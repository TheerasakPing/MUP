import { aK as N, aL as j, aM as f, aN as b, aO as E } from "./mermaid-LQXJBOYN-DVCVGgd1.js";
import { a as v, c as P, k as _, f as g, d, i as l, v as p, r as D } from "./_baseUniq-BJk6H_eQ.js";
var w = N(function (o) {
    return v(P(o, 1, j, !0));
  }),
  F = "\0",
...
class L {
  constructor(e = {}) {
    ((this._isDirected = Object.prototype.hasOwnProperty.call(e, "directed") ? e.directed : !0),
      (this._isMultigraph = Object.prototype.hasOwnProperty.call(e, "multigraph")
        ? e.multigraph
        : !1),
  ...
  setNode(e, t) {
    return Object.prototype.hasOwnProperty.call(this._nodes, e)
      ...
      : ((this._nodes[e] = arguments.length > 1 ? t : this._defaultNodeLabelFn(e)),
        this._isCompound &&
          ((this._parent[e] = a), (this._children[e] = {}), (this._children[a][e] = !0)),
        (this._in[e] = {}),
        (this._preds[e] = {}),
        (this._out[e] = {}),
        (this._sucs[e] = {}),
  ...
  setEdge() {
    ...
    (typeof n == "object" && n !== null && "v" in n
      ? ((e = n.v),
        (t = n.w),
        (s = n.name),
        arguments.length === 2 && ((i = arguments[1]), (r = !0)))
      : ((e = n),
        (t = arguments[1]),
        (s = arguments[3]),
  ...
  edge(e, t, s) {
    var i =
      arguments.length === 1 ? m(this._isDirected, arguments[0]) : c(this._isDirected, e, t, s);
