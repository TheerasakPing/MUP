import { a as gt, g as lt, f as mt, d as xt } from "./chunk-TZMSLE5B-BcG2Ejp4.js";
import { g as kt } from "./chunk-FMBD7UC4-D_S8-DfJ.js";
import {
  _ as n,
  g as _t,
  s as vt,
...
import { d as et } from "./arc-B98crhUD.js";
      ...
      parse: n(function (i) {
        ...
        function D() {
          ...
          return (
            (w = d.pop() || _.lex() || Q),
            typeof w != "number" &&
              (w instanceof Array && ((d = w), (w = d.pop())), (w = a.symbols_[w] || w)),
            w
          );
        }
        n(D, "lex");
...
Expecting ` +
          ...
          if (T[0] instanceof Array && T.length > 1)
            throw new Error(
              "Parse Error: multiple actions possible at state: " + A + ", token: " + v
            );
          switch (T[0]) {
            case 1:
              (l.push(v),
            ...
            case 2:
              if (
                ...
                return q;
              (M &&
                ((l = l.slice(0, -1 * M * 2)), (p = p.slice(0, -1 * M)), (o = o.slice(0, -1 * M))),
        ...
        unput: n(function (i) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: l
                ? (l.length === d.length ? this.yylloc.first_column : 0) +
                  d[d.length - l.length].length -
                  l[0].length
...
` +
        ...
        next: n(function () {
          ...
          for (var p = this._currentRules(), o = 0; o < p.length; o++)
            if (
              ((l = this._input.match(this.rules[p[o]])), l && (!a || l[0].length > a[0].length))
            ) {
          ...
          if ((y.text(a), y.node().getBoundingClientRect().width > s)) {
            if ((h && m.push(h), (h = i), y.text(i), y.node().getBoundingClientRect().width > s)) {
              ...
              for (const p of i)
                ((d += p),
                  y.text(d + "-"),
                  y.node().getBoundingClientRect().width > s &&
                    (m.push(d.slice(0, -1) + "-"), (d = p)));
              h = d;
            }
          } else h = a;
        }),
