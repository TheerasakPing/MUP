import { p as K } from "./chunk-4BX2VUAB-DD9VcsVt.js";
import { I as Y } from "./chunk-QZHKN3VN-Cf1botSZ.js";
import {
  _ as l,
  x as U,
  v as V,
...
import { p as dr } from "./treemap-KMMF4GRG-CUI7aynp.js";
...
var x = { NORMAL: 0, REVERSE: 1, HIGHLIGHT: 2, MERGE: 3, CHERRY_PICK: 4 },
  hr = cr.gitGraph,
  I = l(() => nr({ ...hr, ...or().gitGraph }), "getConfig"),
  c = new Y(() => {
    const t = I(),
      r = t.mainBranchName,
      s = t.mainBranchOrder;
    return {
      ...
      commits: new Map(),
      head: null,
      branchConfig: new Map([[r, { name: r, order: s }]]),
...
var lr = l(function (t) {
  ...
  gr = l(function (t) {
    ...
    const a = I();
    ((s = C.sanitizeText(s, a)),
      (r = C.sanitizeText(r, a)),
      (e = e?.map((o) => C.sanitizeText(o, a))));
    const d = {
      id: s || c.records.seq + "-" + q(),
      message: r,
      seq: c.records.seq++,
      type: n ?? x.NORMAL,
      tags: e ?? [],
    ...
    ((c.records.head = d),
      m.info("main branch", a.mainBranchName),
      c.records.commits.has(d.id) && m.warn(`Commit ID ${d.id} already exists`),
      c.records.commits.set(d.id, d),
      c.records.branches.set(c.records.currBranch, d.id),
      m.debug("in pushCommit " + d.id));
  }, "commit"),
  yr = l(function (t) {
    let r = t.name;
    const s = t.order;
  ...
  ur = l((t) => {
    ...
    const d = c.records.branches.get(c.records.currBranch),
      o = c.records.branches.get(r),
      f = d ? c.records.commits.get(d) : void 0,
      h = o ? c.records.commits.get(o) : void 0;
    if (f && h && f.branch === r) throw new Error(`Cannot merge branch '${r}' into itself.`);
    if (c.records.currBranch === r) {
      const i = new Error('Incorrect usage of "merge". Cannot merge a branch to itself');
      throw ((i.hash = { text: `merge ${r}`, token: `merge ${r}`, expected: ["branch abc"] }), i);
    }
    if (f === void 0 || !f) {
      const i = new Error(
        `Incorrect usage of "merge". Current branch (${c.records.currBranch})has no commits`
      );
      throw ((i.hash = { text: `merge ${r}`, token: `merge ${r}`, expected: ["commit"] }), i);
    }
    if (!c.records.branches.has(r)) {
      const i = new Error(
        'Incorrect usage of "merge". Branch to be merged (' + r + ") does not exist"
      );
      throw ((i.hash = { text: `merge ${r}`, token: `merge ${r}`, expected: [`branch ${r}`] }), i);
    }
    if (h === void 0 || !h) {
      const i = new Error(
    ...
    if (s && c.records.commits.has(s)) {
      ...
      throw (
        (i.hash = {
          ...
          expected: [`merge ${r} ${s}_UNIQUE ${n} ${e?.join(" ")}`],
        }),
        i
      );
    }
  ...
  pr = l(function (t) {
    ...
    if (
      ((r = C.sanitizeText(r, a)),
      (s = C.sanitizeText(s, a)),
      (n = n?.map((f) => C.sanitizeText(f, a))),
      (e = C.sanitizeText(e, a)),
      !r || !c.records.commits.has(r))
    ) {
      const f = new Error(
...
function P(t) {
  ...
  for (const e in c.records.branches) c.records.branches.get(e) === r.id && n.push(e);
...
var xr = l(function () {
  ...
  br = l(function () {
    return [...c.records.branchConfig.values()]
      .map((r, s) =>
        r.order !== null && r.order !== void 0 ? r : { ...r, order: parseFloat(`0.${s}`) }
      )
      .sort((r, s) => (r.order ?? 0) - (s.order ?? 0))
      .map(({ name: r }) => ({ name: r }));
  ...
  Br = l((t, r) => {
    (K(t, r), t.dir && r.setDirection(t.dir));
    for (const s of t.statements) Lr(s, r);
  }, "populate"),
  Lr = l((t, r) => {
    const n = {
      Commit: l((e) => r.commit(kr(e)), "Commit"),
      Branch: l((e) => r.branch(Mr(e)), "Branch"),
      Merge: l((e) => r.merge(Ir(e)), "Merge"),
      Checkout: l((e) => r.checkout(Rr(e)), "Checkout"),
      CherryPicking: l((e) => r.cherryPick(Gr(e)), "CherryPicking"),
    }[t.$type];
  ...
  Mr = l((t) => ({ name: t.name, order: t.order ?? 0 }), "parseBranch"),
  Ir = l(
    (t) => ({
      branch: t.branch,
      id: t.id ?? "",
  ...
  u = "LR",
  qr = l(() => {
    (b.clear(), w.clear(), R.clear(), (B = 0), (A = []), (u = "LR"));
  }, "clear"),
  W = l((t) => {
  ...
  j = l((t) => {
    ...
    return (
      u === "BT"
        ? ((s = l((e, a) => e <= a, "comparisonFunc")), (n = 1 / 0))
        : ((s = l((e, a) => e >= a, "comparisonFunc")), (n = 0)),
      t.forEach((e) => {
  ...
  _r = l((t, r, s) => {
    ...
    (t.forEach((d) => {
      const o = r.get(d);
      if (!o) throw new Error(`Commit not found for key ${d}`);
      (o.parents.length ? ((n = zr(o)), (e = Math.max(n, e))) : a.push(o), Dr(o, n));
    }),
      (n = e),
      a.forEach((d) => {
        Fr(d, n, s);
  ...
  Pr = l((t) => {
    ...
    const s = w.get(r)?.y;
    if (s === void 0) throw new Error(`Closest parent position not found for commit ${t.id}`);
    return s;
  }, "findClosestParentPos"),
  zr = l((t) => Pr(t) + k, "calculateCommitPosition"),
  Dr = l((t, r) => {
  ...
  Nr = l((t, r, s, n, e, a) => {
    if (a === x.HIGHLIGHT)
      (t
        ...
        .attr("width", 20)
        .attr("height", 20)
        .attr("class", `commit ${r.id} commit-highlight${e % M} ${n}-outer`),
        t
          .append("rect")
          .attr("x", s.x - 6)
          .attr("y", s.y - 6)
          .attr("width", 12)
          .attr("height", 12)
          .attr("class", `commit ${r.id} commit${e % M} ${n}-inner`));
  ...
  Sr = l((t, r, s, n) => {
    if (
      r.type !== x.CHERRY_PICK &&
      ((r.customId && r.type === x.MERGE) || r.type !== x.MERGE) &&
      v?.showCommitLabel
    ) {
      const e = t.append("g"),
        a = e.insert("rect").attr("class", "commit-label-bkg"),
        d = e
          .append("text")
          .attr("x", n)
          .attr("y", s.y + 25)
      ...
      if (
        o &&
        (a
          .attr("x", s.posWithOffset - o.width / 2 - T)
          .attr("y", s.y + 13.5)
          .attr("width", o.width + 2 * T)
          .attr("height", o.height + 2 * T),
        u === "TB" || u === "BT"
          ? (a.attr("x", s.x - (o.width + 4 * E + 5)).attr("y", s.y - 12),
            d.attr("x", s.x - (o.width + 4 * E)).attr("y", s.y + o.height - 12))
          : d.attr("x", s.posWithOffset - o.width / 2),
        v.rotateCommitLabel)
      )
        if (u === "TB" || u === "BT")
    ...
    if (r.tags.length > 0) {
      ...
      ${s.posWithOffset - a / 2 - E},${y + i + T}`
        ...
        ${s.x + L},${p + i + 2}`
            ...
            .attr("transform", "translate(12,12) rotate(45, " + s.x + "," + n + ")"),
            h
              .attr("cx", s.x + E / 2)
              .attr("cy", p)
              .attr("transform", "translate(12,12) rotate(45, " + s.x + "," + n + ")"),
            f
              .attr("x", s.x + 5)
              .attr("y", p + 3)
              .attr("transform", "translate(14,14) rotate(45, " + s.x + "," + n + ")"));
        }
      }
    }
  }, "drawCommitTags"),
  ...
  Kr = l((t, r, s, n) => {
    ...
    } else return r === "TB" ? O : r === "BT" ? (n.get(t.id) ?? e).y - k : 0;
    return 0;
  }, "calculatePosition"),
  Yr = l((t, r, s) => {
    const n = u === "BT" && s ? r : r + L,
      e = u === "TB" || u === "BT" ? n : b.get(t.branch)?.pos,
      a = u === "TB" || u === "BT" ? b.get(t.branch)?.pos : n;
    if (a === void 0 || e === void 0) throw new Error(`Position were undefined for commit ${t.id}`);
    return { x: a, y: e, posWithOffset: n };
  }, "getCommitPosition"),
  z = l((t, r, s) => {
    if (!v) throw new Error("GitGraph config not found");
    const n = t.append("g").attr("class", "commit-bullets"),
      e = t.append("g").attr("class", "commit-labels");
    let a = u === "TB" || u === "BT" ? O : 0;
    const d = [...r.keys()],
      o = v?.parallelCommits ?? !1,
      f = l(($, g) => {
        const i = r.get($)?.seq,
          y = r.get(g)?.seq;
    ...
    let h = d.sort(f);
    (u === "BT" && (o && _r(h, r, a), (h = h.reverse())),
      h.forEach(($) => {
        const g = r.get($);
        if (!g) throw new Error(`Commit not found for key ${$}`);
        o && (a = Kr(g, u, a, w));
        const i = Yr(g, a, o);
        if (s) {
          const y = jr(g),
            p = g.customType ?? g.type,
            H = b.get(g.branch)?.index ?? 0;
          (Nr(n, g, i, y, H, p), Sr(e, g, i, a), Wr(e, g, i, a));
        }
        (u === "TB" || u === "BT"
  ...
  Ur = l((t, r, s, n, e) => {
    const d = (u === "TB" || u === "BT" ? s.x < n.x : s.y < n.y) ? r.branch : t.branch,
      o = l((h) => h.branch === d, "isOnBranchToGetCurve"),
      f = l((h) => h.seq > t.seq && h.seq < r.seq, "isBetweenCommits");
    return [...e.values()].some((h) => f(h) && o(h));
  }, "shouldRerouteArrow"),
  G = l((t, r, s = 0) => {
    const n = t + Math.abs(t - r) / 2;
    if (s > 5) return n;
    if (A.every((d) => Math.abs(d - n) >= 10)) return (A.push(n), n);
  ...
  Vr = l((t, r, s, n) => {
    ...
    if (d) {
      ...
      ((o = "A 20 20, 0, 0, 0,"),
        ...
        u === "TB"
          ? (e.x < a.x &&
              (s.type === x.MERGE && r.id !== s.parents[0]
                ? (i = `M ${e.x} ${e.y} L ${e.x} ${a.y - h} ${o} ${e.x + $} ${a.y} L ${a.x} ${a.y}`)
                : (i = `M ${e.x} ${e.y} L ${a.x - h} ${e.y} ${f} ${a.x} ${e.y + $} L ${a.x} ${a.y}`)),
            e.x > a.x &&
              ((o = "A 20 20, 0, 0, 0,"),
              (f = "A 20 20, 0, 0, 1,"),
              (h = 20),
              ($ = 20),
              s.type === x.MERGE && r.id !== s.parents[0]
                ? (i = `M ${e.x} ${e.y} L ${e.x} ${a.y - h} ${f} ${e.x - $} ${a.y} L ${a.x} ${a.y}`)
                : (i = `M ${e.x} ${e.y} L ${a.x + h} ${e.y} ${o} ${a.x} ${e.y + $} L ${a.x} ${a.y}`)),
    ...
    if (i === void 0) throw new Error("Line definition not found");
    t.append("path")
      .attr("d", i)
      .attr("class", "arrow arrow" + (g % M));
  }, "drawArrow"),
  Xr = l((t, r) => {
  ...
  Jr = l((t, r) => {
    ...
    r.forEach((n, e) => {
      const a = e % M,
        d = b.get(n.name)?.pos;
      if (d === void 0) throw new Error(`Position not found for branch ${n.name}`);
      ...
      (o.attr("x1", 0),
        ...
        u === "TB"
          ? (o.attr("y1", O), o.attr("x1", d), o.attr("y2", B), o.attr("x2", d))
          : u === "BT" && (o.attr("y1", B), o.attr("x1", d), o.attr("y2", O), o.attr("x2", d)),
        A.push(d));
      const f = n.name,
        h = W(f),
        $ = s.insert("rect"),
        i = s
          ...
          .insert("g")
          .attr("class", "label branch-label" + a);
      i.node().appendChild(h);
      const y = h.getBBox();
      ($.attr("class", "branchLabelBkg label" + a)
        .attr("rx", 4)
        .attr("ry", 4)
        .attr("x", -y.width - 4 - (v?.rotateCommitLabel === !0 ? 30 : 0))
        .attr("y", -y.height / 2 + 8)
        ...
        i.attr(
          "transform",
          "translate(" +
            (-y.width - 14 - (v?.rotateCommitLabel === !0 ? 30 : 0)) +
            ", " +
            (d - y.height / 2 - 1) +
            ")"
        ),
...
`,
    ...
    (d.forEach((h, $) => {
      const g = W(h.name),
        i = o.append("g"),
        y = i.insert("g").attr("class", "branchLabel"),
        p = y.insert("g").attr("class", "label branch-label");
      p.node()?.appendChild(g);
      const H = g.getBBox();
      ((f = Qr(h.name, f, $, H, e)), p.remove(), y.remove(), i.remove());
    }),
      z(o, R, !1),
      v.showBranches && Jr(o, d),
      Xr(o, R),
      z(o, R, !0),
      tr.insertTitle(o, "gitTitleText", v.titleTopMargin ?? 0, a.getDiagramTitle()),
      ar(void 0, o, v.diagramPadding, v.useMaxWidth));
  }, "draw"),
  re = { draw: Zr },
  ee = l(
    (t) => `
...
`,
  ...
  te = ee,
  ge = { parser: Or, db: S, renderer: re, styles: te };
