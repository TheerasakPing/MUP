...
import { p as hr } from "./chunk-4BX2VUAB-DD9VcsVt.js";
import { p as lr } from "./treemap-KMMF4GRG-CUI7aynp.js";
import { c as Se } from "./cytoscape.esm-BnkdMOzK.js";
import { g as fr } from "./TerminalRouterContext-CeKE7fio.js";
import "./main-B2XpWmPF.js";
import "./__vite-browser-external-2447137e-B8az0FDV.js";
import "./coerce-CyuT_8C8.js";
import "./_baseUniq-BJk6H_eQ.js";
import "./_basePickBy-ELfCephs.js";
import "./clone-D_3mFVg4.js";
var se = { exports: {} },
  he = { exports: {} },
  le = { exports: {} },
  cr = le.exports,
        ...
        (function (G, N) {
          ...
          return (function (M) {
            ...
            function N(d) {
              ...
              var h = (G[d] = { i: d, l: !1, exports: {} });
              return (M[d].call(h.exports, h, h.exports, N), (h.l = !0), h.exports);
            }
            return (
              (N.m = M),
              (N.c = G),
              ...
              (N.d = function (d, h, a) {
                N.o(d, h) ||
                  Object.defineProperty(d, h, { configurable: !1, enumerable: !0, get: a });
              }),
              (N.n = function (d) {
                var h =
                  d && d.__esModule
            ...
            function (M, G, N) {
              ...
              ((e.prototype.getSource = function () {
                ...
                (e.prototype.getOtherEndInGraph = function (l, i) {
                  for (var u = this.getOtherEnd(l), t = i.getGraphManager().getRoot(); ; ) {
            ...
            function (M, G, N) {
              ...
              ((i.prototype.getEdges = function () {
                ...
                (i.prototype.transform = function (t) {
                  ...
                  o > e.WORLD_BOUNDARY
                    ? (o = e.WORLD_BOUNDARY)
                    : o < -e.WORLD_BOUNDARY && (o = -e.WORLD_BOUNDARY);
                  var s = this.rect.y;
                  s > e.WORLD_BOUNDARY
                    ? (s = e.WORLD_BOUNDARY)
                    : s < -e.WORLD_BOUNDARY && (s = -e.WORLD_BOUNDARY);
                  var c = new l(o, s),
                    f = t.inverseTransformPoint(c);
            ...
            function (M, G, N) {
              ...
              function o(c, f, T) {
                (d.call(this, T),
                  ...
                  (this.isConnected = !1),
                  (this.parent = c),
                  f != null && f instanceof e
                    ? (this.graphManager = f)
                    : f != null && f instanceof Layout && (this.graphManager = f.graphManager));
              }
              ...
              ((o.prototype.getNodes = function () {
                ...
                (o.prototype.remove = function (c) {
                  var f = c;
                  if (c instanceof r) {
                    if (f == null) throw "Node is null!";
                    if (!(f.owner != null && f.owner == this)) throw "Owner graph is invalid!";
                    if (this.graphManager == null) throw "Owner graph manager is invalid!";
                    for (var T = f.edges.slice(), g, v = T.length, L = 0; L < v; L++)
                      ((g = T[L]),
                        g.isInterGraph ? this.graphManager.remove(g) : g.source.owner.remove(g));
                    var F = this.nodes.indexOf(f);
                    ...
                    var A = g.source.edges.indexOf(g),
                      b = g.target.edges.indexOf(g);
                    if (!(A > -1 && b > -1)) throw "Source and/or target doesn't know this edge!";
                    (g.source.edges.splice(A, 1),
                      g.target != g.source && g.target.edges.splice(b, 1));
                    var F = g.source.owner.getEdges().indexOf(g);
                    if (F == -1) throw "Not in owner's edge list!";
                    g.source.owner.getEdges().splice(F, 1);
                  }
                }),
                (o.prototype.updateLeftTop = function () {
                  for (
                    ...
                    var b = L[A];
                    ((T = b.getTop()), (g = b.getLeft()), c > T && (c = T), f > g && (f = g));
                  }
                ...
                (o.prototype.updateBounds = function (c) {
                  for (
                    ...
                    var it = U[D];
                    (c && it.child != null && it.updateBounds(),
                      (L = it.getLeft()),
                      (F = it.getRight()),
                      (A = it.getTop()),
                      (b = it.getBottom()),
                  ...
                  var n = new i(f, g, T - f, v - g);
                  (f == h.MAX_VALUE &&
                    ((this.left = this.parent.getLeft()),
                    (this.right = this.parent.getRight()),
                    (this.top = this.parent.getTop()),
                    (this.bottom = this.parent.getBottom())),
                    U[0].getParent().paddingLeft != null
                      ? (Z = U[0].getParent().paddingLeft)
                      : (Z = this.margin),
                    (this.left = n.x - Z),
                ...
                (o.prototype.calcEstimatedSize = function () {
                  for (var c = 0, f = this.nodes, T = f.length, g = 0; g < T; g++) {
                    var v = f[g];
                ...
                (o.prototype.updateConnected = function () {
                  ...
                  for (
                    ...
                    ((g = f.shift()), (v = g.getEdges()));
                    for (var A = v.length, b = 0; b < A; b++) {
                      var Z = v[b];
                      if (((L = Z.getOtherEndInGraph(g, this)), L != null && !T.has(L))) {
                        var U = L.withChildren();
            ...
            function (M, G, N) {
              ...
              ((a.prototype.addRoot = function () {
                ...
                (a.prototype.add = function (e, r, l, i, u) {
                  if (l == null && i == null && u == null) {
                    ...
                    if (t == o) return ((l.isInterGraph = !1), t.add(l, i, u));
                    if (
                      ((l.isInterGraph = !0),
                      (l.source = i),
                      (l.target = u),
                      this.edges.indexOf(l) > -1)
                    )
                ...
                (a.prototype.remove = function (e) {
                  if (e instanceof d) {
                    ...
                    if (
                      !(r == this.rootGraph || (r.parent != null && r.parent.graphManager == this))
                    )
                      throw "Invalid parent node!";
                    var l = [];
                    l = l.concat(r.getEdges());
                    for (var i, u = l.length, t = 0; t < u; t++) ((i = l[t]), r.remove(i));
                    var o = [];
                    o = o.concat(r.getNodes());
                    var s;
                    u = o.length;
                    for (var t = 0; t < u; t++) ((s = o[t]), r.remove(s));
                ...
                (a.prototype.setRootGraph = function (e) {
                  ...
                  ((this.rootGraph = e),
                    e.parent == null && (e.parent = this.layout.newNode("Root node")));
                }),
                ...
                (a.prototype.calcLowestCommonAncestors = function () {
                  for (var e, r, l, i, u, t = this.getAllEdges(), o = t.length, s = 0; s < o; s++) {
                    if (
                      ((e = t[s]),
                      (r = e.source),
                      (l = e.target),
                    ...
                    for (i = r.getOwner(); e.lca == null; ) {
                      for (e.targetInLca = l, u = l.getOwner(); e.lca == null; ) {
                        if (u == i) {
                          e.lca = u;
                          break;
                        }
                      ...
                      e.lca == null &&
                        ((e.sourceInLca = i.getParent()), (i = e.sourceInLca.getOwner()));
                    }
                    if (e.lca == null) throw "assert failed";
                  }
                }),
                ...
                (a.prototype.calcInclusionTreeDepths = function (e, r) {
                  ...
                  for (var l, i = e.getNodes(), u = i.length, t = 0; t < u; t++)
                    ((l = i[t]),
                ...
                (a.prototype.includesInvalidEdge = function () {
                  for (var e, r = [], l = this.edges.length, i = 0; i < l; i++)
                    ((e = this.edges[i]),
                      this.isOneAncestorOfOther(e.source, e.target) && r.push(e));
            ...
            function (M, G, N) {
              ...
              ((h.calcSeparationAmount = function (a, e, r, l) {
                ...
                var u = Math.abs(
                  (e.getCenterY() - a.getCenterY()) / (e.getCenterX() - a.getCenterX())
                );
                ...
                (h.getIntersection2 = function (a, e, r) {
                  var l = a.getCenterX(),
                    ...
                    u = e.getCenterX(),
                    t = e.getCenterY();
                  if (a.intersects(e)) return ((r[0] = l), (r[1] = i), (r[2] = u), (r[3] = t), !0);
                  var o = a.getX(),
                    s = a.getY(),
                    c = a.getRight(),
                    f = a.getX(),
                    ...
                    m = !1;
                  if (l === u) {
                    if (i > t) return ((r[0] = l), (r[1] = s), (r[2] = u), (r[3] = U), !1);
                    if (i < t) return ((r[0] = l), (r[1] = T), (r[2] = u), (r[3] = A), !1);
                  } else if (i === t) {
                    if (l > u) return ((r[0] = o), (r[1] = i), (r[2] = b), (r[3] = t), !1);
                    if (l < u) return ((r[0] = c), (r[1] = i), (r[2] = F), (r[3] = t), !1);
                  } else {
                    ...
                    if (
                      (l > u
                        ? i > t
                          ? ((I = this.getCardinalDirection(p, y, 4)),
                            (w = this.getCardinalDirection(E, y, 2)))
                          : ((I = this.getCardinalDirection(-p, y, 3)),
                            (w = this.getCardinalDirection(-E, y, 1)))
                        : i > t
                          ? ((I = this.getCardinalDirection(-p, y, 1)),
                            (w = this.getCardinalDirection(-E, y, 3)))
                          : ((I = this.getCardinalDirection(p, y, 2)),
                            (w = this.getCardinalDirection(E, y, 4))),
                      !n)
                    )
                      switch (I) {
                        case 1:
                          ((W = s), (R = l + -L / y), (r[0] = R), (r[1] = W));
                          break;
                        case 2:
                          ((R = g), (W = i + v * y), (r[0] = R), (r[1] = W));
                          break;
                        case 3:
                          ((W = T), (R = l + L / y), (r[0] = R), (r[1] = W));
                          break;
                        case 4:
                          ((R = f), (W = i + -v * y), (r[0] = R), (r[1] = W));
                          break;
                      }
                    if (!m)
                      switch (w) {
                        case 1:
                          ((q = A), (x = u + -it / y), (r[2] = x), (r[3] = q));
                          break;
                        case 2:
                          ((x = K), (q = t + D * y), (r[2] = x), (r[3] = q));
                          break;
                        case 3:
                          ((q = U), (x = u + it / y), (r[2] = x), (r[3] = q));
                          break;
                        case 4:
                ...
                (h.getIntersection = function (a, e, r, l) {
                  ...
                  return (
                    ...
                    K === 0
                      ? null
                      : ((g = (A * U - b * Z) / K), (v = (F * Z - L * U) / K), new d(g, v))
                  );
                }),
                ...
                (h.doIntersect = function (a, e, r, l) {
                  var i = a.x,
                    ...
                    g = (t - i) * (T - c) - (f - s) * (o - u);
                  if (g === 0) return !1;
                  var v = ((T - c) * (f - i) + (s - f) * (T - u)) / g,
                    L = ((u - o) * (f - i) + (t - i) * (T - u)) / g;
                  return 0 < v && v < 1 && 0 < L && L < 1;
                }),
                (h.findCircleLineIntersections = function (a, e, r, l, i, u, t) {
            ...
            function (M, G, N) {
              function d(h, a, e) {
                ((this.x = null),
                  (this.y = null),
                  h == null && a == null && e == null
                    ? ((this.x = 0), (this.y = 0))
                    : typeof h == "number" && typeof a == "number" && e == null
                      ? ((this.x = h), (this.y = a))
              ...
              ((d.prototype.getX = function () {
                ...
                (d.prototype.setLocation = function (h, a, e) {
                  h.constructor.name == "Point" && a == null && e == null
                ...
                (d.prototype.move = function (h, a) {
                  ((this.x = h), (this.y = a));
                }),
                (d.prototype.translate = function (h, a) {
                  ((this.x += h), (this.y += a));
                }),
              ...
              function d(h, a, e, r) {
                ((this.x = 0),
                  ...
                  h != null &&
                    ...
                    e != null &&
                    r != null &&
                    ((this.x = h), (this.y = a), (this.width = e), (this.height = r)));
              }
              ((d.prototype.getX = function () {
                return this.x;
              }),
              ...
              ((h.lastID = 0),
                (h.createID = function (a) {
                  return h.isPrimitive(a)
                    ? a
                    : (a.uniqueID != null || ((a.uniqueID = h.getString()), h.lastID++),
                      a.uniqueID);
                }),
            ...
            function (M, G, N) {
              function d(s) {
                if (Array.isArray(s)) {
                  for (var c = 0, f = Array(s.length); c < s.length; c++) f[c] = s[c];
                  return f;
              ...
              ((o.RANDOM_SEED = 1),
                ...
                (o.prototype.update = function (s) {
                  if (s == null) this.update2();
                    ...
                    var c = s;
                    if (c.getChild() != null)
                      for (var f = c.getChild().getNodes(), T = 0; T < f.length; T++) update(f[T]);
                ...
                (o.prototype.transform = function (s) {
                  if (s == null) this.transform(new i(0, 0));
                    ...
                    var c = new u(),
                      f = this.graphManager.getRoot().updateLeftTop();
                    if (f != null) {
                      (c.setWorldOrgX(s.x),
                        c.setWorldOrgY(s.y),
                        c.setDeviceOrgX(f.x),
                ...
                (o.prototype.positionNodesRandomly = function (s) {
                  if (s == null)
                    ...
                    for (var c, f, T = s.getNodes(), g = 0; g < T.length; g++)
                      ((c = T[g]),
                        (f = c.getChild()),
                        f == null || f.getNodes().length == 0
                          ? c.scatter()
                          : (this.positionNodesRandomly(f), c.updateBounds()));
                }),
                (o.prototype.getFlatForest = function () {
                  for (
                    var s = [], c = !0, f = this.graphManager.getRoot().getNodes(), T = !0, g = 0;
                    g < f.length;
                    g++
                  )
                    f[g].getChild() != null && (T = !1);
                  if (!T) return s;
                  var v = new Set(),
                    L = [],
                    F = new Map(),
                    A = [];
                  for (A = A.concat(f); A.length > 0 && c; ) {
                    for (L.push(A[0]); L.length > 0 && c; ) {
                      var b = L[0];
                      (L.splice(0, 1), v.add(b));
                      for (var Z = b.getEdges(), g = 0; g < Z.length; g++) {
                        var U = Z[g].getOtherEnd(b);
                        if (F.get(b) != U)
                          if (!v.has(U)) (L.push(U), F.set(U, b));
                          else {
                            c = !1;
                            break;
                          }
                ...
                (o.prototype.createDummyNodesForBendpoints = function (s) {
                  for (
                    var c = [],
                      f = s.source,
                      T = this.graphManager.calcLowestCommonAncestor(s.source, s.target),
                      g = 0;
                ...
                (o.prototype.createBendpointsFromDummyNodes = function () {
                  ...
                  ((s = s.concat(this.graphManager.getAllEdges())),
                    (s = [].concat(d(this.edgeToDummyNodes.keys())).concat(s)));
                  for (var c = 0; c < s.length; c++) {
                    var f = s[c];
                    if (f.bendpoints.length > 0) {
                      for (var T = this.edgeToDummyNodes.get(f), g = 0; g < T.length; g++) {
                        var v = T[g],
                          L = new i(v.getCenterX(), v.getCenterY()),
                          F = f.bendpoints.get(g);
                        ((F.x = L.x), (F.y = L.y), v.getOwner().remove(v));
                      }
                ...
                (o.findCenterOfTree = function (s) {
                  ...
                  for (var L = 0; L < c.length; L++) {
                    var F = c[L],
                      A = F.getNeighborsList().size;
                    (T.set(F, F.getNeighborsList().size), A == 1 && f.push(F));
                  }
                  var b = [];
                  for (b = b.concat(f); !g; ) {
                    var Z = [];
                    ...
                    for (var L = 0; L < c.length; L++) {
                      ...
                      K.forEach(function (n) {
                        if (f.indexOf(n) < 0) {
                          var m = T.get(n),
                            p = m - 1;
                          (p == 1 && b.push(n), T.set(n, p));
                        }
                      });
                    }
                    ((f = f.concat(b)), (c.length == 1 || c.length == 2) && ((g = !0), (v = c[0])));
                  }
                  return v;
                }),
            ...
            function (M, G, N) {
              ...
              ((i.prototype.initParameters = function () {
                ...
                (i.prototype.calcIdealEdgeLengths = function () {
                  for (
                    var t, o, s, c, f, T, g, v = this.getGraphManager().getAllEdges(), L = 0;
                    L < v.length;
                    L++
                  )
                    ((t = v[L]),
                      ...
                      t.isInterGraph &&
                        ...
                        this.useSmartIdealEdgeLengthCalculation &&
                          (t.idealLength += T + g - 2 * e.SIMPLE_NODE_SIZE),
                        (s = t.getLca().getInclusionTreeDepth()),
                        (t.idealLength +=
                          o *
                          a.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR *
                          (c.getInclusionTreeDepth() + f.getInclusionTreeDepth() - 2 * s))));
                }),
                ...
                (i.prototype.calcRepulsionForces = function () {
                  ...
                  if (this.useFRGridVariant)
                    for (
                      this.totalIterations % a.GRID_CALCULATION_CHECK_PERIOD == 1 &&
                        t &&
                        this.updateGrid(),
                        v = new Set(),
                        s = 0;
                      ...
                      ((f = g[s]), this.calculateRepulsionForceOfANode(f, v, t, o), v.add(f));
                  else
                    for (s = 0; s < g.length; s++)
                      for (f = g[s], c = s + 1; c < g.length; c++)
                        ((T = g[c]), f.getOwner() == T.getOwner() && this.calcRepulsionForce(f, T));
                }),
                ...
                (i.prototype.calcRepulsionForce = function (t, o) {
                  ...
                  if (s.intersects(c)) {
                    ...
                    ((t.repulsionForceX -= U * b),
                      (t.repulsionForceY -= U * Z),
                      (o.repulsionForceX += U * b),
                      (o.repulsionForceY += U * Z));
                  } else
                    (this.uniformLeafNodeSizes && t.getChild() == null && o.getChild() == null
                      ? ((g = c.getCenterX() - s.getCenterX()),
                      ...
                      (F = Math.sqrt(L)),
                      (A =
                        ((t.nodeRepulsion / 2 + o.nodeRepulsion / 2) *
                          t.noOfChildren *
                          o.noOfChildren) /
                        L),
                      (b = (A * g) / F),
                ...
                (i.prototype.calcGrid = function (t) {
                  ...
                  for (var c = new Array(o), f = 0; f < o; f++) c[f] = new Array(s);
                  for (var f = 0; f < o; f++) for (var T = 0; T < s; T++) c[f][T] = new Array();
                  return c;
                }),
                (i.prototype.addNodeToGrid = function (t, o, s) {
                  ...
                  ((c = parseInt(Math.floor((t.getRect().x - o) / this.repulsionRange))),
                    (f = parseInt(
                      Math.floor((t.getRect().width + t.getRect().x - o) / this.repulsionRange)
                    )),
                    (T = parseInt(Math.floor((t.getRect().y - s) / this.repulsionRange))),
                    (g = parseInt(
                      Math.floor((t.getRect().height + t.getRect().y - s) / this.repulsionRange)
                    )));
                  for (var v = c; v <= f; v++)
                    for (var L = T; L <= g; L++)
                      (this.grid[v][L].push(t), t.setGridCoordinates(c, f, T, g));
                }),
                  ...
                  if ((this.totalIterations % a.GRID_CALCULATION_CHECK_PERIOD == 1 && s) || c) {
                    ...
                    for (var T, g = this.grid, v = t.startX - 1; v < t.finishX + 2; v++)
                      for (var L = t.startY - 1; L < t.finishY + 2; L++)
                        if (!(v < 0 || L < 0 || v >= g.length || L >= g[0].length)) {
                          for (var F = 0; F < g[v][L].length; F++)
                            if (
                              ((T = g[v][L][F]),
                              !(t.getOwner() != T.getOwner() || t == T) && !o.has(T) && !f.has(T))
                            ) {
                              var A =
                              ...
                              A <= this.repulsionRange && b <= this.repulsionRange && f.add(T);
                            }
                        }
                    t.surrounding = [].concat(d(f));
                  }
              ...
              ((d.multMat = function (h, a) {
                for (var e = [], r = 0; r < h.length; r++) {
                  ...
                  for (var l = 0; l < a[0].length; l++) {
                    e[r][l] = 0;
                    for (var i = 0; i < h[0].length; i++) e[r][l] += h[r][i] * a[i][l];
                  }
                }
                return e;
              }),
                (d.transpose = function (h) {
                  for (var a = [], e = 0; e < h[0].length; e++) {
                    a[e] = [];
                    for (var r = 0; r < h.length; r++) a[e][r] = h[r][e];
                  }
                  return a;
                }),
                (d.multCons = function (h, a) {
                  for (var e = [], r = 0; r < h.length; r++) e[r] = h[r] * a;
                  return e;
                }),
                (d.minusOp = function (h, a) {
                  for (var e = [], r = 0; r < h.length; r++) e[r] = h[r] - a[r];
                  return e;
                }),
                (d.dotProduct = function (h, a) {
                  for (var e = 0, r = 0; r < h.length; r++) e += h[r] * a[r];
                  return e;
                }),
                (d.mag = function (h) {
                ...
                (d.normalize = function (h) {
                  for (var a = [], e = this.mag(h), r = 0; r < h.length; r++) a[r] = h[r] / e;
                  return a;
                }),
                (d.multGamma = function (h) {
                  for (var a = [], e = 0, r = 0; r < h.length; r++) e += h[r];
                  e *= -1 / h.length;
                  for (var l = 0; l < h.length; l++) a[l] = e + h[l];
                  return a;
                }),
                (d.multL = function (h, a, e) {
                  for (var r = [], l = [], i = [], u = 0; u < a[0].length; u++) {
                    for (var t = 0, o = 0; o < a.length; o++) t += -0.5 * a[o][u] * h[o];
                    l[u] = t;
                  }
                  for (var s = 0; s < e.length; s++) {
                    for (var c = 0, f = 0; f < e.length; f++) c += e[s][f] * l[f];
                    i[s] = c;
                  }
              ...
              var a = N(11),
                e = (function () {
                  function r(l, i) {
                    ...
                    var u = void 0;
                    (l instanceof a ? (u = l.size()) : (u = l.length),
                      this._quicksort(l, 0, u - 1));
                  }
                  return (
                    d(r, [
                      {
                        ...
                        value: function (i, u, t) {
                          if (u < t) {
                            var o = this._partition(i, u, t);
                            (this._quicksort(i, u, o), this._quicksort(i, o + 1, t));
                          }
                        },
                      },
                      {
                        key: "_partition",
                        value: function (i, u, t) {
                          for (var o = this._get(i, u), s = u, c = t; ; ) {
                      ...
                      },
                      {
                        ...
                        value: function (i, u, t) {
                          var o = this._get(i, u);
                          (this._set(i, u, this._get(i, t)), this._set(i, t, o));
                        },
                      },
                      {
            ...
            function (M, G, N) {
              ...
              ((d.svd = function (h) {
                ...
                for (
                  ...
                  if (t < i) {
                    this.s[t] = 0;
                    for (var o = t; o < this.m; o++) this.s[t] = d.hypot(this.s[t], h[o][t]);
                    if (this.s[t] !== 0) {
                  ...
                  for (var c = t + 1; c < this.n; c++) {
                    if (
                      ...
                      for (var f = 0, T = t; T < this.m; T++) f += h[T][t] * h[T][c];
                      f = -f / h[t][t];
                      for (var g = t; g < this.m; g++) h[g][c] += f * h[g][t];
                    }
                    e[c] = h[t][c];
                  }
                  if (
                  ...
                  if (t < u) {
                    e[t] = 0;
                    for (var L = t + 1; L < this.n; L++) e[t] = d.hypot(e[t], e[L]);
                    if (e[t] !== 0) {
                      e[t + 1] < 0 && (e[t] = -e[t]);
                    ...
                    if (
                      ...
                      for (var A = t + 1; A < this.m; A++) r[A] = 0;
                      for (var b = t + 1; b < this.n; b++)
                        for (var Z = t + 1; Z < this.m; Z++) r[Z] += e[b] * h[Z][b];
                      for (var U = t + 1; U < this.n; U++)
                        for (var K = -e[U] / e[t + 1], D = t + 1; D < this.m; D++)
                          h[D][U] += K * r[D];
                    }
                    for (var it = t + 1; it < this.n; it++) this.V[it][t] = e[it];
                  }
                }
                  ...
                  for (var E = i - 1; E >= 0; E--)
                    if (this.s[E] !== 0) {
                      for (var y = E + 1; y < a; y++) {
                        ...
                        I = -I / this.U[E][E];
                        for (var R = E; R < this.m; R++) this.U[R][y] += I * this.U[R][E];
                      }
                ...
                for (var $ = n - 1, _ = Math.pow(2, -52), ht = Math.pow(2, -966); n > 0; ) {
                  ...
                  for (Q = n - 2; Q >= -1 && Q !== -1; Q--)
                    if (
                      Math.abs(e[Q]) <=
                      ht + _ * (Math.abs(this.s[Q]) + Math.abs(this.s[Q + 1]))
                    ) {
                      e[Q] = 0;
                      break;
                    }
                  if (Q === n - 2) It = 4;
                    ...
                    for (Nt = n - 1; Nt >= Q && Nt !== Q; Nt--) {
                      var vt =
                        (Nt !== n ? Math.abs(e[Nt]) : 0) + (Nt !== Q + 1 ? Math.abs(e[Nt - 1]) : 0);
                    ...
                    case 1:
                      {
                        ...
                        for (var gt = n - 2; gt >= Q; gt--) {
                          var mt = d.hypot(this.s[gt], rt),
                            At = this.s[gt] / mt,
                            Ot = rt / mt;
                          ((this.s[gt] = mt),
                            gt !== Q && ((rt = -Ot * e[gt - 1]), (e[gt - 1] = At * e[gt - 1])));
                    ...
                    case 3:
                      {
                        var Yt = Math.max(
                            Math.max(
                              Math.max(
                                Math.max(Math.abs(this.s[n - 1]), Math.abs(this.s[n - 2])),
                                Math.abs(e[n - 2])
                              ),
                              Math.abs(this.s[Q])
                            ),
                ...
                (d.hypot = function (h, a) {
                  var e = void 0;
                  return (
                    Math.abs(h) > Math.abs(a)
                      ? ((e = a / h), (e = Math.abs(h) * Math.sqrt(1 + e * e)))
                      : a != 0
                        ? ((e = h / a), (e = Math.abs(a) * Math.sqrt(1 + e * e)))
                        : (e = 0),
                    e
                  );
                }),
                ...
                return (
                  d(e, [
                        ...
                        for (var u = 1; u < this.iMax; u++)
                          for (var t = 1; t < this.jMax; t++) {
                            ...
                            this.sequence1[u - 1] === this.sequence2[t - 1]
                              ? (o = this.grid[u - 1][t - 1] + this.match_score)
                              : (o = this.grid[u - 1][t - 1] + this.mismatch_penalty);
                            var s = this.grid[u - 1][t] + this.gap_penalty,
                              c = this.grid[u][t - 1] + this.gap_penalty,
                              f = [o, s, c],
                              T = this.arrayAllMaxIndexes(f);
                            ((this.grid[u][t] = f[T[0]]),
                              (this.tracebackGrid[u][t] = [
                                T.includes(0),
                                T.includes(1),
                                T.includes(2),
                              ]));
                    ...
                    },
                    {
                      key: "getAllIndexes",
                      value: function (l, i) {
                        for (var u = [], t = -1; (t = l.indexOf(i, t + 1)) !== -1; ) u.push(t);
                        return u;
                      },
                    },
                    {
          ...
          return (() => {
            var G = {
                ...
                765: (a, e, r) => {
                  ...
                  ((D.prototype.newGraphManager = function () {
                    ...
                    (D.prototype.initParameters = function () {
                      (l.prototype.initParameters.call(this, arguments),
                        this.isSubLayout ||
                          ...
                          (this.useSmartIdealEdgeLengthCalculation =
                            s.DEFAULT_USE_SMART_IDEAL_EDGE_LENGTH_CALCULATION),
                          ...
                          (this.compoundGravityRangeFactor =
                            f.DEFAULT_COMPOUND_GRAVITY_RANGE_FACTOR),
                          (this.prunedNodesAll = []),
                    ...
                    (D.prototype.tick = function () {
                      ...
                      if (
                        this.totalIterations % f.CONVERGENCE_CHECK_PERIOD == 0 &&
                        !this.isTreeGrowing &&
                        !this.isGrowthFinished
                      ) {
                        if (this.isConverged())
                          ...
                          (this.coolingFactor = Math.max(
                            this.initialCoolingFactor -
                              (Math.pow(
                                this.coolingCycle,
                                Math.log(
                                  100 * (this.initialCoolingFactor - this.finalTemperature)
                      ...
                      if (this.isGrowthFinished) {
                        ...
                        (this.afterGrowthIterations % 10 == 0 &&
                          ...
                          s.PURE_INCREMENTAL
                            ? (this.coolingFactor =
                                (f.DEFAULT_COOLING_FACTOR_INCREMENTAL / 2) *
                                ((100 - this.afterGrowthIterations) / 100))
                            : (this.coolingFactor =
                                f.DEFAULT_COOLING_FACTOR_INCREMENTAL *
                                ((100 - this.afterGrowthIterations) / 100)),
                    ...
                    (D.prototype.getPositionsData = function () {
                      for (
                        var n = this.graphManager.getAllNodes(), m = {}, p = 0;
                        p < n.length;
                        p++
                      ) {
                        var E = n[p].rect,
                    ...
                    (D.prototype.runSpringEmbedder = function () {
                      ...
                      var n = !1;
                      if (f.ANIMATE === "during") this.emit("layoutstarted");
                      else {
                        for (; !n; ) n = this.tick();
                        this.graphManager.updateBounds();
                      }
                    ...
                    (D.prototype.initConstraintVariables = function () {
                      ...
                      var y = function O(H) {
                        for (var $ = H.getChild().getNodes(), _, ht = 0, Q = 0; Q < $.length; Q++)
                          ((_ = $[Q]),
                            _.getChild() == null
                              ? n.fixedNodeSet.has(_.id) && (ht += 100)
                              : (ht += O(_)));
                        return ht;
                      };
                      ...
                      if (this.constraints.relativePlacementConstraint) {
                        ...
                        if (
                          ...
                          if (this.constraints.alignmentConstraint.vertical)
                            for (
                              var W = this.constraints.alignmentConstraint.vertical, p = 0;
                              p < W.length;
                              p++
                            )
                          ...
                          if (this.constraints.alignmentConstraint.horizontal)
                            for (
                              var x = this.constraints.alignmentConstraint.horizontal, p = 0;
                              p < x.length;
                              p++
                            )
                                ...
                                (n.nodesInRelativeHorizontal.includes(H) ||
                                  ...
                                  n.dummyToNodeForVerticalAlignment.has(H)
                                    ? n.nodeToTempPositionMapHorizontal.set(
                                        H,
                                        n.idToNodeMap
                                          .get(n.dummyToNodeForVerticalAlignment.get(H)[0])
                                          .getCenterX()
                                      )
                                    : n.nodeToTempPositionMapHorizontal.set(
                                        H,
                                  ...
                                  n.nodesInRelativeHorizontal.includes($) ||
                                    ...
                                    n.dummyToNodeForVerticalAlignment.has($)
                                      ? n.nodeToTempPositionMapHorizontal.set(
                                          $,
                                          n.idToNodeMap
                                            .get(n.dummyToNodeForVerticalAlignment.get($)[0])
                                            .getCenterX()
                                        )
                                      : n.nodeToTempPositionMapHorizontal.set(
                                          $,
                                          n.idToNodeMap.get($).getCenterX()
                                        )),
                                  n.nodeToRelativeConstraintMapHorizontal
                                    .get(H)
                                    .push({ right: $, gap: O.gap }),
                                  n.nodeToRelativeConstraintMapHorizontal
                                    .get($)
                                    .push({ left: H, gap: O.gap }));
                              } else {
                                var _ = R.has(O.top) ? R.get(O.top) : O.top,
                                  ht = R.has(O.bottom) ? R.get(O.bottom) : O.bottom;
                                (n.nodesInRelativeVertical.includes(_) ||
                                  ...
                                  n.dummyToNodeForHorizontalAlignment.has(_)
                                    ? n.nodeToTempPositionMapVertical.set(
                                        _,
                                        n.idToNodeMap
                                          .get(n.dummyToNodeForHorizontalAlignment.get(_)[0])
                                          .getCenterY()
                                      )
                                    : n.nodeToTempPositionMapVertical.set(
                                        _,
                                        n.idToNodeMap.get(_).getCenterY()
                                      )),
                                  ...
                                  n.nodeToRelativeConstraintMapVertical
                                    .get(_)
                                    .push({ bottom: ht, gap: O.gap }),
                                  n.nodeToRelativeConstraintMapVertical
                                    .get(ht)
                                    .push({ top: _, gap: O.gap }));
                              }
                            }));
                        else {
                          var q = new Map(),
                    ...
                    (D.prototype.updateDisplacements = function () {
                      ...
                      if (
                        ...
                        if (this.constraints.alignmentConstraint.vertical)
                          for (
                            var m = this.constraints.alignmentConstraint.vertical, p = 0;
                            p < m.length;
                            p++
                          ) {
                        ...
                        if (this.constraints.alignmentConstraint.horizontal)
                          for (
                            var w = this.constraints.alignmentConstraint.horizontal, p = 0;
                            p < w.length;
                            p++
                          ) {
                            ...
                            this.nodesInRelativeHorizontal.forEach(function (z) {
                              if (!n.fixedNodesOnHorizontal.has(z)) {
                                ...
                                (n.dummyToNodeForVerticalAlignment.has(z)
                                  ? (O = n.idToNodeMap.get(
                                      n.dummyToNodeForVerticalAlignment.get(z)[0]
                                    ).displacementX)
                            ...
                            this.nodesInRelativeVertical.forEach(function (z) {
                              if (!n.fixedNodesOnHorizontal.has(z)) {
                                ...
                                (n.dummyToNodeForHorizontalAlignment.has(z)
                                  ? (O = n.idToNodeMap.get(
                                      n.dummyToNodeForHorizontalAlignment.get(z)[0]
                                    ).displacementY)
                                  ...
                                  n.nodeToTempPositionMapVertical.set(
                                    z,
                                    n.nodeToTempPositionMapVertical.get(z) + O
                                  ),
                                  n.dummyToNodeForHorizontalAlignment.has(z)
                            ...
                            if (this.fixedComponentsOnHorizontal[p])
                              ...
                              for (var q = 0, V = 0, y = 0; y < x.length; y++)
                                if (this.dummyToNodeForVerticalAlignment.has(x[y])) {
                                  ...
                                  ((q += Y.length * this.idToNodeMap.get(Y[0]).displacementX),
                                    (V += Y.length));
                            ...
                            if (this.fixedComponentsOnVertical[p])
                              ...
                              for (var q = 0, V = 0, y = 0; y < x.length; y++)
                                if (this.dummyToNodeForHorizontalAlignment.has(x[y])) {
                                  ...
                                  ((q += Y.length * this.idToNodeMap.get(Y[0]).displacementY),
                                    (V += Y.length));
                    ...
                    (D.prototype.calculateNodesToApplyGravitationTo = function () {
                      ...
                      for (y = 0; y < E; y++)
                        ((m = p[y]),
                          m.updateConnected(),
                          m.isConnected || (n = n.concat(m.getNodes())));
                      return n;
                    }),
                    ...
                    (D.prototype.positionNodesRadially = function (n) {
                      for (
                        ...
                        R % p == 0 &&
                          ((I = 0),
                          (y = E),
                          R != 0 && (y += s.DEFAULT_COMPONENT_SEPERATION),
                          (E = 0));
                        var W = n[R],
                        ...
                        ((m.x = I),
                          ...
                          (I = Math.floor(w.x + s.DEFAULT_COMPONENT_SEPERATION)));
                      }
                    ...
                    (D.prototype.groupZeroDegreeMembers = function () {
                      ...
                      for (
                        var p = [], E = this.graphManager.getAllNodes(), y = 0;
                        y < E.length;
                        y++
                      ) {
                        var I = E[y],
                          w = I.getParent();
                        this.getNodeDegreeWithChildren(I) === 0 &&
                          (w.id == null || !this.getToBeTiled(w)) &&
                          p.push(I);
                      }
                    ...
                    (D.prototype.tileCompoundMembers = function (n, m) {
                      ...
                      ((this.tiledMemberPack = []),
                        Object.keys(n).forEach(function (E) {
                          var y = m[E];
                          if (
                            ((p.tiledMemberPack[E] = p.tileNodes(
                              n[E],
                    ...
                    (D.prototype.tileNodesByFavoringDim = function (n, m, p) {
                      ...
                      for (var V = 0; V < n.length; V++) {
                        ...
                        if (w.rows.length == 0) this.insertNodeToRow(w, Y, 0, m);
                          ...
                          (w.idealRowWidth || (et = this.getShortestRowIndex(w)),
                            this.insertNodeToRow(w, Y, et, m));
                    ...
                    (D.prototype.insertNodeToRow = function (n, m, p, E) {
                      ...
                      var W = 0;
                      (R > n.rowHeight[p] &&
                        ((W = n.rowHeight[p]), (n.rowHeight[p] = R), (W = n.rowHeight[p] - W)),
                        (n.height += W),
                        n.rows[p].push(m));
                    }),
                    ...
                    (D.prototype.canAddHorizontal = function (n, m, p) {
                      ...
                      (n.width - w >= m + n.horizontalPadding
                        ? (W = (n.height + R) / (w + m + n.horizontalPadding))
                        : (W = (n.height + R) / n.width),
                        (R = p + n.verticalPadding));
                      var x;
                      return (
                        n.width < m ? (x = (n.height + R) / m) : (x = (n.height + R) / n.width),
                        x < 1 && (x = 1 / x),
                        W < 1 && (W = 1 / W),
                        W < x
                      );
                      ...
                      for (var n = [], m = !0, p; m; ) {
                          ...
                          if (
                            ...
                            if (s.PURE_INCREMENTAL) {
                              var w = p.getEdges()[0].getOtherEnd(p),
                                R = new L(
                                  p.getCenterX() - w.getCenterX(),
                                  p.getCenterY() - w.getCenterY()
                                );
                        ...
                        if (m == !0) {
                          for (var W = [], x = 0; x < y.length; x++)
                            y[x][0].getEdges().length == 1 &&
                              (W.push(y[x]), y[x][0].getOwner().remove(y[x][0]));
                          (n.push(W),
                    ...
                    (D.prototype.findPlaceforPrunedNode = function (n) {
                      var m,
                        ...
                        E = n[0];
                      if (
                        (E == n[1].source ? (p = n[1].target) : (p = n[1].source),
                        s.PURE_INCREMENTAL)
                      )
                        E.setCenter(
                  ...
                  ((u.prototype.calculateDisplacement = function () {
                    ...
                    (this.getChild() != null && this.fixedNodeWeight
                      ...
                      Math.abs(this.displacementX) > o.coolingFactor * o.maxNodeDisplacement &&
                        (this.displacementX =
                          o.coolingFactor * o.maxNodeDisplacement * i.sign(this.displacementX)),
                      Math.abs(this.displacementY) > o.coolingFactor * o.maxNodeDisplacement &&
                        (this.displacementY =
                          o.coolingFactor * o.maxNodeDisplacement * i.sign(this.displacementY)),
                      this.child &&
                    ...
                    (u.prototype.propogateDisplacementToChildren = function (o, s) {
                      for (var c = this.getChild().getNodes(), f, T = 0; T < c.length; T++)
                        ((f = c[T]),
                          f.getChild() == null
                            ? ((f.displacementX += o), (f.displacementY += s))
                    ...
                    (u.prototype.setPred1 = function (o) {
                      this.pred1 = o;
                    }),
                    ...
                    (u.prototype.setNext = function (o) {
                      this.next = o;
                    }),
                    (u.prototype.getNext = function () {
                      return next;
                    }),
                    (u.prototype.setProcessed = function (o) {
                      this.processed = o;
                    }),
                ...
                902: (a, e, r) => {
                  function l(c) {
                    if (Array.isArray(c)) {
                      for (var f = 0, T = Array(c.length); f < c.length; f++) T[f] = c[f];
                      return T;
                  ...
                  ((s.handleConstraints = function (c) {
                    ...
                    f.relativePlacementConstraint &&
                      f.relativePlacementConstraint.forEach(function (S) {
                        !S.gap &&
                          S.gap != 0 &&
                          (S.left
                            ? (S.gap =
                                i.DEFAULT_EDGE_LENGTH +
                                T.get(S.left).getWidth() / 2 +
                                T.get(S.right).getWidth() / 2)
                            : (S.gap =
                                i.DEFAULT_EDGE_LENGTH +
                                T.get(S.top).getHeight() / 2 +
                                T.get(S.bottom).getHeight() / 2));
                      });
                    var U = function (P, B) {
                      ...
                      K = function (P) {
                        ...
                        return (
                          P.forEach(function (k) {
                            ((B += v[g.get(k)]), (J += L[g.get(k)]));
                          }),
                          { x: B / P.size, y: J / P.size }
                        );
                      },
                      D = function (P, B, J, k, at) {
                        function ct(lt, ot) {
                          var Lt = new Set(lt),
                            ft = !0,
                            st = !1,
                            ...
                            ? (ut.push(ot),
                              J ||
                                (B == "horizontal"
                                  ...
                                  : tt.set(ot, g.has(ot) ? L[g.get(ot)] : k.get(ot))))
                            ...
                            at.forEach(function (lt) {
                              ...
                              if (
                                ...
                                (ot.forEach(function (st) {
                                  B == "horizontal"
                                    ? (tt.set(st, g.has(st) ? v[g.get(st)] : k.get(st)),
                                      (Lt += tt.get(st)))
                                    : (tt.set(st, g.has(st) ? L[g.get(st)] : k.get(st)),
                                      (Lt += tt.get(st)));
                                }),
                                  (Lt = Lt / ot.length),
                                  lt.forEach(function (st) {
                                ...
                                (lt.forEach(function (st) {
                                  B == "horizontal"
                                    ...
                                    : (ft += g.has(st) ? L[g.get(st)] : k.get(st));
                                }),
                                  (ft = ft / lt.length),
                                  lt.forEach(function (st) {
                                    tt.set(st, ft);
                                ...
                                if (J && J.has(ft.id)) {
                                  ...
                                  if (
                                    (B == "horizontal"
                                      ...
                                      : (st = g.has(ft.id) ? L[g.get(ft.id)] : k.get(ft.id)),
                                    tt.set(ft.id, st),
                                    st < tt.get(ot) + ft.gap)
                                  ) {
                        ...
                        if (J) {
                          ...
                          (j.forEach(function (lt, ot) {
                            ...
                            xt.forEach(function (lt, ot) {
                              ...
                              try {
                                for (
                                  ...
                                  B == "horizontal"
                                    ...
                                    : (kt = g.has(St) ? L[g.get(St)] : k.get(St));
                                  var Kt = tt.get(St);
                                  (kt < Lt && (Lt = kt),
                                    kt > st && (st = kt),
                                    Kt < ft && (ft = Kt),
                              ...
                              var fe = (Lt + st) / 2 - (ft + Xt) / 2,
                                Qt = !0,
                                jt = !1,
                                _t = void 0;
                              try {
                                for (
                                  var Jt = lt[Symbol.iterator](), ne;
                                  !(Qt = (ne = Jt.next()).done);
                                  Qt = !0
                                ) {
                                  var te = ne.value;
                                  tt.set(te, tt.get(te) + fe);
                                }
                              } catch (ee) {
                                ((jt = !0), (_t = ee));
                              } finally {
                      ...
                      it = function (P) {
                          ...
                          (P.forEach(function (j) {
                            j.left
                              ? v[g.get(j.left)] - v[g.get(j.right)] >= 0
                                ? B++
                                : J++
                              : L[g.get(j.top)] - L[g.get(j.bottom)] >= 0
                                ? k++
                                : at++;
                          }),
                          B > J && k > at)
                        ...
                        else if (B > J) for (var nt = 0; nt < g.size; nt++) v[nt] = -1 * v[nt];
                        else if (k > at) for (var tt = 0; tt < g.size; tt++) L[tt] = -1 * L[tt];
                      },
                      n = function (P) {
                        var B = [],
                          J = new u(),
                      ...
                      q = [];
                    if (
                      (f.fixedNodeConstraint &&
                        f.fixedNodeConstraint.forEach(function (S) {
                          R.add(S.nodeId);
                        }),
                      f.relativePlacementConstraint &&
                        (f.relativePlacementConstraint.forEach(function (S) {
                          S.left
                            ? (W.has(S.left)
                                ...
                                : W.set(S.left, [
                                    { id: S.right, gap: S.gap, direction: "horizontal" },
                                  ]),
                              W.has(S.right) || W.set(S.right, []))
                            : (W.has(S.top)
                                ? W.get(S.top).push({
                                    id: S.bottom,
                                    gap: S.gap,
                                ...
                                : W.set(S.top, [
                                    { id: S.bottom, gap: S.gap, direction: "vertical" },
                                  ]),
                              W.has(S.bottom) || W.set(S.bottom, []));
                        }),
                        (x = m(W)),
                        (q = n(x))),
                      ...
                      if (f.fixedNodeConstraint && f.fixedNodeConstraint.length > 1)
                        (f.fixedNodeConstraint.forEach(function (S, P) {
                          ((E[P] = [S.position.x, S.position.y]),
                            (y[P] = [v[g.get(S.nodeId)], L[g.get(S.nodeId)]]));
                        }),
                          (I = !0));
                        ...
                        (function () {
                          ...
                          if (f.alignmentConstraint.vertical) {
                            for (
                              var P = f.alignmentConstraint.vertical,
                                B = function (tt) {
                                  var j = new Set();
                                  P[tt].forEach(function (pt) {
                                    j.add(pt);
                                  });
                                  var ut = new Set(
                                    ...
                                    Mt = void 0;
                                  (ut.size > 0
                                    ? (Mt = v[g.get(ut.values().next().value)])
                                    : (Mt = K(j).x),
                                    P[tt].forEach(function (pt) {
                                      ((E[S] = [Mt, L[g.get(pt)]]),
                                        (y[S] = [v[g.get(pt)], L[g.get(pt)]]),
                                        S++);
                                    }));
                                },
                                J = 0;
                          ...
                          if (f.alignmentConstraint.horizontal) {
                            for (
                              var k = f.alignmentConstraint.horizontal,
                                at = function (tt) {
                                  var j = new Set();
                          ...
                          f.relativePlacementConstraint && (w = !0);
                        })();
                      else if (f.relativePlacementConstraint) {
                        for (var V = 0, Y = 0, et = 0; et < q.length; et++)
                          q[et].length > V && ((V = q[et].length), (Y = et));
                        if (V < x.size / 2) (it(f.relativePlacementConstraint), (I = !1), (w = !1));
                        else {
                          var z = new Map(),
                            O = new Map(),
                            H = [];
                          (q[Y].forEach(function (S) {
                            W.get(S).forEach(function (P) {
                              P.direction == "horizontal"
                                ? (z.has(S) ? z.get(S).push(P) : z.set(S, [P]),
                                  z.has(P.id) || z.set(P.id, []),
                                  H.push({ left: S, right: P.id }))
                                : (O.has(S) ? O.get(S).push(P) : O.set(S, [P]),
                                  O.has(P.id) || O.set(P.id, []),
                                  H.push({ top: S, bottom: P.id }));
                            });
                          }),
                            it(H),
                            (w = !1));
                          var $ = D(z, "horizontal"),
                            _ = D(O, "vertical");
                          (q[Y].forEach(function (S, P) {
                            ((y[P] = [v[g.get(S)], L[g.get(S)]]),
                              (E[P] = []),
                              $.has(S) ? (E[P][0] = $.get(S)) : (E[P][0] = v[g.get(S)]),
                              _.has(S) ? (E[P][1] = _.get(S)) : (E[P][1] = L[g.get(S)]));
                          }),
                            (I = !0));
                        }
                      }
                      if (I) {
                        for (
                          var ht = void 0, Q = t.transpose(E), It = t.transpose(y), Nt = 0;
                          Nt < Q.length;
                          Nt++
                        )
                        ...
                        w && it(f.relativePlacementConstraint);
                      }
                    }
                    if (i.ENFORCE_CONSTRAINTS) {
                      if (f.fixedNodeConstraint && f.fixedNodeConstraint.length > 0) {
                        var Et = { x: 0, y: 0 };
                        (f.fixedNodeConstraint.forEach(function (S, P) {
                          var B = { x: v[g.get(S.nodeId)], y: L[g.get(S.nodeId)] },
                            J = S.position,
                            k = U(J, B);
                          ((Et.x += k.x), (Et.y += k.y));
                        }),
                          ...
                          v.forEach(function (S, P) {
                            v[P] += Et.x;
                          }),
                          L.forEach(function (S, P) {
                            L[P] += Et.y;
                          }),
                          f.fixedNodeConstraint.forEach(function (S) {
                            ((v[g.get(S.nodeId)] = S.position.x),
                              (L[g.get(S.nodeId)] = S.position.y));
                          }));
                      }
                      if (f.alignmentConstraint) {
                        if (f.alignmentConstraint.vertical)
                          for (
                            var Dt = f.alignmentConstraint.vertical,
                              Rt = function (P) {
                                var B = new Set();
                                ...
                                var J = new Set(
                                    [].concat(l(B)).filter(function (at) {
                                      return R.has(at);
                                    })
                                  ),
                                  k = void 0;
                                (J.size > 0
                                  ? (k = v[g.get(J.values().next().value)])
                                  : (k = K(B).x),
                                  B.forEach(function (at) {
                                    R.has(at) || (v[g.get(at)] = k);
                                  }));
                              },
                              Ht = 0;
                            Ht < Dt.length;
                        ...
                        if (f.alignmentConstraint.horizontal)
                          for (
                            var Ut = f.alignmentConstraint.horizontal,
                              Pt = function (P) {
                                var B = new Set();
                                ...
                                var J = new Set(
                                  ...
                                  k = void 0;
                                (J.size > 0
                                  ? (k = L[g.get(J.values().next().value)])
                                  : (k = K(B).y),
                                  B.forEach(function (at) {
                                    R.has(at) || (L[g.get(at)] = k);
                                  }));
                              },
                              Ft = 0;
                            Ft < Ut.length;
                      ...
                      f.relativePlacementConstraint &&
                        (function () {
                          ...
                          if (
                            ...
                            if (f.alignmentConstraint.vertical)
                              for (
                                var tt = f.alignmentConstraint.vertical,
                                  j = function (yt) {
                                    (B.set("dummy" + yt, []),
                                      tt[yt].forEach(function (wt) {
                                        (S.set(wt, "dummy" + yt),
                                          B.get("dummy" + yt).push(wt),
                                          R.has(wt) && ct.add("dummy" + yt));
                                      }),
                            ...
                            if (f.alignmentConstraint.horizontal)
                              for (
                                var Mt = f.alignmentConstraint.horizontal,
                                  pt = function (yt) {
                                    (J.set("dummy" + yt, []),
                                      Mt[yt].forEach(function (wt) {
                                        (P.set(wt, "dummy" + yt),
                                          J.get("dummy" + yt).push(wt),
                                          R.has(wt) && nt.add("dummy" + yt));
                                      }),
                          ...
                          (St.forEach(function (Gt, yt) {
                            ...
                            kt.forEach(function (Gt, yt) {
                              ((jt[yt] = []),
                                Gt.forEach(function (wt) {
                                  fe.get(wt).length == 0 && jt[yt].push(wt);
                                }));
                            }));
                          ...
                          try {
                            for (
                              var ce = _t.keys()[Symbol.iterator](), Ne;
                              !(te = (Ne = ce.next()).done);
                              te = !0
                            ) {
                              var ge = Ne.value;
                          ...
                          try {
                            for (
                              var de = Jt.keys()[Symbol.iterator](), Ae;
                              !(ue = (Ae = de.next()).done);
                              ue = !0
                            ) {
                              var ge = Ae.value;
            ...
            function d(a) {
              ...
              var r = (N[a] = { exports: {} });
              return (G[a](r, r.exports, d), r.exports);
            }
            var h = d(45);
            return h;
          })();
            ...
            var G = {
                ...
                548: (a, e, r) => {
                      ...
                      function t(o, s) {
                        ...
                        try {
                          for (
                            ...
                            !(f = (L = v.next()).done) && (c.push(L.value), !(s && c.length === s));
                            f = !0
                          );
                        } catch (F) {
                          ((T = !0), (g = F));
                  ...
                  ((u.getTopMostNodes = function (t) {
                    ...
                    (u.connectComponents = function (t, o, s, c) {
                      var f = new i(),
                        T = new Set(),
                        g = [],
                        v = void 0,
                          ...
                          for (
                            var p = function () {
                              ...
                              for (var w = 0; w < I.length; w++) {
                                var R = I[w];
                                if (
                                  ((v = s.intersection(R.union(R.ancestors()))),
                                  v != null && !T.has(v[0]))
                                ) {
                                  var W = v.union(v.descendants());
                                  W.forEach(function (x) {
                                    (f.push(x), T.add(x), it.merge(x), s.has(x) && g.push(x));
                                  });
                                }
                              }
                            };
                            ...
                            p();
                          if (
                            (it.forEach(function (y) {
                              o.intersection(y.connectedEdges()).forEach(function (I) {
                                it.has(I.source()) && it.has(I.target()) && it.merge(I);
                              });
                            }),
                            g.length == s.length && (A = !0),
                            !A || (A && b > 1))
                          ) {
                            ((L = g[0]),
                              (F = L.connectedEdges().length),
                              g.forEach(function (y) {
                                y.connectedEdges().length < F &&
                                  ((F = y.connectedEdges().length), (L = y));
                              }),
                              Z.push(L.id()));
                            var E = t.collection();
                            (E.merge(g[0]),
                      ...
                      do K();
                      while (!A);
                      return (c && Z.length > 0 && c.set("dummy" + (c.size + 1), Z), U);
                    }),
                    (u.relocateComponent = function (t, o, s) {
                      if (!s.fixedNodeConstraint) {
                        ...
                        if (s.quality == "draft") {
                          ...
                          try {
                            for (
                              var A = o.nodeIndexes[Symbol.iterator](), b;
                              !(v = (b = A.next()).done);
                              v = !0
                            ) {
                              var Z = b.value,
                                ...
                                K = U[0],
                                D = U[1],
                                it = s.cy.getElementById(K);
                              if (it) {
                                var n = it.boundingBox(),
                                  m = o.xCoords[D] - n.w / 2,
                                  p = o.xCoords[D] + n.w / 2,
                                  E = o.yCoords[D] - n.h / 2,
                                  y = o.yCoords[D] + n.h / 2;
                    ...
                    (u.calcBoundingBox = function (t, o, s, c) {
                      for (
                        ...
                        var D = Z[K];
                        ((L = o[c.get(D.id())] - D.width() / 2),
                          (F = o[c.get(D.id())] + D.width() / 2),
                          (A = s[c.get(D.id())] - D.height() / 2),
                          (b = s[c.get(D.id())] + D.height() / 2),
                          f > L && (f = L),
                          T < F && (T = F),
                          g > A && (g = A),
                          v < b && (v = b));
                    ...
                    (u.calcParentsWithoutChildren = function (t, o) {
                      var s = t.collection();
                      return (
                  ...
                  var l = r(548),
                    ...
                    T = function (v, L) {
                      ...
                      var n = function (x) {
                        ...
                        p = l.calcParentsWithoutChildren(F, A),
                              ...
                              if (Y.randomize)
                                if (!O.isParent())
                                  $ = x.add(
                                    new u(
                                      V.graphManager,
                                      new t(K[U.get(O.id())] - _.w / 2, D[U.get(O.id())] - _.h / 2),
                                      new o(parseFloat(_.w), parseFloat(_.h))
                                    )
                                  );
                                else {
                                  var ht = l.calcBoundingBox(O, K, D, U);
                        ...
                        y = function (x, q, V) {
                          ...
                          v.idealEdgeLength != null &&
                            (et > 0
                              ? (f.DEFAULT_EDGE_LENGTH = c.DEFAULT_EDGE_LENGTH = Y / et)
                              : n(v.idealEdgeLength)
                                ? (f.DEFAULT_EDGE_LENGTH = c.DEFAULT_EDGE_LENGTH = 50)
                                : (f.DEFAULT_EDGE_LENGTH = c.DEFAULT_EDGE_LENGTH =
                                    v.idealEdgeLength),
                            (f.MIN_REPULSION_DIST = c.MIN_REPULSION_DIST =
                              c.DEFAULT_EDGE_LENGTH / 10),
                            (f.DEFAULT_RADIAL_SEPARATION = c.DEFAULT_EDGE_LENGTH));
                        },
                        I = function (x, q) {
                          (q.fixedNodeConstraint &&
                            (x.constraints.fixedNodeConstraint = q.fixedNodeConstraint),
                      ...
                      (v.nestingFactor != null &&
                        ...
                        v.numIter != null && (f.MAX_ITERATIONS = c.MAX_ITERATIONS = v.numIter),
                        v.gravityRange != null &&
                          (f.DEFAULT_GRAVITY_RANGE_FACTOR = c.DEFAULT_GRAVITY_RANGE_FACTOR =
                            v.gravityRange),
                        v.gravityCompound != null &&
                          (f.DEFAULT_COMPOUND_GRAVITY_STRENGTH =
                        ...
                        v.step == "transformed" &&
                          ((f.TRANSFORM_ON_CONSTRAINT_HANDLING = !0),
                          (f.ENFORCE_CONSTRAINTS = !1),
                          (f.APPLY_LAYOUT = !1)),
                        v.step == "enforced" &&
                          ((f.TRANSFORM_ON_CONSTRAINT_HANDLING = !1),
                          (f.ENFORCE_CONSTRAINTS = !0),
                          (f.APPLY_LAYOUT = !1)),
                        v.step == "cose" &&
                          ((f.TRANSFORM_ON_CONSTRAINT_HANDLING = !1),
                          (f.ENFORCE_CONSTRAINTS = !1),
                        ...
                        v.relativePlacementConstraint
                          ? (f.TREE_REDUCTION_ON_INCREMENTAL = !1)
                          : (f.TREE_REDUCTION_ON_INCREMENTAL = !0));
                      var w = new i(),
                        R = w.newGraphManager();
                      return (
                        E(R.addRoot(), l.getTopMostNodes(b), w, v),
                        y(w, R, Z),
                        I(w, v),
                        w.runLayout(),
                        it
                        ...
                        l(v, [
                          {
                            ...
                            value: function () {
                              var F = this,
                                ...
                                D = void 0,
                                it = [];
                              (A.fixedNodeConstraint &&
                                (!Array.isArray(A.fixedNodeConstraint) ||
                                  A.fixedNodeConstraint.length == 0) &&
                                (A.fixedNodeConstraint = void 0),
                                A.alignmentConstraint &&
                                  (A.alignmentConstraint.vertical &&
                                    (!Array.isArray(A.alignmentConstraint.vertical) ||
                                      A.alignmentConstraint.vertical.length == 0) &&
                                    (A.alignmentConstraint.vertical = void 0),
                                  A.alignmentConstraint.horizontal &&
                                    (!Array.isArray(A.alignmentConstraint.horizontal) ||
                                      A.alignmentConstraint.horizontal.length == 0) &&
                                    (A.alignmentConstraint.horizontal = void 0)),
                                A.relativePlacementConstraint &&
                                  (!Array.isArray(A.relativePlacementConstraint) ||
                                    A.relativePlacementConstraint.length == 0) &&
                                  (A.relativePlacementConstraint = void 0));
                              var n =
                                A.fixedNodeConstraint ||
                                A.alignmentConstraint ||
                                A.relativePlacementConstraint;
                              ...
                              if (
                                (b.layoutUtilities &&
                                  A.packComponents &&
                                  ((m = b.layoutUtilities("get")),
                                  m || (m = b.layoutUtilities()),
                                  (p = !0)),
                                Z.nodes().length > 0)
                              )
                                if (p) {
                                  ...
                                  if (
                                    ((D = t.connectComponents(b, A.eles, I)),
                                    ...
                                    if (A.tile) {
                                      var R = new Map(),
                                        ...
                                        x = [],
                                        q = 0,
                                        V = { nodeIndexes: R, xCoords: W, yCoords: x },
                                        Y = [];
                                      if (
                                    ...
                                    D.forEach(function (vt, rt) {
                                      ((A.eles = vt),
                                        K.push(f(A, U[rt])),
                                        t.relocateComponent(it[rt], K[rt], A));
                                    });
                                  } else
                                    D.forEach(function (vt, rt) {
                                      t.relocateComponent(it[rt], U[rt], A);
                                    });
                                  var O = new Set();
                                  if (D.length > 1) {
                                    var H = [],
                                    ...
                                    D.forEach(function (vt, rt) {
                                      var gt = void 0;
                                      if (
                                        (A.quality == "draft" && (gt = U[rt].nodeIndexes),
                                        vt.nodes().not($).length > 0)
                                      ) {
                                        var mt = {};
                                        ((mt.edges = []), (mt.nodes = []));
                                        var At = void 0;
                                          ...
                                          .forEach(function (Ot) {
                                            if (A.quality == "draft")
                                              if (!Ot.isParent())
                                                ((At = gt.get(Ot.id())),
                                                  mt.nodes.push({
                                                    x: U[rt].xCoords[At] - Ot.boundingbox().w / 2,
                                                    y: U[rt].yCoords[At] - Ot.boundingbox().h / 2,
                                                    width: Ot.boundingbox().w,
                                                    height: Ot.boundingbox().h,
                                                  }));
                                              else {
                                                var Et = t.calcBoundingBox(
                                                  Ot,
                                                  U[rt].xCoords,
                                                  U[rt].yCoords,
                                                  gt
                                              ...
                                              K[rt][Ot.id()] &&
                                                mt.nodes.push({
                                                  x: K[rt][Ot.id()].getLeft(),
                                                  y: K[rt][Ot.id()].getTop(),
                                                  width: K[rt][Ot.id()].getWidth(),
                                                  height: K[rt][Ot.id()].getHeight(),
                                                });
                                          }),
                                            ...
                                            if (
                                              ...
                                              if (A.quality == "draft") {
                                                ...
                                                if (Et.isParent()) {
                                                  ...
                                                  (Ut.push(U[rt].xCoords[Rt]),
                                                    Ut.push(U[rt].yCoords[Rt]));
                                                if (Dt.isParent()) {
                                                  ...
                                                  (Pt.push(U[rt].xCoords[Ht]),
                                                    Pt.push(U[rt].yCoords[Ht]));
                                                mt.edges.push({
                                                  startX: Ut[0],
                                                  startY: Ut[1],
                                                  endX: Pt[0],
                                                ...
                                                K[rt][Et.id()] &&
                                                  K[rt][Dt.id()] &&
                                                  mt.edges.push({
                                                    startX: K[rt][Et.id()].getCenterX(),
                                                    startY: K[rt][Et.id()].getCenterY(),
                                                    endX: K[rt][Dt.id()].getCenterX(),
                                                    endY: K[rt][Dt.id()].getCenterY(),
                                                  });
                                          }),
                                          mt.nodes.length > 0 && (H.push(mt), O.add(rt)));
                                      }
                                    });
                                    ...
                                    if (A.quality == "draft")
                                      ...
                                      O.forEach(function (vt) {
                                        (Object.keys(K[vt]).forEach(function (rt) {
                                          var gt = K[vt][rt];
                                          gt.setCenter(
                                            gt.getCenterX() + _[ht].dx,
                                            gt.getCenterY() + _[ht].dy
                                          );
                                        }),
                                          ht++);
                                      });
                                  ...
                                  if (
                                    (it.push({ x: E.x1 + E.w / 2, y: E.y1 + E.h / 2 }), A.randomize)
                                  ) {
                                    var y = s(A);
                                    U.push(y);
                                  }
                                  A.quality == "default" || A.quality == "proof"
                                    ? (K.push(f(A, U[0])), t.relocateComponent(it[0], K[0], A))
                                    : t.relocateComponent(it[0], U[0], A);
                                }
                              ...
                              if (A.quality == "default" || A.quality == "proof" || A.randomize) {
                                var It = t.calcParentsWithoutChildren(b, Z),
                                  Nt = Z.filter(function (vt) {
                                    return vt.css("display") == "none";
                                  });
                                ((A.eles = Z.not(Nt)),
                                  Z.nodes().not(":parent").not(Nt).layoutPositions(F, A, Q),
                                  It.length > 0 &&
                  ...
                  var l = r(548),
                    ...
                    t = function (s) {
                      var c = s.cy,
                        ...
                        R = void 0,
                        W = function () {
                          for (var P = 0, B = 0, J = !1; B < R; ) {
                            ((P = Math.floor(Math.random() * m)), (J = !1));
                            for (var k = 0; k < B; k++)
                              if (U[k] == P) {
                                J = !0;
                                break;
                        ...
                        x = function (P, B, J) {
                          for (
                            ...
                            j[pt] = p;
                          for (k[ct] = P, j[P] = 0; ct >= at; ) {
                            nt = k[at++];
                            for (var xt = A[nt], lt = 0; lt < xt.length; lt++)
                              ((tt = L.get(xt[lt])),
                                j[tt] == p && ((j[tt] = j[nt] + 1), (k[++ct] = tt)));
                            D[nt][B] = j[nt] * w;
                          }
                          if (J) {
                            for (var ot = 0; ot < m; ot++) D[ot][B] < K[ot] && (K[ot] = D[ot][B]);
                            for (var Lt = 0; Lt < m; Lt++) K[Lt] > ut && ((ut = K[Lt]), (Mt = Lt));
                          }
                          return Mt;
                        },
                        q = function (P) {
                          ...
                          if (P) {
                            ...
                            for (var at = 0; at < R; at++) ((U[at] = B), (B = x(B, at, P)));
                          } else {
                            W();
                            for (var J = 0; J < R; J++) x(U[J], J, P);
                          }
                          for (var ct = 0; ct < m; ct++)
                            for (var nt = 0; nt < R; nt++) D[ct][nt] *= D[ct][nt];
                          for (var tt = 0; tt < R; tt++) it[tt] = [];
                          for (var j = 0; j < R; j++)
                            for (var ut = 0; ut < R; ut++) it[j][ut] = D[U[ut]][j];
                        },
                        V = function () {
                          for (
                            var P = u.svd(it),
                            ...
                            for (var tt = 0; tt < R; tt++)
                              ((ct[nt][tt] = 0),
                                nt == tt &&
                                  (ct[nt][tt] = B[nt] / (B[nt] * B[nt] + at / (B[nt] * B[nt]))));
                          }
                          n = i.multMat(i.multMat(k, ct), i.transpose(J));
                        },
                        Y = function () {
                          for (
                            var P = void 0, B = void 0, J = [], k = [], at = [], ct = [], nt = 0;
                            nt < m;
                            nt++
                          )
                          ...
                          ((b = i.multCons(at, Math.sqrt(Math.abs(P)))),
                            (Z = i.multCons(ct, Math.sqrt(Math.abs(B)))));
                        };
                      (l.connectComponents(c, f, l.getTopMostNodes(T), v),
                        g.forEach(function (S) {
                          l.connectComponents(
                            c,
                            f,
                            l.getTopMostNodes(S.descendants().intersection(f)),
                            v
                          );
                        }));
                      ...
                      try {
                        for (
                          var _ = v.keys()[Symbol.iterator](), ht;
                          !(O = (ht = _.next()).done);
                          O = !0
                        ) {
                          var Q = ht.value;
                      ...
                      for (var It = 0; It < L.size; It++) A[It] = [];
                      (g.forEach(function (S) {
                        for (
                          var P = S.children().intersection(f);
                          P.nodes(":childless").length == 0;
                        )
                          P = P.nodes()[0].children().intersection(f);
                        var B = 0,
                          J = P.nodes(":childless")[0].connectedEdges().length;
                        (P.nodes(":childless").forEach(function (k, at) {
                          k.connectedEdges().length < J &&
                            ((J = k.connectedEdges().length), (B = at));
                        }),
                          F.set(S.id(), P.nodes(":childless")[B].id()));
                      }),
                        T.forEach(function (S) {
                          var P = void 0;
                          (S.isParent() ? (P = L.get(F.get(S.id()))) : (P = L.get(S.id())),
                            S.neighborhood()
                              .nodes()
                              .forEach(function (B) {
                                f.intersection(S.edgesWith(B)).length > 0 &&
                                  (B.isParent() ? A[P].push(F.get(B.id())) : A[P].push(B.id()));
                              }));
                        }));
                      var Nt = function (P) {
                          var B = L.get(P),
                            J = void 0;
                          v.get(P).forEach(function (k) {
                      ...
                      try {
                        for (
                          var mt = v.keys()[Symbol.iterator](), At;
                          !(vt = (At = mt.next()).done);
                          vt = !0
                        ) {
                          var Ot = At.value;
                      ...
                      if (m > 2) {
                        ...
                        for (var Rt = 0; Rt < R; Rt++) n[Rt] = [];
                        return (
                          s.quality == "draft" || s.step == "all"
                            ? (q(I), V(), Y(), (Et = { nodeIndexes: L, xCoords: b, yCoords: Z }))
                            : (L.forEach(function (S, P) {
                                (b.push(c.getElementById(P).position("x")),
                                  Z.push(c.getElementById(P).position("y")));
                              }),
                              (Et = { nodeIndexes: L, xCoords: b, yCoords: Z })),
                          Et
                        );
                      } else {
                        var Ht = L.keys(),
                          ...
                          Pt = Ut.position(),
                          Ft = Ut.outerWidth();
                        if ((b.push(Pt.x), Z.push(Pt.y), m == 2)) {
                          var Yt = c.getElementById(Ht.next().value),
                            Vt = Yt.outerWidth();
                          (b.push(Pt.x + Ft / 2 + Vt / 2 + s.idealEdgeLength), Z.push(Pt.y));
                        }
                        return ((Et = { nodeIndexes: L, xCoords: b, yCoords: Z }), Et);
                      }
                    };
...
var yr = pr();
const Er = fr(yr);
var De = { L: "left", R: "right", T: "top", B: "bottom" },
  xe = {
    L: dt((C) => `${C},${C / 2} 0,${C} 0,0`, "L"),
    R: dt((C) => `0,${C / 2} ${C},0 ${C},${C}`, "R"),
    T: dt((C) => `0,0 ${C},0 ${C / 2},${C}`, "T"),
    B: dt((C) => `${C / 2},0 ${C},${C} 0,${C}`, "B"),
  },
  oe = {
    L: dt((C, X) => C - X + 2, "L"),
    R: dt((C, X) => C - 2, "R"),
  ...
  pe = dt(function (C, X) {
    const M = `${C}${X}`;
    return Nr(M) ? M : void 0;
  }, "getArchitectureDirectionPair"),
  Lr = dt(function ([C, X], M) {
    const G = M[0],
      N = M[1];
    return Wt(G)
      ? qt(N)
  ...
  Ar = dt(function (C, X) {
    return me(C, X) ? "bend" : Wt(C) ? "horizontal" : "vertical";
  ...
  Fe = dt((C) => C.data(), "edgeData"),
  ie = dt((C) => C.data(), "nodeData"),
  Or = rr.architecture,
  be = class {
    constructor() {
      ((this.nodes = {}),
        ...
        (this.getDiagramTitle = Je),
        (this.getAccDescription = Ke),
        (this.setAccDescription = je),
        this.clear());
    }
    static {
    ...
    addService({ id: C, icon: X, in: M, title: G, iconText: N }) {
      if (this.registeredIds[C] !== void 0)
        throw new Error(
          `The service id [${C}] is already in use by another ${this.registeredIds[C]}`
        );
      if (M !== void 0) {
        if (C === M) throw new Error(`The service [${C}] cannot be placed within itself`);
        ...
        if (this.registeredIds[M] === "node")
          throw new Error(`The service [${C}]'s parent is not a group`);
      }
      ((this.registeredIds[C] = "node"),
        (this.nodes[C] = {
          id: C,
          type: "service",
          icon: X,
    ...
    addJunction({ id: C, in: X }) {
      ((this.registeredIds[C] = "node"),
        (this.nodes[C] = { id: C, type: "junction", edges: [], in: X }));
    }
    getJunctions() {
    ...
    addGroup({ id: C, icon: X, in: M, title: G }) {
      if (this.registeredIds?.[C] !== void 0)
        throw new Error(
          `The group id [${C}] is already in use by another ${this.registeredIds[C]}`
        );
      if (M !== void 0) {
        if (C === M) throw new Error(`The group [${C}] cannot be placed within itself`);
        if (this.registeredIds?.[M] === void 0)
          throw new Error(
      ...
      ((this.registeredIds[C] = "group"), (this.groups[C] = { id: C, icon: X, title: G, in: M }));
    }
    getGroups() {
    ...
    addEdge({
      ...
      if (!Ie(M))
        throw new Error(
          `Invalid direction given for left hand side of edge ${C}--${X}. Expected (L,R,T,B) got ${String(M)}`
        );
      if (!Ie(G))
        throw new Error(
          `Invalid direction given for right hand side of edge ${C}--${X}. Expected (L,R,T,B) got ${String(G)}`
        );
      ...
      (this.edges.push(i),
        this.nodes[C] &&
          this.nodes[X] &&
          (this.nodes[C].edges.push(this.edges[this.edges.length - 1]),
    ...
    getDataStructures() {
      if (this.dataStructures === void 0) {
        const C = {},
          X = Object.entries(this.nodes).reduce(
            (a, [e, r]) => (
              (a[e] = r.edges.reduce((l, i) => {
                const u = this.getNode(i.lhsId)?.in,
                  t = this.getNode(i.rhsId)?.in;
                if (u && t && u !== t) {
                  const o = Ar(i.lhsDir, i.rhsDir);
                  o !== "bend" && ((C[u] ??= {}), (C[u][t] = o), (C[t] ??= {}), (C[t][u] = o));
                }
                if (i.lhsId === e) {
                  const o = pe(i.lhsDir, i.rhsDir);
                  o && (l[o] = i.rhsId);
                } else {
                  const o = pe(i.rhsDir, i.lhsDir);
                  o && (l[o] = i.lhsId);
                }
                return l;
              }, {})),
          ...
          M = Object.keys(X)[0],
          G = { [M]: 1 },
          N = Object.keys(X).reduce((a, e) => (e === M ? a : { ...a, [e]: 1 }), {}),
          d = dt((a) => {
            const e = { [a]: [0, 0] },
              r = [a];
            for (; r.length > 0; ) {
          ...
          h = [d(M)];
        for (; Object.keys(N).length > 0; ) h.push(d(Object.keys(N)[0]));
        this.dataStructures = { adjList: X, spatialMaps: h, groupAlignments: C };
      }
  ...
  Dr = dt((C, X) => {
    (hr(C, X),
      C.groups.map((M) => X.addGroup(M)),
      C.services.map((M) => X.addService({ ...M, type: "service" })),
      C.junctions.map((M) => X.addJunction({ ...M, type: "junction" })),
      C.edges.map((M) => X.addEdge(M)));
  }, "populateDb"),
  Pe = {
    parser: { yy: void 0 },
    parse: dt(async (C) => {
      const X = await lr("architecture", C);
      Re.debug(X);
      const M = Pe.parser?.yy;
      if (!(M instanceof be))
        throw new Error(
...
`,
  ...
  Ir = xr,
  re = dt(
    (C) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${C}</g>`,
    "wrapIcon"
  ),
  ae = {
  ...
  Rr = dt(async function (C, X, M) {
    const G = M.getConfigField("padding"),
    ...
    await Promise.all(
      X.edges().map(async (e) => {
        ...
        let { x: F, y: A } = e[0].targetEndpoint();
        const b = G + 4;
        if (
          (u && (Wt(l) ? (T += l === "L" ? -b : b) : (g += l === "T" ? -b : b + 18)),
          c && (Wt(o) ? (F += o === "L" ? -b : b) : (A += o === "T" ? -b : b + 18)),
          !u &&
            M.getNode(r)?.type === "junction" &&
            (Wt(l) ? (T += l === "L" ? d : -d) : (g += l === "T" ? d : -d)),
          !c &&
            M.getNode(t)?.type === "junction" &&
            (Wt(o) ? (F += o === "L" ? d : -d) : (A += o === "T" ? d : -d)),
          e[0]._private.rscratch)
        ) {
          const Z = C.insert("g");
          if (
            (Z.insert("path")
              .attr("d", `M ${T},${g} L ${v},${L} L${F},${A} `)
              .attr("class", "edge")
              .attr("id", nr(r, t, { prefix: "L" })),
            i)
          ) {
            const U = Wt(l) ? oe[l](T, h) : T - a,
              K = qt(l) ? oe[l](g, h) : g - a;
            Z.insert("polygon")
              .attr("points", xe[l](h))
              .attr("transform", `translate(${U},${K})`)
              .attr("class", "arrow");
          }
          if (s) {
            const U = Wt(o) ? oe[o](F, h) : F - a,
              K = qt(o) ? oe[o](A, h) : A - a;
            Z.insert("polygon")
              .attr("points", xe[o](h))
              .attr("transform", `translate(${U},${K})`)
          ...
          if (f) {
            ...
            if (
              (await Ee(
                D,
                f,
                { useHtmlLabels: !1, width: K, classes: "architecture-service-label" },
                ye()
              ),
              D.attr("dy", "1em")
              ...
              D.attr("transform", "translate(" + v + ", " + L + ")");
            else if (U === "Y") D.attr("transform", "translate(" + v + ", " + L + ") rotate(-90)");
            else if (U === "XY") {
              const it = pe(l, o);
              if (it && Tr(it)) {
                const n = D.node().getBoundingClientRect(),
                  [m, p] = Cr(it);
                D.attr("dominant-baseline", "auto").attr("transform", `rotate(${-1 * m * p * 45})`);
                const E = D.node().getBoundingClientRect();
                D.attr(
                  "transform",
                  `
  ...
  Sr = dt(async function (C, X, M) {
    const N = M.getConfigField("padding") * 0.75,
      d = M.getConfigField("fontSize"),
      a = M.getConfigField("iconSize") / 2;
    await Promise.all(
      X.nodes().map(async (e) => {
        const r = ie(e);
        if (r.type === "group") {
          const { h: l, w: i, x1: u, y1: t } = e.boundingBox(),
            o = C.append("rect");
          o.attr("id", `group-${r.id}`)
            .attr("x", u + a)
            .attr("y", t + a)
            .attr("width", i)
            .attr("height", l)
          ...
          if (r.icon) {
            const T = s.append("g");
            (T.html(
              `<g>${await ve(r.icon, { height: N, width: N, fallbackPrefix: ae.prefix })}</g>`
            ),
          ...
          M.setElementForId(r.id, o);
        }
      })
    );
  }, "drawGroups"),
  Fr = dt(async function (C, X, M) {
    const G = ye();
    for (const N of M) {
      const d = X.append("g"),
        h = C.getConfigField("iconSize");
      if (N.title) {
        const l = d.append("g");
        (await Ee(
          l,
          N.title,
          { useHtmlLabels: !1, width: h * 1.5, classes: "architecture-service-label" },
          G
        ),
          l
            .attr("dy", "1em")
      ...
      const a = d.append("g");
      if (N.icon)
        a.html(`<g>${await ve(N.icon, { height: h, width: h, fallbackPrefix: ae.prefix })}</g>`);
      else if (N.iconText) {
        a.html(`<g>${await ve("blank", { height: h, width: h, fallbackPrefix: ae.prefix })}</g>`);
        const u = a
            .append("g")
            ...
            .append("div")
            .html(ir(N.iconText, G)),
          t =
            parseInt(
              window
                .getComputedStyle(u.node(), null)
                .getPropertyValue("font-size")
                .replace(/\D/g, "")
            ) ?? 16;
        u.attr("style", `-webkit-line-clamp: ${Math.floor((h - 2) / t)};`);
      } else
        a.append("path")
          .attr("class", "node-bkg")
          .attr("id", "node-" + N.id)
          .attr("d", `M0 ${h} v${-h} q0,-5 5,-5 h${h} q5,0 5,5 v${h} H0 Z`);
      d.attr("id", `service-${N.id}`).attr("class", "architecture-service");
      const { width: e, height: r } = d.node().getBBox();
      ((N.width = e), (N.height = r), C.setElementForId(N.id, d));
    }
    return 0;
  }, "drawServices"),
  br = dt(function (C, X, M) {
    M.forEach((G) => {
      const N = X.append("g"),
        d = C.getConfigField("iconSize");
      (N.append("g")
        .append("rect")
        .attr("id", "node-" + G.id)
        .attr("fill-opacity", "0")
      ...
      ((N.width = a), (N.height = e), C.setElementForId(G.id, N));
    });
  }, "drawJunctions");
...
function Ye(C, X) {
  X.nodes().map((M) => {
    ...
    ((G.x = M.position().x),
      (G.y = M.position().y),
      C.getElementById(G.id).attr("transform", "translate(" + (G.x || 0) + "," + (G.y || 0) + ")"));
  });
}
dt(Ye, "positionNodes");
function Xe(C, X) {
  C.forEach((M) => {
    X.add({
      group: "nodes",
      data: { type: "group", id: M.id, icon: M.icon, label: M.title, parent: M.in },
      classes: "node-group",
    });
  });
}
...
function He(C, X) {
  C.forEach((M) => {
    const {
      ...
      u = me(M.lhsDir, M.rhsDir) ? "segments" : "straight",
      t = {
        id: `${G}-${N}`,
        label: i,
        source: G,
        ...
        targetGroup: l,
        targetEndpoint:
          r === "L" ? "0 50%" : r === "R" ? "100% 50%" : r === "T" ? "50% 0" : "50% 100%",
      };
    X.add({ group: "edges", data: t, classes: u });
  });
}
dt(He, "addEdges");
function We(C, X, M) {
  const G = dt(
    ...
    N = X.map((a) => {
      const e = {},
        r = {};
      return (
        Object.entries(a).forEach(([l, [i, u]]) => {
          const t = C.getNode(l)?.in ?? "default";
          ((e[u] ??= {}),
            (e[u][t] ??= []),
            e[u][t].push(l),
            (r[i] ??= {}),
        ...
        {
          horiz: Object.values(G(e, "horizontal")).filter((l) => l.length > 1),
          vert: Object.values(G(r, "vertical")).filter((l) => l.length > 1),
        }
      );
    }),
    [d, h] = N.reduce(
  ...
  return { horizontal: d, vertical: h };
}
dt(We, "getAlignments");
function Ve(C, X) {
  const M = [],
    G = dt((d) => `${d[0]},${d[1]}`, "posToStr"),
    N = dt((d) => d.split(",").map((h) => parseInt(h)), "strToPos");
  return (
    C.forEach((d) => {
      const h = Object.fromEntries(Object.entries(d).map(([l, i]) => [G(i), l])),
        a = [G([0, 0])],
        e = {},
        ...
        if (l) {
          ...
          if (i) {
            ...
            Object.entries(r).forEach(([t, o]) => {
              const s = G([u[0] + o[0], u[1] + o[1]]),
                c = h[s];
              c &&
                !e[s] &&
                (a.push(s),
                M.push({ [De[t]]: c, [De[mr(t)]]: i, gap: 1.5 * X.getConfigField("iconSize") }));
            });
          }
        }
      }
...
function ze(C, X, M, G, N, { spatialMaps: d, groupAlignments: h }) {
  return new Promise((a) => {
    const e = ar("body").append("div").attr("id", "cy").attr("style", "display:none"),
      r = Se({
    ...
    (e.remove(), Xe(M, r), Ge(C, r, N), Ue(X, r, N), He(G, r));
    const l = We(N, d, h),
      i = Ve(d, N),
      u = r.layout({
        name: "fcose",
    ...
    (u.one("layoutstop", () => {
      function t(o, s, c, f) {
        ...
        const { x: v, y: L } = o,
          { x: F, y: A } = s;
        ((g =
          (f - L + ((v - c) * (L - A)) / (v - F)) / Math.sqrt(1 + Math.pow((L - A) / (v - F), 2))),
          (T = Math.sqrt(Math.pow(f - L, 2) + Math.pow(c - v, 2) - Math.pow(g, 2))));
        const b = Math.sqrt(Math.pow(F - v, 2) + Math.pow(A - L, 2));
        T = T / b;
        let Z = (F - v) * (f - L) - (A - L) * (c - v);
        switch (!0) {
          case Z >= 0:
            Z = 1;
            break;
        ...
        return ((g = Math.abs(g) * Z), (T = T * U), { distances: g, weights: T });
      }
      (dt(t, "getSegmentWeights"), r.startBatch());
      for (const o of Object.values(r.edges()))
        if (o.data?.()) {
          const { x: s, y: c } = o.source().position(),
            { x: f, y: T } = o.target().position();
          if (s !== f && c !== T) {
            const g = o.sourceEndpoint(),
              v = o.targetEndpoint(),
              { sourceDir: L } = Fe(o),
              [F, A] = qt(L) ? [g.x, v.y] : [v.x, g.y],
              { weights: b, distances: Z } = t(g, v, F, A);
            (o.style("segment-distances", Z), o.style("segment-weights", b));
          }
        }
      (r.endBatch(), u.run());
    }),
...
var Pr = dt(async (C, X, M, G) => {
    const N = G.db,
      d = N.getServices(),
      h = N.getJunctions(),
      a = N.getGroups(),
      e = N.getEdges(),
      r = N.getDataStructures(),
      l = Be(X),
      i = l.append("g");
    ...
    const t = l.append("g");
    (t.attr("class", "architecture-groups"), await Fr(N, u, d), br(N, u, h));
    const o = await ze(d, h, a, e, N, r);
    (await Rr(i, o, N),
      await Sr(t, o, N),
      Ye(N, o),
      ke(void 0, l, N.getConfigField("padding"), N.getConfigField("useMaxWidth")));
  }, "draw"),
  Gr = { draw: Pr },
  qr = {
    parser: Pe,
