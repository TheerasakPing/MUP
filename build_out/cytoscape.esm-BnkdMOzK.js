...
var _o = !0,
  ...
  ed = (function () {
    function r(e) {
      if ((ht(this, r), (this._obj = Object.create(null)), (this.size = 0), e != null)) {
        var t;
        e.instanceString != null && e.instanceString() === this.instanceString()
          ? (t = e.toArray())
          : (t = e);
  ...
  In = function (e, t) {
    ...
    if (
      (n == null &&
        (t.data && t.data.source != null && t.data.target != null ? (n = "edges") : (n = "nodes")),
      n !== "nodes" && n !== "edges")
    ) {
    ...
    if (
      (i.position.x == null && (i.position.x = 0),
      i.position.y == null && (i.position.y = 0),
      t.renderedPosition)
    ) {
            ...
            (h = function (p, m, b) {
              ...
              if ((b == null && (b = a), m * 10 <= p.length)) {
                ...
                for (E = C[C.length - 1], D = p.slice(m), x = 0, k = D.length; x < k; x++)
                  ((w = D[x]),
                    b(w, E) < 0 && (v(C, w, 0, null, b), C.pop(), (E = C[C.length - 1])));
                return C;
              }
              for (
                i(p, b), P = [], T = 0, B = f(m, p.length);
                0 <= B ? T < B : T > B;
                0 <= B ? ++T : --T
              )
                P.push(s(p, b));
...
var nd = ad(),
  ...
  sd = {
    dijkstra: function (e) {
      ...
      for (
        var E = function (I, M) {
          for (
            var O = (s ? I.edgesTo(M) : I.edgesWith(M)).intersect(y), V = 1 / 0, G, N = 0;
            N < O.length;
            N++
          ) {
            var F = O[N],
    ...
    aStar: function (e) {
      ...
      for (var x = 0; d.size() > 0; ) {
        if ((E(), x++, w === v)) {
          for (
            var T = [], k = i, D = v, B = p[D];
            T.unshift(k), B != null && T.unshift(B), (k = g[D]), k != null;
          )
            ((D = k.id()), (B = p[D]));
    ...
    bellmanFord: function (e) {
      ...
      for (
        var p = f.length,
          ...
          E = function (we) {
            for (
              var ye = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : s,
                ie = b(we),
                de = [],
                he = ie;
              ;
      ...
      for (
        var k = !1,
          D = function (we, ye, ie, de, he, Ee) {
            ...
            pe < he.dist &&
              !ie.same(de.edge) &&
              ((he.dist = pe), (he.pred = we), (he.edge = ie), (k = !0));
          },
          B = 1;
        B < h;
        B++
  ...
  gd = function (e, t, a) {
    ...
    for (
      var n = a[e], i = n[1], s = n[2], o = t[i], l = t[s], u = a, v = u.length - 1;
      v >= 0;
      v--
    ) {
      var f = u[v],
...
var wv = function (e, t, a, n, i, s, o) {
  ...
  Zr = function (e, t, a, n, i, s, o, l, u) {
    var v = new Array(a.length),
      f;
    l[0] != null
      ? ((f = Math.atan(l[1] / l[0])), l[0] < 0 ? (f = f + Math.PI / 2) : (f = -f - Math.PI / 2))
      : (f = l);
  ...
  qd = function (e, t, a, n, i, s, o, l, u) {
    ...
    if (v.length > 2) {
      for (
        var d = [v[0], v[1]], y = Math.pow(d[0] - e, 2) + Math.pow(d[1] - t, 2), g = 1;
        g < v.length / 2;
        g++
      ) {
  ...
  xv = function (e) {
    for (
      var t, a, n = e.length / 2, i = 1 / 0, s = 1 / 0, o = -1 / 0, l = -1 / 0, u = 0;
      u < n;
      u++
    )
      ((t = e[2 * u]),
  ...
  Xt = {
    ...
    degreeCentrality: function (e) {
      ...
      if (((i = t.collection(i)[0]), o)) {
        ...
        for (
          var u = i.connectedEdges().intersection(a), v = u.length, f = 0, c = 0;
          c < u.length;
          c++
        )
          f += s(u[c]);
...
var $d = cr({
  ...
  Yd = function (e, t, a) {
    for (var n = new Array(a * a), i = 0; i < a; i++) {
      ...
      for (var o = 0; o < a; o++)
        for (var l = 0; l < a; l++) n[i * a + l] += e[i * a + o] * t[o * a + l];
    }
    return n;
  },
  Zd = function (e, t, a) {
  ...
  rh = function (e) {
    for (var t = 0; t < e.length; t++)
      for (var a = 0; a < e.length; a++) t != a && eh(e[t], e[a]) && e.splice(a, 1);
    return e;
  },
  Zo = function (e) {
    for (
      var t = this.nodes(), a = this.edges(), n = this.cy(), i = Ud(e), s = {}, o = 0;
      o < t.length;
      o++
    )
      s[t[o].id()] = o;
  ...
  va = function (e, t, a, n, i) {
    for (
      var s = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : ah,
        o = n,
        l,
        u,
        v = 0;
...
function Nn(r, e, t, a, n, i) {
  var s;
  return (
    Ue(r) ? (s = r) : (s = Jt[r] || Jt.euclidean),
    e === 0 && Ue(r) ? s(n, i) : s(e, t, a, n, i)
  );
}
var sh = cr({
    k: 2,
  ...
  mi = function (e, t, a) {
    for (
      var n = a.length, i = new Array(n), s = new Array(n), o = new Array(t), l = null, u = 0;
      u < n;
      u++
    )
  ...
  vh = function (e) {
    ...
    for (var u = !0, v = 0; u && v < i.maxIterations; ) {
      ...
      for (var c = 0; c < i.k; c++) {
        ...
        if (h.length !== 0) {
          for (
            var d = i.attributes.length, y = l[c], g = new Array(d), p = new Array(d), m = 0;
            m < d;
            m++
          ) {
            p[m] = 0;
  ...
  ch = function (e, t, a, n, i) {
    for (var s, o, l = 0; l < t.length; l++)
      for (var u = 0; u < e.length; u++) n[l][u] = Math.pow(a[l][u], i.m);
  ...
  ru = function (e) {
    ...
    for (var m = !0, b = 0; m && b < n.maxIterations; )
      ((m = !1),
        ch(s, a, o, u, n),
        dh(o, l, s, a, n),
        uh(o, l, n.sensitivityThreshold) || (m = !0),
        b++);
      ...
      o = function (u) {
        ...
        if (
          ...
          for (var f = e.spawn(); ; ) {
            var c = i.pop();
            if (
              (f.merge(e.getElementById(c)), (t[c].low = t[u].index), (t[c].explored = !0), c === u)
            )
              break;
          }
          var h = f.edgesWith(f),
...
var su = function (e, t, a, n) {
  ...
  Rv = function (e) {
    e.state === Pv
      ...
      : e.state === Av && ou(e, "onRejected", e.rejectReason);
  },
  ou = function (e, t, a) {
    if (e[t].length !== 0) {
      var n = e[t];
    ...
    if (typeof a == "function") {
      ...
      try {
        a.call(
          ...
          function (i) {
            n ||
              ((n = !0), i === t ? e.reject(new TypeError("circular thenable chain")) : Mv(e, i));
          },
          function (i) {
            n || ((n = !0), e.reject(i));
          }
...
be(Pt, {
  ...
  progress: function (e) {
    ...
    return e === void 0
      ? t.progress
      : (a && this.pause(), (t.progress = e), (t.started = !1), a && this.play(), this);
  },
  completed: function () {
...
var Rh = {
    ...
    animation: function () {
      return function (t, a) {
        ...
        if (
          (u && ((t.style = v.getPropsList(t.style || t.css)), (t.css = void 0)),
          u && t.renderedPosition != null)
        ) {
        ...
        if (l && Le(t.zoom)) {
          ...
          E != null
            ? (E.zoomed && (t.zoom = E.zoom), E.panned && (t.pan = E.pan))
            : (t.zoom = null);
        }
        return new Is(s[0], t);
      };
...
function dg() {
  ...
  function e(t, a, n) {
    a == "__proto__" && r
      ? r(t, a, { configurable: !0, enumerable: !0, value: n, writable: !0 })
      : (t[a] = n);
  }
  return ((ls = e), ls);
}
...
function gg() {
  ...
  function t(a, n) {
    ...
    return (
      (n = n ?? r),
      !!n && (i == "number" || (i != "symbol" && e.test(a))) && a > -1 && a % 1 == 0 && a < n
    );
  }
  return ((fs = t), fs);
}
...
var qe = function () {
  ...
  Ns = [
    ...
    },
    {
      ...
      query: !0,
      regex:
        "\\[\\s*(" + Me.variable + ")\\s*(" + Me.comparatorOp + ")\\s*(" + Me.value + ")\\s*\\]",
      populate: function (e, t, a) {
        var n = Je(a, 3),
          i = n[0],
          s = n[1],
    ...
    },
    {
      ...
      query: !0,
      regex:
        "\\[\\[\\s*(" + Me.meta + ")\\s*(" + Me.comparatorOp + ")\\s*(" + Me.number + ")\\s*\\]\\]",
      populate: function (e, t, a) {
        var n = Je(a, 3),
          i = n[0],
          s = n[1],
  ...
  Hv = function (e, t, a) {
    for (var n = 0; n < e.length; n++) {
      ...
      if (!i.locked()) {
        ...
        (i.isParent() && !(o.x === 0 && o.y === 0) && i.children().shift(o, a),
    ...
    if (a && a.isNode())
      if (s)
        for (var l = 0; l < this.length; l++) {
          ...
          t !== void 0
            ? u.position(e, t + h[e])
            : i !== void 0 && u.position({ x: i.x + h.x, y: i.y + h.y });
        }
      else {
        var d = a.position(),
          y = o ? a.parent() : null,
  ...
  function t(s) {
    ...
    function h(k, D, B) {
      var P = 0,
        ...
        R = D + B;
      return (
        k > 0 && R > 0 && ((P = (D / R) * k), (A = (B / R) * k)),
        { biasDiff: P, biasComplementDiff: A }
      );
    }
    function d(k, D, B, P) {
      if (B.units === "%")
...
var Ar = function (e) {
    ...
    if (b) {
      ...
      (te.all != null ? kd(te.all) : (te.all = wr()),
        n &&
          ...
          u &&
            (t.includeSourceLabels && ys(s, e, "source"),
            t.includeTargetLabels && ys(s, e, "target"))));
    }
    return (
      (s.x1 = Ar(s.x1)),
      (s.y1 = Ar(s.y1)),
  ...
  ul = function (e, t) {
    ...
    if (
      (a.bbCache == null
        ? ((n = $g(e, Pa)), (a.bbCache = n), (a.bbCachePosKey = Uv(e)))
        : (n = a.bbCache),
      !o)
    ) {
      var l = e.isNode();
...
qa.padding = function () {
  ...
  return r.isParent()
    ? (r.updateCompoundBounds(),
      e.autoPadding !== void 0 ? e.autoPadding : r.pstyle("padding").pfValue)
          ...
          var o = function () {
              ...
              if (
                ...
                (i.afterEmit(i.context, v, s),
                  h === !1 && (s.stopPropagation(), s.preventDefault()));
              }
            },
            l = 0;
          l < n;
...
var vr = {
  ...
  updateStyle: function (e) {
    ...
    var n = t.hasCompoundNodes(),
      i = this;
    ((e = !!(e || e === void 0)),
      n && (i = this.spawnSelf().merge(this.descendants()).merge(this.parents())));
    var s = i;
    return (
...
var aa = Hn("eleTakesUpSpace", function (r) {
  return (
    r.pstyle("display").value === "element" &&
    r.width() !== 0 &&
    (r.isNode() ? r.height() !== 0 : !0)
  );
});
vr.takesUpSpace = Wn("takesUpSpace", vo({ ok: aa }));
var cp = Hn("eleInteractive", function (r) {
    return (
      r.pstyle("events").value === "yes" && r.pstyle("visibility").value === "visible" && aa(r)
    );
  }),
        ...
        if (o.isNode()) {
          for (var l = !1, u = o.connectedEdges(), v = 0; v < u.length; v++) {
            var f = u[v],
              ...
              h = f.target();
            if (
              (e.noIncomingEdges && h === o && c !== o) ||
              (e.noOutgoingEdges && c === o && h !== o)
            ) {
              l = !0;
              break;
            }
      ...
      for (var a = this, n = [], i = 0; i < a.length; i++) {
        ...
        if (s.isNode())
          for (var o = s.connectedEdges(), l = 0; l < o.length; l++) {
            ...
            e.outgoing && v === s
              ? (n.push(u), n.push(f))
              : e.incoming && f === s && (n.push(u), n.push(v));
          }
      }
    ...
    for (var s = 0; s < t.length; s++)
      for (var o = t[s]._private.edges, l = 0; l < o.length; l++) {
        var u = o[l],
          ...
          h = f || c;
        h &&
          (((i.thisIsSrc || i.thisIsTgt) && ((i.thisIsSrc && !f) || (i.thisIsTgt && !c))) ||
            a.push(u));
      }
...
var fr = function (e, t) {
    ...
    for (var d = 0, y = t.length; d < y; d++) {
      ...
      if (g != null) {
        ...
        (!a || !i.has(p)) &&
          (a && i.set(p, { index: this.length, ele: g }), (this[this.length] = g), this.length++);
      }
    }
    ((this._private = {
      eles: this,
  ...
  for (var B = 0; B < i.length; B++) {
    ...
    if (L || P._private.parent) {
      ...
      if (I.empty()) A.parent = void 0;
        ...
        M ||
          (I[0]._private.children.push(P), (P._private.parent = I[0]), (n.hasCompoundNodes = !0));
      }
    }
  }
  if (o.length > 0) {
...
He.remove = function () {
  ...
  function l(R) {
    ...
    (e && R.removed()) ||
      L ||
      ((n[R.id()] = !0), R.isNode() ? (a.push(R), s(R), o(R)) : a.unshift(R));
  }
...
function bp(r, e, t, a) {
  ...
  if (
    ...
    if (m && n && !r.locked()) {
      var b = {};
      (da(p.x, m.x) && (b.x = zt(p.x, m.x, g, y)),
        da(p.y, m.y) && (b.y = zt(p.y, m.y, g, y)),
        r.position(b));
    }
    var w = s.startPan,
      E = s.pan,
...
function Cl(r, e) {
  ...
  function n(v, f) {
    ...
    for (
      ...
      (!w.playing && !w.applying) ||
        ...
        b.completed() &&
          (h.splice(m, 1), (w.hooked = !1), (w.playing = !1), (w.started = !1), p(w.completes)),
        (y = !0));
    }
  ...
  var u = n(e, !0);
  ((i || u) && (t.length > 0 ? e.notify("draw", t) : e.notify("draw")),
    t.unmerge(a),
    e.emit("step"));
}
var xp = {
...
var dn = {
  layout: function (e) {
    ...
    if (n == null) {
      $e(
        "No such layout `" + a + "` found.  Did you forget to import it and `cytoscape.use()` it?"
      );
      return;
    }
    var i;
...
ur.apply = function (r) {
  for (var e = this, t = e._private, a = t.cy, n = a.collection(), i = 0; i < r.length; i++) {
    ...
    if (!o.empty) {
      ...
      s._private.appliedInitStyle
        ? e.updateTransitions(s, u.diffProps)
        : (s._private.appliedInitStyle = !0);
  ...
  for (var a = this, n = r.diffPropNames, i = {}, s = a.types, o = 0; o < n.length; o++) {
    ...
    if (v !== u) {
      ...
      (a.applyParsedProperty(t, u),
        (h.next = t.pstyle(l)),
        h.next && h.next.bypass && (h.next = h.next.bypassed));
    }
  }
  return { diffProps: i };
};
...
ur.applyParsedProperty = function (r, e) {
  ...
  return (
    l
      ? (v ? (a.bypassed = u.bypassed) : (a.bypassed = u), (n[a.name] = a))
      : v
        ? (u.bypassed = a)
        : (n[a.name] = a),
    d(),
...
ur.updateTransitions = function (r, e) {
  ...
  if (n.length > 0 && i > 0) {
    ...
    a.transitioning &&
      (this.removeBypasses(r, n), r.emitAndNotify("style"), (a.transitioning = !1));
};
...
_r.getAnimationStartStyle = function (r, e) {
  for (var t = {}, a = 0; a < e.length; a++) {
    var n = e[a],
      i = n.name,
      s = r.pstyle(i);
    (s !== void 0 && (Le(s) ? (s = this.parse(i, s.strValue)) : (s = this.parse(i, s))),
      s && (t[i] = s));
  }
  return t;
};
...
Un.parseImpl = function (r, e, t, a) {
  ...
  if (u.multiple && a !== "multiple") {
    var b;
    if (
      (l ? (b = e.split(/\s+/)) : _e(e) ? (b = e) : (b = [e]), u.evenMultiple && b.length % 2 !== 0)
    )
      return null;
  ...
  if (u.number) {
    ...
    return u.string
      ? { name: r, value: "" + e, strValue: "" + e, bypass: t }
      : u.enums
        ? B()
        : null;
};
      ...
      if (
        ...
        ae(e)
          ...
          : Le(e) &&
            ...
            e.position != null
              ? (i = On(e.position, n, a))
              : e.renderedPosition != null && (i = e.renderedPosition),
    ...
    viewport: function (e) {
      ...
      if (a) {
        ...
        l < t.minZoom || l > t.maxZoom || !t.zoomingEnabled
          ? (s = !0)
          : ((t.zoom = l), i.push("zoom"));
      }
      if (n && (!s || !e.cancelOnFailedZoom) && t.panningEnabled) {
        var u = e.pan;
        (ae(u.x) && ((t.pan.x = u.x), (o = !1)),
          ae(u.y) && ((t.pan.y = u.y), (o = !1)),
          o || i.push("pan"));
      }
      return (
  ...
  mount: function (e) {
    if (e != null) {
      ...
      return (
        ...
        t.invalidateSize(),
        t.initRenderer(
          be({}, n, n.renderer, { name: n.renderer.name === "null" ? "canvas" : n.renderer.name })
        ),
        ...
        var s = {},
          o = function (w, E) {
            for (var C = [], x = [], T = 0; T < w.length; T++) {
              ...
              ((s[D] = !0),
                B.length !== 0 ? x.push({ ele: B, json: k }) : (E && (k.group = E), C.push(k)));
            }
            t.add(C);
...
af.prototype.run = function () {
  ...
  var F = {},
    U = function (ie) {
      ...
      for (
        var de = Ft(ie).depth, he = ie.neighborhood(), Ee = 0, pe = 0, Se = 0;
        Se < he.length;
        Se++
      ) {
        var Re = he[Se];
  ...
  var H = { x: l.x1 + l.w / 2, y: l.y1 + l.h / 2 },
    ...
    Ae = function (ie) {
      ...
      if (r.circle) {
        ...
        return (
          he === 0 && p[0].length === 1 && (Se = 1),
          { x: H.x + Se * Math.cos(Re), y: H.y + Se * Math.sin(Re) }
        );
      } else {
        var Oe = p[he].length,
          Ne = Math.max(
...
var Lp = function (e, t, a) {
  ...
  Np = function (e, t) {
    for (var a = e.clientWidth, n = e.clientHeight, i = 0; i < e.nodeSize; i++) {
      ...
      s.children.length === 0 &&
        !s.isLocked &&
        ((s.positionX = Math.random() * a), (s.positionY = Math.random() * n));
    }
  },
  uf = function (e, t, a) {
    var n = e.boundingBox,
    ...
    if (!(i !== s && !a.isCompound)) {
      ...
      if (v > 0)
        ...
        var y = Dn(e, o, l),
          ...
          h = (f * p) / c,
          d = (f * m) / c;
      (e.isLocked || ((e.offsetX -= h), (e.offsetY -= d)),
        t.isLocked || ((t.offsetX += h), (t.offsetY += d)));
    }
  },
  _p = function (e, t, a, n) {
      ...
      : 0 < t && -1 * u <= l && l <= u
        ...
        : 0 > t && -1 * u <= l && l <= u
          ...
          : 0 < a && (l <= -1 * u || l >= u)
            ...
            : (0 > a && (l <= -1 * u || l >= u) && ((v.x = n - (s * t) / 2 / a), (v.y = i - s / 2)),
              v);
  },
  Gp = function (e, t) {
    for (var a = 0; a < e.edgeSize; a++) {
      ...
      if (!(u === 0 && v === 0)) {
        ...
        if (y !== 0)
          ...
          var p = 0,
            m = 0;
        (s.isLocked || ((s.offsetX += p), (s.offsetY += m)),
          l.isLocked || ((l.offsetX -= p), (l.offsetY -= m)));
      }
    }
  },
  Hp = function (e, t) {
  ...
  $p = function (e, t) {
    for (var a = 0; a < e.nodeSize; a++) {
      ...
      0 < n.children.length &&
        ((n.maxX = void 0), (n.minX = void 0), (n.maxY = void 0), (n.minY = void 0));
    }
    for (var a = 0; a < e.nodeSize; a++) {
      var n = e.layoutNodes[a];
  ...
  lf = function (e, t) {
    ...
    if (a != null) {
      var n = t.layoutNodes[t.idToIndex[a]],
        i = !1;
      if (
        ((n.maxX == null || e.maxX + n.padRight > n.maxX) &&
          ((n.maxX = e.maxX + n.padRight), (i = !0)),
        (n.minX == null || e.minX - n.padLeft < n.minX) &&
          ((n.minX = e.minX - n.padLeft), (i = !0)),
        (n.maxY == null || e.maxY + n.padBottom > n.maxY) &&
          ((n.maxY = e.maxY + n.padBottom), (i = !0)),
...
go.registerArrowShapes = function () {
  ...
  (o("none", { collide: xn, roughCollide: xn, draw: js, spacing: Go, gap: Go }),
    ...
    o("circle-triangle", {
      ...
      spacing: function (u) {
        return (
          e.getArrowWidth(u.pstyle("width").pfValue, u.pstyle("arrow-scale").value) * this.radius
        );
      },
    }),
    o("triangle-cross", {
  ...
  function m(x) {
    ...
    if (k.edgeType === "segments" || k.edgeType === "straight" || k.edgeType === "haystack") {
      for (var I = k.allpts, M = 0; M + 3 < I.length; M += 2)
        if (
          Rd(r, e, I[M], I[M + 1], I[M + 2], I[M + 3], R) &&
          A > (L = Nd(r, e, I[M], I[M + 1], I[M + 2], I[M + 3]))
        )
          return (g(x, L), !0);
    } else if (
      k.edgeType === "bezier" ||
    ...
    if (b.isNode()) {
      ...
      if (O === "contain") {
        ...
        if (
          ...
          for (
            var V = I.rstyle.bezierPts || I.rstyle.linePts || I.rstyle.haystackPts, G = !0, N = 0;
            N < V.length;
            N++
          )
            if (!Ko(c, V[N])) {
...
Bn.calculateArrowAngles = function (r) {
  ...
  if (
    ((e.midtgtArrowAngle = Ya(l, u)), (e.midDispX = l), (e.midDispY = u), (l *= -1), (u *= -1), i)
  ) {
    var d = e.allpts;
    if ((d.length / 2) % 2 !== 0) {
      if (!e.isRound) {
...
yr.findBezierPoints = function (r, e, t, a, n) {
  ...
  for (var h = 0; h < u; h++) {
    var d = (0.5 - e.eles.length / 2 + t) * s * (n ? -1 : 1),
      y = void 0,
      g = to(d);
    (c && ((v = o ? o.pfValue[h] : s), (f = l.value[h])),
      a ? (y = v) : (y = v !== void 0 ? g * v : void 0));
    var p = y !== void 0 ? y : d,
      m = 1 - f,
      b = f,
...
yr.tryToCorrectInvalidPoints = function (r, e) {
  ...
  if (t.edgeType === "bezier") {
    var a = e.srcPos,
      ...
      b = 3,
      w =
        this.getArrowWidth(r.pstyle("width").pfValue, r.pstyle("arrow-scale").value) *
    ...
    for (var t = 0; t + 1 < e.ctrlpts.length; t += 2)
      (e.allpts.push(e.ctrlpts[t], e.ctrlpts[t + 1]),
        t + 3 < e.ctrlpts.length &&
          e.allpts.push(
            (e.ctrlpts[t] + e.ctrlpts[t + 2]) / 2,
            (e.ctrlpts[t + 1] + e.ctrlpts[t + 3]) / 2
          ));
      ...
      var C = function () {
          ...
          var G = (A.srcPos = M.position()),
            ...
            ne = (A.srcCornerRadius =
              M.pstyle("corner-radius").value === "auto"
                ? "auto"
                : M.pstyle("corner-radius").pfValue),
            J = (A.tgtCornerRadius =
              O.pstyle("corner-radius").value === "auto"
                ? "auto"
                : O.pstyle("corner-radius").pfValue),
                ...
                : M === O
                  ...
                  : ce.endsWith("segments")
                    ...
                    : ce.endsWith("taxi")
                      ...
                      : ce === "straight" ||
                          (!Ae && A.eles.length % 2 === 1 && H === Math.floor(A.eles.length / 2))
...
Ga.findEndpoints = function (r) {
  ...
  var O,
    ...
    F =
      (e =
        (L == null || (t = L.pfValue) === null || t === void 0 ? void 0 : t.length) === 2
          ? L.pfValue
          : null) !== null && e !== void 0
        ? e
        : [0, 0],
    U =
      (a =
        (P == null || (n = P.pfValue) === null || n === void 0 ? void 0 : n.length) === 2
          ? P.pfValue
          : null) !== null && a !== void 0
        ? a
        : [0, 0];
  ...
  if (
    ...
    var _ = Da(
      N[0],
      N[1],
      [Ne - xe, ze - ue, Ne + xe, ze - ue, Ne + xe, ze + ue, Ne - xe, ze + ue],
      u.x,
      u.y
    );
    if (_.length > 0) {
  ...
  ((m.startX = le[0]),
    ...
    (m.arrowStartY = ve[1]),
    D &&
      (!ae(m.startX) || !ae(m.startY) || !ae(m.endX) || !ae(m.endY)
        ? (m.badLine = !0)
        : (m.badLine = !1)));
};
  ...
  if (i.mid || i.source || i.target) {
    ...
    var l = function () {
        ...
        for (var b = 0; b < f.length; b++) {
          var w = f[b],
            E = f[b - 1];
          (E && (w.startDist = E.startDist + E.length),
          ...
          switch (a.edgeType) {
            ...
            case "haystack": {
              for (
                ...
                V + 3 < O &&
                (h
                  ? ((I = { x: a.allpts[V], y: a.allpts[V + 1] }),
                    (M = { x: a.allpts[V + 2], y: a.allpts[V + 3] }))
...
Gr.getLabelText = function (r, e) {
  ...
  if (!n) return "";
  i == "none" ||
    (i == "uppercase" ? (n = n.toUpperCase()) : i == "lowercase" && (n = n.toLowerCase()));
...
ia.load = function () {
  ...
  (w &&
    ...
    r.styleObserver.observe(r.container, { attributes: !0 })),
                ...
                (r.hoverData.dragging ||
                  (W.selectionType() === "additive" || le
                    ? oe.selected()
                      ...
                      : oe.select(["tapselect"])
                    : le ||
                      (W.$(t).unmerge(oe).unselect(["tapunselect"]), oe.select(["tapselect"]))),
                r.redrawHint("eles", !0)),
              r.hoverData.selecting)
            ) {
              var fe = W.collection(r.getAllInBox(Z[0], Z[1], Z[2], Z[3]));
              (r.redrawHint("select", !0),
                fe.length > 0 && r.redrawHint("eles", !0),
                W.emit(me("boxend")));
              var Pe = function (Ke) {
    ...
    N = function (S) {
      ...
      if (
        (W == null &&
          (S.wheelDeltaY != null
            ? (W = S.wheelDeltaY / 4)
            : S.wheelDelta != null && (W = S.wheelDelta / 4)),
        W !== 0)
      ) {
        if (M == null)
          if (L.length >= I) {
        ...
        if (!r.scrollingPage) {
          ...
          if (
            ee.panningEnabled() &&
            ee.userPanningEnabled() &&
            ee.zoomingEnabled() &&
            ee.userZoomingEnabled()
          ) {
            (S.preventDefault(),
    ...
    (Ce = function (S) {
      if (((r.hasTouchStarted = !0), !!D(S))) {
        ...
        if (S.touches[2]) _.boxSelectionEnabled() && S.preventDefault();
          ...
          if (S.touches[0]) {
            ...
            if (
              Be != null &&
              (Be.activate(),
              (r.touchData.start = Be),
              (r.touchData.starts = Pe),
              r.nodeIsGrabbable(Be))
            ) {
        ...
        if (S.touches.length >= 1) {
          for (
            var mr = (r.touchData.startPosition = [null, null, null, null, null, null]), Ye = 0;
            Ye < W.length;
            Ye++
          )
            mr[Ye] = $[Ye] = W[Ye];
      ...
      if (!(!_ && !D(S))) {
        ...
        if (_ && r.touchData.cxt) {
          ...
          if (Ze >= $a || jr >= $r) {
            ...
            var bt = le("cxttapend");
            r.touchData.start
              ? (r.touchData.start.unactivate().emit(bt), (r.touchData.start = null))
              : $.emit(bt);
          }
        }
        if (_ && r.touchData.cxt) {
          ...
          if (
            (!r.hoverData.draggingEles &&
              !r.swipePanning &&
              (Er = r.findNearestElement(Z[0], Z[1], !0, !0)),
          ...
          if (
            ...
            (!Mr || !Mr.grabbed()) &&
              Er != Qn &&
              (Qn && Qn.emit(le("tapdragout")), Er && Er.emit(le("tapdragover"))),
            (r.touchData.last = Er),
            _)
          )
          ...
          if (_ && (Mr == null || Mr.pannable()) && $.panningEnabled() && $.userPanningEnabled()) {
            ...
            Jf &&
              ...
              r.data.bgActivePosistion ||
                (r.data.bgActivePosistion = Wt(r.touchData.startPosition)),
              r.swipePanning
    ...
    (r.registerBinding(
      ...
      (ie = function (S) {
        ...
        ((r.dragData.didDrag = !1),
          ...
          S.touches.length < 2 &&
            (S.touches.length === 1 &&
              (r.touchData.startGPosition = [S.touches[0].clientX, S.touches[0].clientY]),
            (r.pinching = !1),
            r.redrawHint("eles", !0),
            r.redraw()));
      }),
  ...
  return (this.nodeShapes[r] = {
    ...
    intersectLine: function (a, n, i, s, o, l, u, v, f) {
      return qd(
        ...
        s,
        u,
        this.getOrCreateCorners(a, n, i, s, v, f, "corners")
      );
    },
    checkPoint: function (a, n, i, s, o, l, u, v, f) {
      return zd(
        ...
        s,
        o,
        this.getOrCreateCorners(l, u, s, o, v, f, "corners")
      );
    },
  });
};
  ...
  return (this.nodeShapes["bottom-round-rectangle"] = this.nodeShapes.bottomroundrectangle =
    {
      ...
      checkPoint: function (e, t, a, n, i, s, o, l) {
        ...
        var u = 2 * l;
        if (
          Zr(e, t, this.points, s, o, n, i - u, [0, -1], a) ||
          Zr(e, t, this.points, s, o, n - u, i, [0, -1], a)
        )
          return !0;
        var v = n / 2 + 2 * a,
          f = i / 2 + 2 * a,
...
nr.recycleTexture = function (r, e) {
  for (
    var t = this, a = t.getTextureQueue(r), n = t.getRetiredTextureQueue(r), i = 0;
    i < n.length;
    i++
  ) {
    var s = n[i];
...
nr.removeFromQueue = function (r) {
  ...
  i != null &&
    (i.eles.length === 1
      ? ((i.reqs = Js), t.updateItem(i), t.pop(), (a[n] = null))
      : i.eles.unmerge(r));
};
...
dr.getLayers = function (r, e, t) {
  ...
  for (var p = null, m = r.length / by, b = !o, w = 0; w < r.length; w++) {
    ...
    if (
      (!p || p.eles.length >= m || !bv(p.bb, E.boundingBox())) &&
      ((p = g({ insert: !0, after: p })), !p)
    )
      return null;
...
dr.refineElementTextures = function (r) {
  ...
  e.updateElementsInLayers(r, function (a, n, i) {
    var s = a.replacement;
    if (
      (s || ((s = a.replacement = e.makeLayer(a.bb, a.level)), (s.replaces = a), (s.eles = a.eles)),
      !s.reqs)
    )
...
dr.dequeue = function (r) {
  for (var e = this, t = e.layersQueue, a = [], n = 0; n < Dy && t.size() !== 0; ) {
    ...
    (s && (e.drawEleInLayer(i, s, i.level, r), n++),
      a.length === 0 && a.push(!0),
      i.elesQueue.length === 0 &&
        (t.pop(), (i.reqs = 0), i.replaces && e.applyLayerReplacement(i), e.requestRedraw()));
  }
  return a;
};
...
Jr.drawEdgePath = function (r, e, t, a) {
  ...
  if (l) {
    ...
    c
      ? ((s = e = n.pathCache), (o = !0))
      : ((s = e = new Path2D()), (n.pathCacheKey = f), (n.pathCache = s));
  }
  if (i.setLineDash)
    switch (a) {
      case "dotted":
  ...
  if (
    ...
    if (
      ...
      (w &&
        ...
        m.pathCache
          ? r.clip(m.pathCache)
          : (i.nodeShapes[i.getNodeShape(t)].draw(r, o, l, g, p, x, m), r.clip())),
...
Lt.getFontCache = function (r) {
  ...
  for (var t = 0; t < this.fontCaches.length; t++)
    if (((e = this.fontCaches[t]), e.context === r)) return e;
  ...
  if (!(!ae(f.x) || !ae(f.y)) && !(i && !e.visible())) {
    ...
    var ne = function () {
      ...
      q = function (ue, X, S, _) {
        ...
        return (
          Z != null
            ? ((oe = Z), (ee = !0), (v.pathCache = oe))
            : ((oe = new Path2D()), (W[$] = v.pathCache = oe)),
          { path: oe, cacheHit: ee }
        );
      },
    ...
    var ce = function () {
      ...
      we = function () {
        ...
        s.hasStripe(e) &&
          ...
          h
            ? r.clip(v.pathCache)
            : (s.nodeShapes[s.getNodeShape(e)].draw(r, f.x, f.y, o, l, re, v), r.clip()),
          s.drawStripe(r, e, X),
          r.restore(),
          ue && (h || s.nodeShapes[s.getNodeShape(e)].draw(r, f.x, f.y, o, l, re, v)));
      },
      ...
      de = function () {
        if (F > 0) {
          ...
          if (X === "ellipse") s.drawEllipsePath(ee || r, ue.x, ue.y, $, Z);
            ...
            X.startsWith("polygon") ||
            ["rhomboid", "right-rhomboid", "round-tag", "tag", "vee"].includes(X)
          ) {
            var jr = (S + F + j) / o;
...
xr.matchCanvasSize = function (r) {
  ...
  (r === e.data.bufferCanvases[e.MOTIONBLUR_BUFFER_NODE] ||
    r === e.data.bufferCanvases[e.MOTIONBLUR_BUFFER_DRAG]) &&
    (s = o);
  var l = n * s,
    u = i * s,
    v;
...
xr.render = function (r) {
  ...
  var t = e.cy,
    ...
    f =
      e.textureOnViewport &&
      !a &&
      (e.pinching || e.hoverData.dragging || e.swipePanning || e.data.wheelZooming),
  ...
  function P(J, z) {
    ...
    (J === u.bufferContexts[e.MOTIONBLUR_BUFFER_NODE] ||
      J === u.bufferContexts[e.MOTIONBLUR_BUFFER_DRAG])
      ? ((q = { x: E.x * h, y: E.y * h }),
        (H = b * h),
        (Y = e.canvasWidth * h),
        (te = e.canvasHeight * h))
      ...
      z === "motionBlur"
        ? B(J, 0, 0, Y, te)
        : !a && (z === void 0 || z) && J.clearRect(0, 0, Y, te),
  ...
  if ((f || (e.textureDrawLastFrame = !1), f)) {
    ...
    (R.setTransform(1, 0, 0, 1, 0, 0),
      c ? B(R, 0, 0, x.width, x.height) : R.clearRect(0, 0, x.width, x.height));
  ...
  ((e.prevViewport = x),
    e.clearingMotionBlur &&
      ((e.clearingMotionBlur = !1), (e.motionBlurCleared = !0), (e.motionBlur = !0)),
    c &&
...
function Uy(r) {
  return r.pstyle("background-fill").value !== "solid" ||
    r.pstyle("background-image").strValue !== "none"
    ? !1
...
function Qy(r, e, t, a) {
  ...
  return (
    ...
    o === r.FLOAT
      ? r.vertexAttribPointer(t, s, o, !1, 0, 0)
      : o === r.INT && r.vertexAttribIPointer(t, s, o, 0, 0),
...
function Fr(r, e, t, a) {
  ...
  (r.bindBuffer(r.ARRAY_BUFFER, f),
    ...
    o === r.FLOAT
      ? r.vertexAttribPointer(a, s, o, !1, v, 0)
      : o === r.INT && r.vertexAttribIPointer(a, s, o, v, 0),
...
function Jy(r, e, t) {
  ...
  for (var u = 0; u < 3; u++) {
    ...
    (r.enableVertexAttribArray(v),
      r.vertexAttribPointer(v, 3, r.FLOAT, !1, 36, u * 12),
            ...
            g = function () {
              ...
              }
              {
                var B = E,
                  ...
                  A = C;
                (w && w.context.drawImage(b, B, 0, A, x, 0, P, A, x),
                  (d[1] = { x: 0, y: P, w: A, h: c }));
              }
        ...
        value: function (t, a, n) {
          ...
          return (
            i ||
              ...
              (!i || !i.canFit(a)) &&
                (i && i.lock(), (i = this._createAtlas()), this.atlases.push(i)),
              i.draw(t, a, n),
                ...
                for (d.s(); !(y = d.n()).done; ) {
                  ...
                  if (!h.has(g)) {
                    var p = f.getOffsets(g),
                      ...
                      b = m[0],
                      w = m[1];
                    (s.canFit({ w: b.w + w.w, h: b.h }) ||
                      (s.lock(), (s = t._createAtlas()), n.push(s)),
  ...
  sm = (function () {
    ...
    return gt(r, [
      ...
      },
      {
        ...
        value: function (t) {
          return this.batchAtlases.length === this.maxAtlasesPerBatch
            ? this.batchAtlases.includes(t)
            : !0;
        },
      },
      {
        ...
        if(vVertType == `
          ...
          `
              ...
              .concat(
                i.map(function (u) {
                  return "if(vAtlasId == "
                    .concat(u, ") outColor = texture(uTexture")
                    .concat(u, ", vTexCoord);");
                }).join(`
	else `),
                `
      ...
      },
      {
        ...
        value: function (t, a, n, i) {
          var s = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : !0,
            o = 0;
          if (
            (n.shapeProps && n.shapeProps.padding && (o = t.pstyle(n.shapeProps.padding).pfValue),
            i)
          ) {
            var l = i.bb,
              u = i.tex1,
...
function Of(r, e, t) {
  ...
  var n = r.drawing,
    i = 0;
  if (
    (t.screen && r.data.canvasNeedsRedraw[r.SELECT_BOX] && ym(r, e),
    r.data.canvasNeedsRedraw[r.NODE] || t.picking)
  ) {
  ...
  if (r.webglDebug) {
    ...
    if (h) console.log("WebGL (".concat(t.name, ") - time ").concat(d, "ms, ").concat(g));
    else {
      (console.log("WebGL (".concat(t.name, ") - frame time ").concat(d, "ms")),
        console.log("Totals:"),
      ...
      try {
        for (m.s(); !(b = m.n()).done; ) {
          var w = b.value;
          console.log(
            "  ".concat(w.type, ": ").concat(w.keyCount, " keys, ").concat(w.atlasCount, " atlases")
          );
        }
      } catch (E) {
        m.e(E);
...
function Em(r, e) {
  for (
    var t = atob(r), a = new ArrayBuffer(t.length), n = new Uint8Array(a), i = 0;
    i < t.length;
    i++
  )
    n[i] = t.charCodeAt(i);
...
function Vf(r) {
  var e = this,
    t = e.cy.window(),
    a = t.document;
  (r.webgl && ((ke.CANVAS_LAYERS = e.CANVAS_LAYERS = 4), console.log("webgl rendering enabled")),
    (e.data = {
