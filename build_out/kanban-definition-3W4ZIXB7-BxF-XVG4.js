...
import { g as Ne } from "./chunk-FMBD7UC4-tNCXGUKF.js";
...
var $ = (function () {
  var e = o(function (O, i, n, r) {
    ...
    T = {
      ...
      performAction: o(function (i, n, r, a, h, t, U) {
        var c = t.length - 1;
        switch (h) {
          case 6:
          case 7:
      ...
      table: [
        ...
        e(D, [2, 4]),
        e(D, [2, 5]),
        { 1: [2, 6], 6: p, 12: 21, 13: s, 14: 14, 16: d, 17: k, 18: 17, 19: 18, 20: m, 23: l },
        { 6: p, 9: 22, 12: 11, 13: s, 14: 14, 16: d, 17: k, 18: 17, 19: 18, 20: m, 23: l },
        { 6: I, 7: g, 10: 23, 11: w },
        e(_, [2, 24], { 18: 17, 19: 18, 14: 27, 16: [1, 28], 17: [1, 29], 20: m, 23: l }),
        e(_, [2, 19]),
        e(_, [2, 21], { 15: 30, 24: G }),
        e(_, [2, 22]),
        e(_, [2, 23]),
        ...
        { 21: [1, 33] },
        { 6: I, 7: g, 10: 34, 11: w },
        { 1: [2, 7], 6: p, 12: 21, 13: s, 14: 14, 16: d, 17: k, 18: 17, 19: 18, 20: m, 23: l },
        e(V, [2, 14], { 7: b, 11: A }),
        e(L, [2, 8]),
        e(L, [2, 9]),
        e(L, [2, 10]),
      ...
      parse: o(function (i) {
        ...
        function ae() {
          ...
          return (
            (S = a.pop() || y.lex() || re),
            typeof S != "number" &&
              (S instanceof Array && ((a = S), (S = a.pop())), (S = n.symbols_[S] || S)),
            S
          );
        }
        o(ae, "lex");
        for (var E, P, x, Q, j = {}, z, C, oe, X; ; ) {
          if (
            ...
            this.defaultActions[P]
              ...
              : ((E === null || typeof E > "u") && (E = ae()), (x = U[P] && U[P][E])),
            typeof x > "u" || !x.length || !x[0])
          ) {
            var Z = "";
            X = [];
            for (z in U[P]) this.terminals_[z] && z > ue && X.push("'" + this.terminals_[z] + "'");
            (y.showPosition
              ? (Z =
                  "Parse error on line " +
                  (W + 1) +
...
Expecting ` +
          ...
          if (x[0] instanceof Array && x.length > 1)
            throw new Error(
              "Parse Error: multiple actions possible at state: " + P + ", token: " + E
            );
          switch (x[0]) {
            case 1:
              (r.push(E),
            ...
            case 2:
              if (
                ...
                de && (j._$.range = [t[t.length - (C || 1)].range[0], t[t.length - 1].range[1]]),
                (Q = this.performAction.apply(j, [c, se, W, R.yy, x[1], h, t].concat(ge))),
                typeof Q < "u")
              )
                return Q;
              (C &&
                ((r = r.slice(0, -1 * C * 2)), (h = h.slice(0, -1 * C)), (t = t.slice(0, -1 * C))),
      ...
      var O = {
        ...
        unput: o(function (i) {
          ...
          return (
            ...
            this.options.ranges && (this.yylloc.range = [h[0], h[0] + this.yyleng - n]),
...
` +
        ...
        next: o(function () {
          ...
          for (var h = this._currentRules(), t = 0; t < h.length; t++)
            if (
              ((r = this._input.match(this.rules[h[t]])), r && (!n || r[0].length > n[0].length))
            ) {
              if (((n = r), (a = t), this.options.backtrack_lexer)) {
                if (((i = this.test_match(r, h[t])), i !== !1)) return i;
                if (this._backtrack) {
                  n = !1;
                  continue;
                } else return !1;
          ...
          return n
            ? ((i = this.test_match(n, h[a])), i !== !1 ? i : !1)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
` +
        ...
        performAction: o(function (n, r, a, h) {
          switch (a) {
            case 0:
...
var xe = $,
  ...
  Le = o(function () {
    ...
    return { nodes: u, edges: e, other: {}, config: H() };
  }, "getData"),
  Oe = o((e, u, p, s, d) => {
    const k = H();
...
` + e
    ...
    const I = l.append("g");
    I.attr("class", "items");
    const g = k.nodes.filter((b) => b.isGroup);
    let w = 0;
    const _ = 10,
      G = [];
    let N = 25;
    for (const b of g) {
      ...
      ((w = w + 1),
        ...
        (b.rx = 5),
        (b.ry = 5),
        (b.cssClasses = b.cssClasses + " section-" + w));
      const L = await ye(D, b);
    ...
    for (const b of g) {
      const A = G[V];
      V = V + 1;
      const L = m?.kanban?.sectionWidth || 200,
        M = (-L * 3) / 2 + N;
      let T = M;
      const Y = k.nodes.filter((i) => i.parentId === b.id);
      for (const i of Y) {
        if (i.isGroup) throw new Error("Groups within groups are not allowed in Kanban diagrams");
        ((i.x = b.x), (i.width = L - 1.5 * _));
        const r = (await me(I, i, { config: m })).node().getBBox();
        ((i.y = T + r.height / 2), await be(i), (T = i.y + r.height / 2 + _ / 2));
      }
      const B = A.cluster.select("rect"),
        O = Math.max(T - M + 3 * _, 50) + (N - 25);
      B.attr("height", O);
    }
    _e(
      void 0,
  ...
  Fe = o((e) => {
    ...
    for (let s = 0; s < e.THEME_COLOR_LIMIT; s++)
      ((e["lineColor" + s] = e["lineColor" + s] || e["cScaleInv" + s]),
        Se(e["lineColor" + s])
          ? (e["lineColor" + s] = ce(e["lineColor" + s], 20))
          : (e["lineColor" + s] = le(e["lineColor" + s], 20)));
    const p = o((s, d) => (e.darkMode ? le(s, d) : ce(s, d)), "adjuster");
    for (let s = 0; s < e.THEME_COLOR_LIMIT; s++) {
      const d = "" + (17 - 3 * s);
      u += `
...
`,
  ...
  Me = Ge,
  Ye = { db: Ve, renderer: je, parser: xe, styles: Me };
