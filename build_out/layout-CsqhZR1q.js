import { G as g } from "./graph-ChesIUmq.js";
import {
  b as Te,
  p as ce,
  q as le,
...
var E = cn(),
  R = ze(function (e, n) {
    ...
    var r = n.length;
    return (
      r > 1 && q(e, n[0], n[1]) ? (n = []) : r > 2 && q(n[0], n[1], n[2]) && (n = [n[0]]),
      on(e, Se(n), [])
    );
  }),
  ln = 0;
...
function J(e) {
  ...
  function r(t) {
    ...
    return (
      (i === Number.POSITIVE_INFINITY || i === void 0 || i === null) && (i = 0),
      (a.rank = i)
    );
  }
  f(e.sources(), r);
...
function ur(e) {
  ...
  function r(i) {
    return function (o) {
      o.merged ||
        ((m(o.barycenter) || m(i.barycenter) || o.barycenter >= i.barycenter) && dr(i, o));
    };
  }
  function t(i) {
    return function (o) {
...
function fr(e) {
  return function (n, r) {
    return n.barycenter < r.barycenter
      ? -1
      : n.barycenter > r.barycenter
        ? 1
        : e
          ? r.i - n.i
          : n.i - r.i;
  ...
  (f(e.nodes(), function (r) {
    ...
    f(e.edges(), function (r) {
      var t = e.edge(r),
        a = n.edge(r);
      ((t.points = a.points),
        Object.prototype.hasOwnProperty.call(a, "x") && ((t.x = a.x), (t.y = a.y)));
    }),
...
function Hr(e) {
  f(e.edges(), function (n) {
    var r = e.edge(n),
      ...
      o;
    (r.points
      ? ((i = r.points[0]), (o = r.points[r.points.length - 1]))
      : ((r.points = []), (i = a), (o = t)),
...
function Jr(e) {
  f(e.edges(), function (n) {
    ...
    if (Object.prototype.hasOwnProperty.call(r, "x"))
      switch (
        ((r.labelpos === "l" || r.labelpos === "r") && (r.width -= r.labeloffset), r.labelpos)
      ) {
        case "l":
