...
function K(n, t) {
  return function (e, i) {
    for (
      var o = e.length, f = [], c = 0, u = n[0], p = 0;
      o > 0 &&
      u > 0 &&
      (p + u + 1 > i && (u = Math.max(1, i - p)),
      f.push(e.substring((o -= u), o + u)),
      !((p += u + 1) > i));
    )
      u = n[(c = (c + 1) % n.length)];
...
function _(n, t) {
  ...
  var i = e[0],
    o = e[1],
    f = o - (U = Math.max(-8, Math.min(8, Math.floor(o / 3))) * 3) + 1,
    c = i.length;
  return f === c
    ? i
    : f > c
      ...
      : f > 0
        ...
        : "0." + new Array(1 - f).join("0") + j(n, Math.max(0, t + f - 1))[0];
}
function G(n, t) {
  var e = j(n, t);
  if (!e) return n + "";
...
function v(n) {
  ...
  function F(a) {
    ...
    var x = a.fill,
      ...
      L = a.trim,
      d = a.type;
    (d === "n" ? ((E = !0), (d = "g")) : I[d] || (g === void 0 && (g = 12), (L = !0), (d = "g")),
      (l || (x === "0" && M === "=")) && ((l = !0), (x = "0"), (M = "=")));
    var Z = w === "$" ? e : w === "#" && /[boxX]/.test(d) ? "0" + d.toLowerCase() : "",
      q = w === "$" ? i : /[%p]/.test(d) ? c : "",
      T = I[d],
      B = /[defgprs%]/.test(d);
    g =
    ...
    function C(r) {
      ...
      E && !l && (r = t(r, 1 / 0));
      var z = y.length + r.length + h.length,
        s = z < S ? new Array(S - z + 1).join(x) : "";
  ...
  function Y(a, x) {
    var M = F(((a = N(a)), (a.type = "f"), a)),
      m = Math.max(-8, Math.min(8, Math.floor(J(x) / 3))) * 3,
      w = Math.pow(10, -m),
      l = R[8 + m / 3];
    return function (S) {
      return M(w * S) + l;
...
export { tn as a, nn as b, J as e, N as f };
