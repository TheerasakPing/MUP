...
class Config {
    ...
    secretsFile;
    constructor(rootDir) {
        this.rootDir = rootDir ?? (0, paths_1.getMuxHome)();
...
// }
${jsonString}`;
            write_file_atomic_1.default.sync(this.providersFile, contentWithComments, {
                encoding: "utf-8",
                mode: 0o600,
            });
        }
    ...
    static GLOBAL_SECRETS_KEY = "__global__";
    ...
    async saveSecretsConfig(config) {
        try {
            ...
            await (0, write_file_atomic_1.default)(this.secretsFile, JSON.stringify(config, null, 2), {
                encoding: "utf-8",
                mode: 0o600,
            });
        }
