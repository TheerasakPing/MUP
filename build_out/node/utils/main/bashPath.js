...
exports.getBashPathForPlatform = getBashPathForPlatform;
exports.getBashPath = getBashPath;
exports.resetBashPathCache = resetBashPathCache;
exports.isBashAvailable = isBashAvailable;
const child_process_1 = require("child_process");
const fs_1 = require("fs");
const path_1 = __importDefault(require("path"));
const WIN_PATH = path_1.default.win32;
const BASH_PATH_ERROR_COOLDOWN_MS = 30_000;
let cachedBashPath = null;
let cachedBashPathError = null;
const defaultExecSync = (command, options) => (0, child_process_1.execSync)(command, options);
...
function getBashPathForPlatform(params) {
    ...
    const bashPath = findWindowsBash({
        ...
        existsSyncFn: params.existsSyncFn ?? fs_1.existsSync,
    });
    if (!bashPath) {
        throw new Error("Git Bash not found. On Windows, mux requires Git for Windows (Git Bash). WSL is not supported. Install Git for Windows from https://git-scm.com/download/win");
    }
    return bashPath;
}
/**
...
//# sourceMappingURL=bashPath.js.map