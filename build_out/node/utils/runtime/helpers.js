...
exports.hasNonEmptyPlanFile = hasNonEmptyPlanFile;
...
async function readPlanFile(runtime, workspaceName, projectName, workspaceId) {
    ...
    const planPath = (0, planStorage_1.getPlanFilePath)(workspaceName, projectName, muxHome);
...
async function movePlanFile(runtime, oldWorkspaceName, newWorkspaceName, projectName) {
    const muxHome = runtime.getMuxHome();
    const oldPath = (0, planStorage_1.getPlanFilePath)(oldWorkspaceName, projectName, muxHome);
    const newPath = (0, planStorage_1.getPlanFilePath)(newWorkspaceName, projectName, muxHome);
    try {
...
async function copyPlanFile(runtime, sourceWorkspaceName, sourceWorkspaceId, targetWorkspaceName, projectName) {
    const muxHome = runtime.getMuxHome();
    const sourcePath = (0, planStorage_1.getPlanFilePath)(sourceWorkspaceName, projectName, muxHome);
    // Legacy paths only used for non-Docker runtimes
    const legacySourcePath = (0, planStorage_1.getLegacyPlanFilePath)(sourceWorkspaceId);
    const targetPath = (0, planStorage_1.getPlanFilePath)(targetWorkspaceName, projectName, muxHome);
