...
exports.sanitizeAnthropicDocumentFilename = sanitizeAnthropicDocumentFilename;
exports.sanitizeAnthropicPdfFilenames = sanitizeAnthropicPdfFilenames;
 ...
 */
function sanitizeAnthropicDocumentFilename(filename, fallback = "Document") {
    if (!filename) {
        return fallback;
    }
 ...
 */
function sanitizeAnthropicPdfFilenames(messages) {
    let didChange = false;
    const result = messages.map((msg) => {
        ...
        const hasPdfWithFilename = msg.parts.some((part) => part.type === "file" &&
...
//# sourceMappingURL=sanitizeAnthropicDocumentFilename.js.map