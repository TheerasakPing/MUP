...
(0, bun_test_1.describe)("PlatformPaths", () => {
    ...
    (0, bun_test_1.describe)("parse", () => {
        (0, bun_test_1.test)("parses absolute path on current platform", () => {
            ...
            (0, bun_test_1.expect)(result.basename).toBe("mux");
        });
    ...
    (0, bun_test_1.describe)("abbreviate", () => {
        (0, bun_test_1.test)("abbreviates path", () => {
            ...
            (0, bun_test_1.expect)(result.endsWith("mux")).toBe(true);
    ...
    (0, bun_test_1.describe)("formatHome", () => {
        (0, bun_test_1.test)("replaces home directory with tilde", () => {
            ...
            (0, bun_test_1.expect)(result).toBe(`~${sep}projects${sep}mux`);
        });
    ...
    (0, bun_test_1.describe)("expandHome", () => {
        ...
        (0, bun_test_1.test)("expands tilde with path", () => {
            const home = os.homedir();
            const sep = path.sep;
            const result = paths_main_1.PlatformPaths.expandHome(`~${sep}projects${sep}mux`);
            (0, bun_test_1.expect)(result).toBe(path.join(home, "projects", "mux"));
        });
        ...
        (0, bun_test_1.test)("expands ~/.mux to MUX_ROOT when set", () => {
            ...
            try {
                ...
                (0, bun_test_1.expect)(paths_main_1.PlatformPaths.expandHome(homePath)).toBe(path.join(home, "projects", "mux"));
            }
            finally {
    ...
    (0, bun_test_1.describe)("getProjectName", () => {
        (0, bun_test_1.test)("extracts project name from path", () => {
            const testPath = path.join("/", "home", "user", "projects", "mux");
            (0, bun_test_1.expect)(paths_main_1.PlatformPaths.getProjectName(testPath)).toBe("mux");
        });
        (0, bun_test_1.test)("handles relative paths", () => {
            (0, bun_test_1.expect)(paths_main_1.PlatformPaths.getProjectName("projects/mux")).toBe("mux");
        });
    ...
    (0, bun_test_1.describe)("on non-Windows platforms", () => {
        (0, bun_test_1.test)("returns POSIX paths unchanged", () => {
            if (process.platform !== "win32") {
                ...
                (0, bun_test_1.expect)((0, paths_1.toPosixPath)("/tmp/mux-bashes")).toBe("/tmp/mux-bashes");
            }
        });
