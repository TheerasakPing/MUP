...
describe("pathUtils", () => {
    describe("expandTilde", () => {
        ...
        it("should return path unchanged if it doesn't start with ~", () => {
            ...
            const result = (0, pathUtils_1.expandTilde)(testPath);
            expect(result).toBe(testPath);
        });
        it("should handle ~ alone (home directory)", () => {
            const result = (0, pathUtils_1.expandTilde)("~");
            expect(result).toBe(os.homedir());
        });
        it("should handle relative paths without tilde", () => {
            const relativePath = "relative/path";
            const result = (0, pathUtils_1.expandTilde)(relativePath);
    ...
    describe("validateProjectPath", () => {
        ...
        it("should return success for existing git directory", async () => {
            ...
            const result = await (0, pathUtils_1.validateProjectPath)(tempDir);
        ...
        it("should expand tilde and validate", async () => {
            ...
            const result = await (0, pathUtils_1.validateProjectPath)(`~/${path.basename(testDir)}`);
            expect(result.valid).toBe(true);
        ...
        it("should return error for non-existent path", async () => {
            ...
            const result = await (0, pathUtils_1.validateProjectPath)(nonExistentPath);
        ...
        it("should return error for file path (not directory)", async () => {
            ...
            const result = await (0, pathUtils_1.validateProjectPath)(filePath);
            expect(result.valid).toBe(false);
        ...
        it("should handle tilde path to non-existent directory", async () => {
            ...
            const result = await (0, pathUtils_1.validateProjectPath)(nonExistentTildePath);
            expect(result.valid).toBe(false);
            expect(result.error).toContain("does not exist");
        });
        it("should return normalized absolute path", async () => {
            ...
            // eslint-disable-next-line local/no-sync-fs-methods -- Test setup only
            fs.mkdirSync(path.join(tempDir, ".git"));
            const result = await (0, pathUtils_1.validateProjectPath)(pathWithDots);
            expect(result.valid).toBe(true);
            expect(result.expandedPath).toBe(tempDir);
        });
        ...
        it("should strip trailing slashes from path", async () => {
            ...
            const resultSingle = await (0, pathUtils_1.validateProjectPath)(`${tempDir}/`);
            ...
            const resultMultiple = await (0, pathUtils_1.validateProjectPath)(`${tempDir}//`);
    ...
    describe("isGitRepository", () => {
        ...
        it("should return false for non-git directory", async () => {
            const result = await (0, pathUtils_1.isGitRepository)(tempDir);
