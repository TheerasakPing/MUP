...
describe("Config", () => {
    ...
    describe("secrets", () => {
        ...
        it("merges global + project secrets with project overriding by key", async () => {
            ...
            const record = (0, secrets_1.secretsToRecord)(effective);
        ...
        it('resolves project secret aliases to global secrets via {secret:"KEY"}', async () => {
            ...
            const record = (0, secrets_1.secretsToRecord)(config.getEffectiveSecrets(projectPath));
            expect(record).toEqual({
                GLOBAL_TOKEN: "abc",
                TOKEN: "abc",
            });
        ...
        it("omits missing referenced secrets when resolving secretsToRecord", () => {
            const record = (0, secrets_1.secretsToRecord)([
                { key: "GLOBAL", value: "1" },
