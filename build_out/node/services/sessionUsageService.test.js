...
(0, bun_test_1.describe)("SessionUsageService", () => {
    ...
    (0, bun_test_1.beforeEach)(async () => {
        ...
        service = new sessionUsageService_1.SessionUsageService(config, historyService);
    });
    ...
    (0, bun_test_1.describe)("getSessionUsage", () => {
        (0, bun_test_1.it)("should rebuild from messages when file missing (ENOENT)", async () => {
            ...
            await historyService.appendToHistory(workspaceId, (0, message_1.createMuxMessage)("msg1", "assistant", "Hello", {
                model: "claude-sonnet-4-20250514",
                usage: { inputTokens: 100, outputTokens: 50, totalTokens: 150 },
            }));
            await historyService.appendToHistory(workspaceId, (0, message_1.createMuxMessage)("msg2", "assistant", "World", {
                model: "claude-sonnet-4-20250514",
    ...
    (0, bun_test_1.describe)("rebuildFromMessages", () => {
        ...
        (0, bun_test_1.it)("should include historicalUsage from legacy compaction summaries", async () => {
            ...
            const compactionSummary = (0, message_1.createMuxMessage)("summary-1", "assistant", "Compacted summary", {
                historySequence: 1,
                compacted: true,
            ...
            const postCompactionMsg = (0, message_1.createMuxMessage)("msg2", "assistant", "New response", {
                historySequence: 2,
                model: "anthropic:claude-sonnet-4-5",
                usage: { inputTokens: 200, outputTokens: 75, totalTokens: 275 },
            });
