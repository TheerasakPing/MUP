...
(0, bun_test_1.describe)("buildMuxMdnsServiceOptions", () => {
    (0, bun_test_1.test)("0.0.0.0 disables IPv6 and avoids advertising loopback addresses", () => {
        ...
        const serviceOptions = (0, mdnsAdvertiserService_1.buildMuxMdnsServiceOptions)({
            bindHost: "0.0.0.0",
            port: 3000,
        ...
        (0, bun_test_1.expect)(serviceOptions.type).toBe(mdnsAdvertiserService_1.MUX_MDNS_SERVICE_TYPE);
    ...
    (0, bun_test_1.test)("sanitizes dots in instanceName so DNS-SD clients can browse/resolve", () => {
        ...
        (0, bun_test_1.expect)(serviceOptions.name).toBe("mux-host-home");
    });
