...
(0, bun_test_1.describe)("TokenizerService", () => {
    ...
    (0, bun_test_1.describe)("calculateStats", () => {
        (0, bun_test_1.test)("delegates to underlying function and persists token stats cache", async () => {
            const messages = [
                (0, message_1.createMuxMessage)("msg1", "user", "Hello", { historySequence: 1 }),
                (0, message_1.createMuxMessage)("msg2", "assistant", "World", { historySequence: 2 }),
            ];
            const mockResult = {
        ...
        (0, bun_test_1.test)("skips persisting stale token stats cache when calculations overlap", async () => {
            ...
            const messagesV2 = [
                ...messagesV1,
                (0, message_1.createMuxMessage)("msg3", "assistant", "!!!", { historySequence: 3 }),
            ];
            const deferred = () => {
                let resolve;
                let reject;
