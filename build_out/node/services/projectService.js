    ...
    async gitInit(projectPath) {
        ...
        try {
            ...
            try {
                ...
                const commitProc = __addDisposableResource(env_1, (0, disposableExec_1.execAsync)(`git -C "${normalizedPath}" -c user.name="mux" -c user.email="mux@localhost" commit --allow-empty -m "Initial commit"`), false);
