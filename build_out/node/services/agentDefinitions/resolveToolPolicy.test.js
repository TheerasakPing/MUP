...
(0, bun_test_1.describe)("resolveToolPolicyForAgent", () => {
    ...
    (0, bun_test_1.test)("subagents hard-deny interactive planning tools and always allow agent_report", () => {
    ...
    (0, bun_test_1.test)("depth limit hard-denies task tools for subagents", () => {
        const agents = [{ tools: { add: ["task", "file_read"] } }];
        const policy = (0, resolveToolPolicy_1.resolveToolPolicyForAgent)({
            agents,
            isSubagent: true,
