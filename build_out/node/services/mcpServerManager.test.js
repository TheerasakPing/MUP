...
(0, bun_test_1.describe)("MCPServerManager", () => {
    ...
    (0, bun_test_1.test)("test() includes oauthChallenge when server responds 401 + WWW-Authenticate Bearer", async () => {
        let baseUrl = "";
        ...
        try {
            ...
            (0, bun_test_1.expect)(result.oauthChallenge).toEqual({
                scope: "mcp.read",
                resourceMetadataUrl,
            });
        }
