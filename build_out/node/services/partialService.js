...
class PartialService {
    ...
    async readPartial(workspaceId) {
        try {
            ...
            return (0, legacy_1.normalizeLegacyMuxMetadata)(message);
        }
        catch (error) {
            ...
            log_1.log.error("Error reading partial:", error);
            return null;
        }
    }
    /**
    ...
    async writePartial(workspaceId, message) {
        return this.fileLocks.withLock(workspaceId, async () => {
            try {
                ...
                await (0, write_file_atomic_1.default)(partialPath, JSON.stringify(partialMessage, null, 2));
