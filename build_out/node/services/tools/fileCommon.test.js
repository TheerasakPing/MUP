...
(0, bun_test_1.describe)("fileCommon", () => {
    ...
    (0, bun_test_1.describe)("validatePathInCwd", () => {
        ...
        (0, bun_test_1.it)("should reject tilde paths outside cwd", () => {
            // Tilde paths expand to home directory, which is outside /workspace/project
            const result = (0, fileCommon_1.validatePathInCwd)("~/other-project/file.ts", cwd, runtime);
            (0, bun_test_1.expect)(result).not.toBeNull();
            (0, bun_test_1.expect)(result?.error).toContain("restricted to the workspace directory");
        });
        (0, bun_test_1.it)("should reject tilde paths to sensitive files", () => {
            const result = (0, fileCommon_1.validatePathInCwd)("~/.ssh/id_rsa", cwd, runtime);
            (0, bun_test_1.expect)(result).not.toBeNull();
            (0, bun_test_1.expect)(result?.error).toContain("restricted to the workspace directory");
        });
        (0, bun_test_1.it)("should reject bare tilde path", () => {
            const result = (0, fileCommon_1.validatePathInCwd)("~", cwd, runtime);
            (0, bun_test_1.expect)(result).not.toBeNull();
            (0, bun_test_1.expect)(result?.error).toContain("restricted to the workspace directory");
        });
    });
    (0, bun_test_1.describe)("validateNoRedundantPrefix", () => {
        ...
        (0, bun_test_1.it)("should work with SSH runtime", () => {
            ...
            const result = (0, fileCommon_1.validateNoRedundantPrefix)("/home/user/mux/project/branch/src/file.ts", sshCwd, sshRuntime);
            (0, bun_test_1.expect)(result).not.toBeNull();
            (0, bun_test_1.expect)(result?.correctedPath).toBe("src/file.ts");
            (0, bun_test_1.expect)(result?.warning).toContain("auto-corrected");
