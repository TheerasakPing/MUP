...
(0, globals_1.describe)("executeFileEditOperation plan mode enforcement", () => {
    ...
    (0, globals_1.test)("should require exact plan file path string in plan mode", async () => {
        ...
        if (!result.success) {
            ...
            (0, globals_1.expect)(result.error).toContain("/home/user/.mux/sessions/ws/plan.md");
            (0, globals_1.expect)(result.error).toContain("../.mux/sessions/ws/plan.md");
        ...
        (0, globals_1.expect)(resolvePathCalls).toContain("../.mux/sessions/ws/plan.md");
        (0, globals_1.expect)(resolvePathCalls).toContain("/home/user/.mux/sessions/ws/plan.md");
    });
});
