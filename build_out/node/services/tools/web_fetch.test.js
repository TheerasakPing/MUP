...
const muxMd_1 = require("../../../common/lib/muxMd");
...
(0, bun_test_1.describe)("mux.md URL helpers", () => {
    (0, bun_test_1.describe)("isMuxMdUrl", () => {
        ...
        (0, bun_test_1.it)("should reject mux.md URLs without hash", () => {
            (0, bun_test_1.expect)((0, muxMd_1.isMuxMdUrl)("https://mux.md/abc123")).toBe(false);
        });
        (0, bun_test_1.it)("should reject mux.md URLs with empty hash", () => {
            (0, bun_test_1.expect)((0, muxMd_1.isMuxMdUrl)("https://mux.md/abc123#")).toBe(false);
        });
        (0, bun_test_1.it)("should reject non-mux.md URLs", () => {
            ...
            (0, bun_test_1.expect)((0, muxMd_1.isMuxMdUrl)("https://other.md/abc#key")).toBe(false);
        });
        (0, bun_test_1.it)("should handle invalid URLs gracefully", () => {
            (0, bun_test_1.expect)((0, muxMd_1.isMuxMdUrl)("not-a-url")).toBe(false);
            (0, bun_test_1.expect)((0, muxMd_1.isMuxMdUrl)("")).toBe(false);
        });
    });
    (0, bun_test_1.describe)("parseMuxMdUrl", () => {
        (0, bun_test_1.it)("should extract id and key from valid mux.md URL", () => {
            const result = (0, muxMd_1.parseMuxMdUrl)("https://mux.md/abc123#key456");
            (0, bun_test_1.expect)(result).toEqual({ id: "abc123", key: "key456" });
        });
        (0, bun_test_1.it)("should handle base64url characters in key", () => {
            const result = (0, muxMd_1.parseMuxMdUrl)("https://mux.md/RQJe3#Fbbhosspt9q9Ig");
...
<body>
  <article>
    ...
    (0, bun_test_1.it)("should not treat non-mux.md URLs with fragments as mux.md shares", async () => {
...
<body>
  <article>
    ...
    <p>This is a fragment test.</p>
            ...
            (0, bun_test_1.expect)(result.success).toBe(true);
            if (result.success) {
                (0, bun_test_1.expect)(result.title).toBe("Fragment Page");
                (0, bun_test_1.expect)(result.content).toContain("This is a fragment test.");
            }
        }
        catch (e_6) {
            env_6.error = e_6;
...
<body><article><p>${largeContent}</p></article></body>
    ...
    (0, bun_test_1.it)("should return error for mux.md URLs without valid key format", async () => {
    ...
    itIntegration("should decrypt and return mux.md content correctly", async () => {
        ...
        try {
            ...
            const uploadResult = await (0, muxMd_1.uploadToMuxMd)(testContent, { name: "test.md", type: "text/markdown", size: testContent.length }, { expiresAt: new Date(Date.now() + 60000) });
            try {
