...
async function withoutSshAgent(fn) {
...
(0, bun_test_1.describe)("SigningService", () => {
    ...
    (0, bun_test_1.describe)("with Ed25519 key", () => {
        (0, bun_test_1.it)("should load key and return capabilities", () => withoutSshAgent(async () => {
        ...
        (0, bun_test_1.it)("should sign messages", () => withoutSshAgent(async () => {
            const service = new signingService_1.SigningService([ed25519KeyPath]);
        ...
        (0, bun_test_1.it)("should return consistent public key across multiple calls", () => withoutSshAgent(async () => {
            const service = new signingService_1.SigningService([ed25519KeyPath]);
    ...
    (0, bun_test_1.describe)("with no key", () => {
        (0, bun_test_1.it)("should return null publicKey when no key exists", () => withoutSshAgent(async () => {
        ...
        (0, bun_test_1.it)("should throw when signing without a key", () => withoutSshAgent(async () => {
            const service = new signingService_1.SigningService(["/nonexistent/path/key"]);
            let threw = false;
            try {
    ...
    (0, bun_test_1.describe)("key path priority", () => {
        (0, bun_test_1.it)("should use first available key in path order", () => withoutSshAgent(async () => {
        ...
        (0, bun_test_1.it)("should skip missing paths and use next available", () => withoutSshAgent(async () => {
    ...
    (0, bun_test_1.describe)("with encrypted key", () => {
        (0, bun_test_1.it)("should detect encrypted key and return hasEncryptedKey=true", () => withoutSshAgent(async () => {
        ...
        (0, bun_test_1.it)("should skip encrypted key and use unencrypted fallback", () => withoutSshAgent(async () => {
        ...
        (0, bun_test_1.it)("should reset hasEncryptedKey on cache clear", () => withoutSshAgent(async () => {
            const service = new signingService_1.SigningService([encryptedKeyPath]);
            const caps1 = await service.getCapabilities();
