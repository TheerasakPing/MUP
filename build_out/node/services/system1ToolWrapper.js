...
exports.wrapToolsWithSystem1 = wrapToolsWithSystem1;
/**
...
const truncateBashOutput_1 = require("../../common/utils/truncateBashOutput");
 ...
 */
function wrapToolsWithSystem1(opts) {
    const { tools } = opts;
...
function buildSystem1ModelContext(opts) {
    ...
    const modelString = raw ? (0, models_1.normalizeGatewayModel)(raw) : "";
    const explicitGateway = raw.startsWith("mux-gateway:");
    const effectiveModelForThinking = modelString || opts.modelString;
    const thinkingLevel = (0, policy_1.enforceThinkingPolicy)(effectiveModelForThinking, opts.system1ThinkingLevel ?? "off");
...
async function maybeFilterBashOutput(params) {
    ...
    const hardTruncation = (0, truncateBashOutput_1.truncateBashOutput)(filterParams.output);
    ...
    try {
        ...
        const lines = (0, bashOutputFiltering_1.splitBashOutputLines)(filterParams.output);
        ...
        if (!system1)
            return undefined;
        const system1ProviderOptions = (0, providerOptions_1.buildProviderOptions)(system1.modelString, system1Ctx.thinkingLevel, undefined, undefined, opts.muxProviderOptions, opts.workspaceId);
        ...
        if (!applied || applied.keptLines === 0) {
            ...
            if (!heuristicFallbackEnabled || upstreamAborted)
                return undefined;
            const heuristicKeepRanges = (0, bashOutputFiltering_1.getHeuristicKeepRangesForBashOutput)({ lines, maxKeptLines });
...
function wrapBashTool(baseTool, executeFn, maybeFilter, workspaceId) {
    const wrapped = (0, cloneToolPreservingDescriptors_1.cloneToolPreservingDescriptors)(baseTool);
