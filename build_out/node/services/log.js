...
let _debugObjDir = null;
function getDebugObjDir() {
    _debugObjDir ?? (_debugObjDir = path.join((0, paths_1.getMuxHome)(), "debug_obj"));
    return _debugObjDir;
}
...
function getDefaultLogLevel() {
    ...
    if ((0, env_1.parseBoolEnv)(process.env.MUX_DEBUG)) {
        return "debug";
    }
...
const chalkDim = typeof chalk_1.default.dim === "function"
    ? chalk_1.default.dim
    : (text) => text;
const chalkCyan = typeof chalk_1.default.cyan === "function"
    ? chalk_1.default.cyan
    : (text) => text;
const chalkGray = typeof chalk_1.default.gray === "function"
    ? chalk_1.default.gray
    : (text) => text;
const chalkRed = typeof chalk_1.default.red === "function"
    ? chalk_1.default.red
    : (text) => text;
const chalkYellow = typeof chalk_1.default.yellow === "function"
 ...
 */
function safePipeLog(level, ...args) {
    ...
    try {
        if (level === "error") {
            ...
            if (useColor) {
                console.error(prefix, ...args.map((arg) => (typeof arg === "string" ? chalkRed(arg) : arg)));
            }
            else {
            ...
            if (useColor) {
                console.error(prefix, ...args.map((arg) => (typeof arg === "string" ? chalkYellow(arg) : arg)));
            }
            else {
                console.error(prefix, ...args);
            }
...
function appendFieldsToArgs(args, fields) {
    if (!fields) {
        return args;
    }
    if (args.length === 0) {
