...
`,
    ...
    (0, bun_test_1.test)("does not include available-subagents section (moved to tool description)", async () => {
        const metadata = {
            id: "test-workspace",
            name: "test-workspace",
            projectName: "test-project",
        ...
        (0, bun_test_1.expect)(systemMessage).not.toContain("<available-subagents>");
    });
});
