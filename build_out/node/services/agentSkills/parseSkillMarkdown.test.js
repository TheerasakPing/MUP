...
`;
    ...
    (0, bun_test_1.test)("parses advertise field in frontmatter", () => {
        const content = `---
name: internal-skill
...
Body
`;
        const directoryName = schemas_1.SkillNameSchema.parse("internal-skill");
        const result = (0, parseSkillMarkdown_1.parseSkillMarkdown)({
            content,
            byteSize: Buffer.byteLength(content, "utf-8"),
            directoryName,
        });
        (0, bun_test_1.expect)(result.frontmatter.name).toBe("internal-skill");
        (0, bun_test_1.expect)(result.frontmatter.advertise).toBe(false);
    });
