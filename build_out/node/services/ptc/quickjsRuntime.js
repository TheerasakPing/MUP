...
exports.QuickJSRuntimeFactory = exports.QuickJSRuntime = void 0;
...
class QuickJSRuntime {
    ...
    eventHandler;
    abortController;
    abortRequested = false; // Track abort requests before eval() starts
    limits = {};
    consoleSetup = false;
    ...
    async eval(code) {
        ...
        try {
            ...
            if (evalResult.error) {
                const errObj = this.ctx.dump(evalResult.error);
            ...
            const value = this.ctx.dump(evalResult.value);
     ...
     */
    getErrorMessage(errorObj, deadline, timeoutMs) {
        ...
        if (refErrorMatch) {
            ...
            if (staticAnalysis_1.UNAVAILABLE_IDENTIFIERS.has(identifier)) {
     ...
     */
    marshal(value, seen = new WeakSet()) {
        if (value === undefined) {
        ...
        if (typeof value === "object") {
            ...
            try {
                ...
                return this.marshalObject(value, seen);
            }
            finally {
...
exports.QuickJSRuntimeFactory = QuickJSRuntimeFactory;
//# sourceMappingURL=quickjsRuntime.js.map