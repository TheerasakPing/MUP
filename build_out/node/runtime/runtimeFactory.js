...
exports.setGlobalCoderService = setGlobalCoderService;
 ...
 */
function setGlobalCoderService(service) {
    ...
    switch (config.type) {
        ...
        case "ssh": {
            ...
            if (config.coder) {
                ...
                return new CoderSSHRuntime_1.CoderSSHRuntime({ ...sshConfig, coder: config.coder }, transport, coderService, {
                    projectPath: options?.projectPath,
                    workspaceName: options?.workspaceName,
                });
            }
