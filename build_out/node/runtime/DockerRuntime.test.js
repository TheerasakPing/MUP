...
(0, bun_test_1.describe)("getContainerName", () => {
    (0, bun_test_1.it)("should generate container name from project and workspace", () => {
        (0, bun_test_1.expect)((0, DockerRuntime_1.getContainerName)("/home/user/myproject", "feature-branch")).toBe("mux-myproject-feature-branch-a8d18a");
    });
    (0, bun_test_1.it)("should sanitize special characters", () => {
        (0, bun_test_1.expect)((0, DockerRuntime_1.getContainerName)("/home/user/my@project", "feature/branch")).toBe("mux-my-project-feature-branch-b354b4");
    });
