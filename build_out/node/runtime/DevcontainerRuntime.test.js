...
(0, bun_test_1.describe)("DevcontainerRuntime.resolvePath", () => {
    (0, bun_test_1.it)("resolves ~ to cached remoteHomeDir", async () => {
        ...
        (0, bun_test_1.expect)(await runtime.resolvePath("~")).toBe("/home/coder");
    });
    ...
    (0, bun_test_1.it)("resolves ~/path to cached remoteHomeDir", async () => {
        ...
        (0, bun_test_1.expect)(await runtime.resolvePath("~/.mux")).toBe("/opt/user/.mux");
    });
...
(0, bun_test_1.describe)("DevcontainerRuntime.quoteForContainer", () => {
    ...
    (0, bun_test_1.it)("uses $HOME expansion for tilde paths", () => {
        const runtime = createRuntime({});
        (0, bun_test_1.expect)(quoteForContainer(runtime, "~/.mux")).toBe('"$HOME/.mux"');
    });
});
...
(0, bun_test_1.describe)("DevcontainerRuntime.mapHostPathToContainer", () => {
    ...
    (0, bun_test_1.it)("maps host workspace root to container workspace", () => {
        ...
        (0, bun_test_1.expect)(mapHostPathToContainer(runtime, "/home/user/mux/project/branch")).toBe("/workspaces/project");
    });
    (0, bun_test_1.it)("maps host subpath to container subpath", () => {
        ...
        (0, bun_test_1.expect)(mapHostPathToContainer(runtime, "/home/user/mux/project/branch/src/file.ts")).toBe("/workspaces/project/src/file.ts");
    });
    (0, bun_test_1.it)("normalizes Windows backslashes to forward slashes", () => {
        ...
        (0, bun_test_1.expect)(mapHostPathToContainer(runtime, "C:\\Users\\dev\\mux\\project\\branch\\src\\file.ts")).toBe("/workspaces/project/src/file.ts");
    });
