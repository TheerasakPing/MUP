...
(0, bun_test_1.describe)("backgroundCommands", () => {
    ...
    (0, bun_test_1.describe)("buildWrapperScript", () => {
        (0, bun_test_1.it)("builds script with trap, cd, and user script joined by &&", () => {
            ...
            (0, bun_test_1.expect)(result).toBe(`__MUX_EXIT_CODE_PATH='/tmp/exit_code' && trap 'echo $? > "$__MUX_EXIT_CODE_PATH"' EXIT && cd '/home/user/project' && echo hello`);
        });
    ...
    (0, bun_test_1.describe)("buildTerminateCommand", () => {
        ...
        (0, bun_test_1.it)("uses custom quotePath function for SSH tilde expansion", () => {
            ...
            const result = (0, backgroundCommands_1.buildTerminateCommand)(1234, "~/mux/exit_code", expandTilde);
            (0, bun_test_1.expect)(result).toContain('"$HOME/mux/exit_code"');
        });
    });
