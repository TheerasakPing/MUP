...
exports.RuntimeStatusEventSchema = zod_1.z.object({
    ...
    detail: zod_1.z.string().optional(), // Human-readable status like "Starting Coder workspace..."
});
...
const ThinkingLevelSchema = zod_1.z.enum(thinking_1.THINKING_LEVELS);
...
exports.CompletedMessagePartSchema = zod_1.z.discriminatedUnion("type", [
    message_1.MuxReasoningPartSchema,
    message_1.MuxTextPartSchema,
    message_1.MuxToolPartSchema,
]);
 ...
 */
exports.TaskCreatedEventSchema = zod_1.z.object({
    type: zod_1.z.literal("task-created"),
    workspaceId: zod_1.z.string(),
    toolCallId: zod_1.z.string(),
    taskId: zod_1.z.string(),
    timestamp: zod_1.z.number().meta({ description: "When the task was created (Date.now())" }),
});
...
exports.ChatMuxMessageSchema = message_1.MuxMessageSchema.extend({
...
exports.ExperimentsSchema = zod_1.z.object({
    ...
    execSubagentHardRestart: zod_1.z.boolean().optional(),
});
// SendMessage options
exports.SendMessageOptionsSchema = zod_1.z.object({
    ...
    system1ThinkingLevel: zod_1.z.enum(["off", "low", "medium", "high", "xhigh", "max"]).optional(),
    ...
    providerOptions: providerOptions_1.MuxProviderOptionsSchema.optional(),
    muxMetadata: zod_1.z.any().optional(), // Black box
    /**
     * When true, skip persisting AI settings (e.g., for one-shot or compaction sends).
     */
    skipAiSettingsPersistence: zod_1.z.boolean().optional(),
