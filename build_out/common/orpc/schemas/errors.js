...
exports.SendMessageErrorSchema = zod_1.z.discriminatedUnion("type", [
  ...
  zod_1.z.object({ type: zod_1.z.literal("oauth_not_connected"), provider: zod_1.z.string() }),
  ...
  zod_1.z.object({ type: zod_1.z.literal("policy_denied"), message: zod_1.z.string() }),
