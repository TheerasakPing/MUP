...
exports.modelPresets = exports.ModelPresetSchema = exports.PresetModelEntrySchema = exports.debug = exports.voice = exports.menu = exports.general = exports.features = exports.update = exports.splashScreens = exports.uiLayouts = exports.config = exports.server = exports.ApiServerStatusSchema = exports.terminal = exports.window = exports.nameGeneration = exports.agentSkills = exports.agents = exports.tasks = exports.workspace = exports.CoderWorkspaceStatusSchema = exports.CoderWorkspaceSchema = exports.CoderWorkspaceConfigSchema = exports.CoderTemplateSchema = exports.CoderPresetSchema = exports.CoderInfoSchema = exports.coder = exports.secrets = exports.mcp = exports.projects = exports.mcpOauth = exports.muxGateway = exports.codexOauth = exports.muxGovernorOauth = exports.copilotOauth = exports.muxGatewayOauth = exports.policy = exports.providers = exports.ProvidersConfigMapSchema = exports.ProviderConfigInfoSchema = exports.CustomModelMetadataSchema = exports.AWSCredentialStatusSchema = exports.tokenizer = exports.BackgroundProcessInfoSchema = exports.signing = exports.TelemetryEventSchema = exports.telemetry = exports.experiments = exports.ExperimentValueSchema = void 0;
exports.costTracking = exports.ModelCostBreakdownSchema = exports.CostSummaryTotalsSchema = exports.CostHistoryRangeSchema = exports.DailySummarySchema = exports.CostEntrySchema = exports.modelHealth = exports.HealthCheckResultSchema = exports.CheckResultSchema = exports.OverallStatusSchema = exports.CheckStatusSchema = void 0;
...
exports.codexOauth = {
    startDesktopFlow: {
        input: zod_1.z.void(),
        output: (0, result_1.ResultSchema)(zod_1.z.object({ flowId: zod_1.z.string(), authorizeUrl: zod_1.z.string() }), zod_1.z.string()),
    },
    waitForDesktopFlow: {
        input: zod_1.z
            .object({
...
const MCPOAuthPendingServerSchema = zod_1.z
    ...
    transport: zod_1.z.union([zod_1.z.literal("http"), zod_1.z.literal("sse"), zod_1.z.literal("auto")]),
    url: zod_1.z.string(),
})
    .strict();
// MCP OAuth
...
Object.defineProperty(exports, "CoderInfoSchema", { enumerable: true, get: function () { return coder_1.CoderInfoSchema; } });
Object.defineProperty(exports, "CoderPresetSchema", { enumerable: true, get: function () { return coder_1.CoderPresetSchema; } });
Object.defineProperty(exports, "CoderTemplateSchema", { enumerable: true, get: function () { return coder_1.CoderTemplateSchema; } });
Object.defineProperty(exports, "CoderWorkspaceConfigSchema", { enumerable: true, get: function () { return coder_1.CoderWorkspaceConfigSchema; } });
Object.defineProperty(exports, "CoderWorkspaceSchema", { enumerable: true, get: function () { return coder_1.CoderWorkspaceSchema; } });
Object.defineProperty(exports, "CoderWorkspaceStatusSchema", { enumerable: true, get: function () { return coder_1.CoderWorkspaceStatusSchema; } });
// Workspace
...
exports.DailySummarySchema = zod_1.z.object({
    ...
    byModel: zod_1.z.record(zod_1.z.string(), zod_1.z.object({ cost: zod_1.z.number(), requests: zod_1.z.number(), tokens: zod_1.z.number() })),
});
...
exports.ModelCostBreakdownSchema = zod_1.z.record(zod_1.z.string(), zod_1.z.object({ cost: zod_1.z.number(), requests: zod_1.z.number(), tokens: zod_1.z.number() }));
exports.costTracking = {
    ...
    getDailySummaries: {
        input: zod_1.z.object({ startDate: zod_1.z.string().optional(), endDate: zod_1.z.string().optional() }),
