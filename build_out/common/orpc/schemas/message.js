...
exports.BranchListResultSchema = exports.MuxMessageSchema = exports.MuxFilePartSchema = exports.MuxToolPartSchema = exports.DynamicToolPartSchema = exports.DynamicToolPartRedactedSchema = exports.DynamicToolPartAvailableSchema = exports.DynamicToolPartPendingSchema = exports.NestedToolCallSchema = exports.MuxReasoningPartSchema = exports.MuxTextPartSchema = exports.FilePartSchema = void 0;
...
const CompactionEpochSchema = zod_1.z.optional(zod_1.z.preprocess((value) => typeof value === "number" && Number.isInteger(value) && value > 0 ? value : undefined, zod_1.z.number().int().positive().or(zod_1.z.undefined())));
