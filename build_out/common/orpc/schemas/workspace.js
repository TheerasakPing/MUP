...
exports.GitStatusSchema =
  exports.PostCompactionStateSchema =
...
exports.FrontendWorkspaceMetadataSchema = exports.WorkspaceMetadataSchema.extend({
  ...
  isInitializing: zod_1.z.boolean().optional().meta({
    description:
...
exports.WorkspaceActivitySnapshotSchema = zod_1.z.object({
  ...
  streaming: zod_1.z
    .boolean()
    .meta({ description: "Whether workspace currently has an active stream" }),
  lastModel: zod_1.z
    .string()
    .nullable()
    .meta({ description: "Last model sent from this workspace" }),
