...
exports.MCPTestResultSchema =
  exports.BearerChallengeSchema =
  exports.MCPTestParamsSchema =
  exports.MCPTestGlobalParamsSchema =
  exports.MCPSetToolAllowlistParamsSchema =
  exports.MCPSetToolAllowlistGlobalParamsSchema =
  exports.MCPSetEnabledParamsSchema =
  exports.MCPSetEnabledGlobalParamsSchema =
  exports.MCPRemoveParamsSchema =
  exports.MCPRemoveGlobalParamsSchema =
  exports.MCPAddParamsSchema =
  exports.MCPAddGlobalParamsSchema =
  exports.MCPListParamsSchema =
  exports.MCPServerMapSchema =
  exports.MCPServerInfoSchema =
  exports.MCPHeadersSchema =
  exports.MCPHeaderValueSchema =
  exports.MCPTransportSchema =
  exports.WorkspaceMCPOverridesSchema =
    void 0;
...
exports.MCPHeaderValueSchema = zod_1.z.union([
  zod_1.z.string(),
  zod_1.z.object({ secret: zod_1.z.string() }),
]);
...
function refineMcpAddParams(input, ctx) {
  ...
  if (!input.url?.trim()) {
    ctx.addIssue({
      ...
      message: "url is required for http/sse/auto",
    });
  }
}
