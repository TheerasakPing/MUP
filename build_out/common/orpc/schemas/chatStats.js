...
exports.ChatStatsSchema = zod_1.z.object({
  consumers: zod_1.z
    .array(exports.TokenConsumerSchema)
    .meta({ description: "Sorted descending by token count" }),
...
exports.SessionUsageTokenStatsCacheSchema = zod_1.z.object({
  ...
  computedAt: zod_1.z
    .number()
    .meta({ description: "Unix timestamp (ms) when this cache was computed" }),
  model: zod_1.z
    .string()
    .meta({ description: "Model used for tokenization (affects tokenizer + tool definitions)" }),
  tokenizerName: zod_1.z.string().meta({ description: 'e.g., "o200k_base", "claude"' }),
  history: zod_1.z.object({
    messageCount: zod_1.z
      .number()
      .meta({ description: "Number of messages used to compute this cache" }),
