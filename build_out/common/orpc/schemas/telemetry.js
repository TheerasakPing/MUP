...
const TelemetryThinkingLevelSchema = zod_1.z.enum(["off", "low", "medium", "high", "xhigh", "max"]);
...
const TelemetryMCPOAuthFlowErrorCategorySchema = zod_1.z.enum([
  "timeout",
  "cancelled",
  "state_mismatch",
  "provider_error",
...
const MCPOAuthFlowStartedPropertiesSchema = zod_1.z.object({
  transport: TelemetryMCPServerTransportSchema,
  has_scope_hint: zod_1.z.boolean(),
  has_resource_metadata_hint: zod_1.z.boolean(),
});
const MCPOAuthFlowCompletedPropertiesSchema = zod_1.z.object({
  transport: TelemetryMCPServerTransportSchema,
  duration_ms_b2: zod_1.z.number(),
  has_scope_hint: zod_1.z.boolean(),
  has_resource_metadata_hint: zod_1.z.boolean(),
});
const MCPOAuthFlowFailedPropertiesSchema = zod_1.z.object({
  transport: TelemetryMCPServerTransportSchema,
  duration_ms_b2: zod_1.z.number(),
  has_scope_hint: zod_1.z.boolean(),
  has_resource_metadata_hint: zod_1.z.boolean(),
...
exports.TelemetryEventSchema = zod_1.z.discriminatedUnion("event", [
  ...
  zod_1.z.object({
    event: zod_1.z.literal("mcp_oauth_flow_started"),
    properties: MCPOAuthFlowStartedPropertiesSchema,
  }),
  zod_1.z.object({
    event: zod_1.z.literal("mcp_oauth_flow_completed"),
    properties: MCPOAuthFlowCompletedPropertiesSchema,
  }),
  zod_1.z.object({
    event: zod_1.z.literal("mcp_oauth_flow_failed"),
