...
exports.PolicyGetResponseSchema = exports.EffectivePolicySchema = exports.EffectivePolicyProviderAccessSchema = exports.PolicySourceSchema = exports.PolicyStatusSchema = exports.PolicyFileSchema = exports.PolicyRuntimeAccessSchema = exports.PolicyRuntimeIdSchema = exports.PolicyToolsSchema = exports.PolicyAllowUserDefinedMCPSchema = exports.PolicyProviderAccessSchema = exports.PolicyProviderNameSchema = exports.PolicyFormatVersionSchema = void 0;
...
exports.EffectivePolicySchema = zod_1.z
    ...
    mcp: zod_1.z
        .object({
        allowUserDefined: zod_1.z.object({ stdio: zod_1.z.boolean(), remote: zod_1.z.boolean() }).strict(),
    })
        .strict(),
