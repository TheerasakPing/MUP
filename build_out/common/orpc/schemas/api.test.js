...
(0, bun_test_1.describe)("ProviderConfigInfoSchema conformance", () => {
  ...
  (0, bun_test_1.it)(
    "preserves all ProviderConfigInfo fields (full object with all optional fields)",
    () => {
      ...
      (0, bun_test_1.expect)(parsed.codexOauthSet).toBe(full.codexOauthSet);
      (0, bun_test_1.expect)(parsed.codexOauthDefaultAuth).toBe(full.codexOauthDefaultAuth);
      (0, bun_test_1.expect)(parsed.aws).toEqual(full.aws);
