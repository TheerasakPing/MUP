...
(0, bun_test_1.describe)("resolveSectionColor", () => {
  (0, bun_test_1.it)("returns default for empty/undefined", () => {
    (0, bun_test_1.expect)((0, ui_1.resolveSectionColor)(undefined)).toBe(
      ui_1.DEFAULT_SECTION_COLOR
    );
  ...
  (0, bun_test_1.it)("falls back to default for invalid values", () => {
    (0, bun_test_1.expect)((0, ui_1.resolveSectionColor)("not-a-color")).toBe(
      ui_1.DEFAULT_SECTION_COLOR
    );
  });
});
