...
(0, bun_test_1.describe)("storage workspace-scoped keys", () => {
  ...
  (0, bun_test_1.test)("getDraftScopeId formats scope id", () => {
    (0, bun_test_1.expect)((0, storage_1.getDraftScopeId)("/Users/me/repo", "draft-123")).toBe(
      "__draft__//Users/me/repo/draft-123"
    );
  });
  (0, bun_test_1.test)("getInputAttachmentsKey formats key", () => {
    (0, bun_test_1.expect)((0, storage_1.getInputAttachmentsKey)("ws-123")).toBe(
      "inputAttachments:ws-123"
    );
  });
