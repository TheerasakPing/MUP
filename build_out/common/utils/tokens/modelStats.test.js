...
(0, bun_test_1.describe)("getModelStats", () => {
  ...
  (0, bun_test_1.describe)("mux-gateway models", () => {
    (0, bun_test_1.test)("should handle mux-gateway:anthropic/model format", () => {
      const stats = (0, modelStats_1.getModelStats)("mux-gateway:anthropic/claude-sonnet-4-5");
      (0, bun_test_1.expect)(stats).not.toBeNull();
    ...
    (0, bun_test_1.test)("should handle mux-gateway:openai/model format", () => {
      const stats = (0, modelStats_1.getModelStats)("mux-gateway:openai/gpt-4o");
      (0, bun_test_1.expect)(stats).not.toBeNull();
      (0, bun_test_1.expect)(stats?.max_input_tokens).toBeGreaterThan(0);
    });
    (0, bun_test_1.test)("should return null for mux-gateway with unknown model", () => {
      const stats = (0, modelStats_1.getModelStats)("mux-gateway:anthropic/unknown-model-xyz");
      (0, bun_test_1.expect)(stats).toBeNull();
    });
  });
