...
(0, bun_test_1.describe)("predictTokenUsage", () => {
  ...
  (0, bun_test_1.it)("should include attached files in token count", () => {
    ...
    (0, bun_test_1.expect)(withFiles.estimatedInputTokens).toBeGreaterThan(
      withoutFiles.estimatedInputTokens
    );
  });
  (0, bun_test_1.it)("should include current context in token count", () => {
    ...
    (0, bun_test_1.expect)(withContext.estimatedInputTokens).toBeGreaterThan(
      withoutContext.estimatedInputTokens
    );
  });
  ...
  (0, bun_test_1.it)("should set critical warning level for >100k tokens", () => {
    ...
    (0, bun_test_1.expect)(result.suggestions).toContain(
