...
(0, bun_test_1.describe)("createDisplayUsage", () => {
  ...
  (0, bun_test_1.test)(
    "falls back to providerMetadata.openai.reasoningTokens when usage.reasoningTokens is undefined",
    () => {
      const usage = {
        inputTokens: 1000,
        outputTokens: 500,
      ...
      const result = (0, tokenStatsCalculator_1.createDisplayUsage)(
        usage,
        "openai:gpt-5-pro",
        providerMetadata
      );
  ...
  (0, bun_test_1.test)(
    "uses 0 when both usage.reasoningTokens and providerMetadata.openai.reasoningTokens are undefined",
    () => {
      const usage = {
        inputTokens: 1000,
        outputTokens: 500,
  ...
  (0, bun_test_1.test)(
    "prefers usage.reasoningTokens over providerMetadata when both exist",
    () => {
      const usage = {
        inputTokens: 1000,
        outputTokens: 500,
  ...
  (0, bun_test_1.test)(
    "works with non-OpenAI providers that don't have providerMetadata.openai",
    () => {
      const usage = {
        inputTokens: 1000,
        outputTokens: 500,
...
(0, bun_test_1.describe)("extractToolOutputData", () => {
  (0, bun_test_1.test)("extracts value from nested structure", () => {
    ...
    (0, bun_test_1.expect)((0, tokenStatsCalculator_1.extractToolOutputData)(output)).toEqual({
      foo: "bar",
    });
  });
  ...
  (0, bun_test_1.test)("handles primitives", () => {
    (0, bun_test_1.expect)((0, tokenStatsCalculator_1.extractToolOutputData)("string")).toBe(
      "string"
    );
...
(0, bun_test_1.describe)("isEncryptedWebSearch", () => {
  (0, bun_test_1.test)("returns false for non-web_search tools", () => {
    ...
    (0, bun_test_1.expect)((0, tokenStatsCalculator_1.isEncryptedWebSearch)("Read", data)).toBe(
      false
    );
  });
  (0, bun_test_1.test)("returns false for non-array data", () => {
    (0, bun_test_1.expect)(
      (0, tokenStatsCalculator_1.isEncryptedWebSearch)("web_search", { foo: "bar" })
    ).toBe(false);
  });
  (0, bun_test_1.test)("returns false for web_search without encrypted content", () => {
    const data = [{ title: "foo", url: "bar" }];
    (0, bun_test_1.expect)(
      (0, tokenStatsCalculator_1.isEncryptedWebSearch)("web_search", data)
    ).toBe(false);
  });
...
(0, bun_test_1.describe)("countEncryptedWebSearchTokens", () => {
  (0, bun_test_1.test)("calculates tokens using heuristic", () => {
    ...
    // 100 chars * 0.75 = 75
    (0, bun_test_1.expect)((0, tokenStatsCalculator_1.countEncryptedWebSearchTokens)(data)).toBe(
      75
    );
  });
...
(0, bun_test_1.describe)("extractSyncMetadata", () => {
  (0, bun_test_1.test)("accumulates system message tokens", () => {
    ...
    const result = (0, tokenStatsCalculator_1.extractSyncMetadata)(
      messages,
...
(0, bun_test_1.describe)("getConsumerInfoForToolCall", () => {
  (0, bun_test_1.test)("labels task tool calls as task", () => {
    (0, bun_test_1.expect)(
      (0, tokenStatsCalculator_1.getConsumerInfoForToolCall)("task", {
        subagent_type: "exec",
        prompt: "hi",
        title: "t",
      })
  ...
  (0, bun_test_1.test)("defaults to tool name for other tools", () => {
    (0, bun_test_1.expect)(
      (0, tokenStatsCalculator_1.getConsumerInfoForToolCall)("file_edit_insert", {
        file_path: "x",
        content: "y",
      })
    ).toEqual({
...
(0, bun_test_1.describe)("mergeResults", () => {
  (0, bun_test_1.test)("merges job results into consumer map", () => {
    ...
    const consumerMap = (0, tokenStatsCalculator_1.mergeResults)(
      jobs,
      results,
      toolDefinitions,
      systemMessageTokens
