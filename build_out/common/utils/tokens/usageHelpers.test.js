...
(0, bun_test_1.describe)("addUsage", () => {
  ...
  (0, bun_test_1.test)("accumulates across multiple calls (simulating multi-step)", () => {
    ...
    // Step 1
    cumulative = (0, usageHelpers_1.addUsage)(cumulative, {
      inputTokens: 1000,
      outputTokens: 100,
      totalTokens: 1100,
    });
...
(0, bun_test_1.describe)("accumulateProviderMetadata", () => {
  ...
  (0, bun_test_1.test)("returns step when neither has cache creation tokens", () => {
    ...
    (0, bun_test_1.expect)((0, usageHelpers_1.accumulateProviderMetadata)(existing, step)).toBe(
      step
    );
  });
  ...
  (0, bun_test_1.test)(
    "handles non-anthropic providers (returns step as-is when no cache tokens)",
    () => {
  ...
  (0, bun_test_1.test)(
    "accumulates across multiple steps (simulating multi-step tool calls)",
    () => {
      let cumulative = undefined;
