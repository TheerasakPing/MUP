 ...
 */
function getModelStats(modelString, customConfig) {
    ...
    if (customConfig) {
        if (!stats) {
            ...
            if (typeof customConfig.maxInputTokens === "number" &&
        ...
        return {
            ...
            cache_creation_input_token_cost: customConfig.cacheCreationInputTokenCost ?? stats.cache_creation_input_token_cost,
            cache_read_input_token_cost: customConfig.cacheReadInputTokenCost ?? stats.cache_read_input_token_cost,
        };
    }
    return stats;
}
