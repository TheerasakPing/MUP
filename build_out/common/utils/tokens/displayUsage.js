...
function createDisplayUsage(usage, model, providerMetadata, customModelConfig) {
  ...
  const cacheCreateTokens = providerMetadata?.anthropic?.cacheCreationInputTokens ?? 0;
  ...
  const reasoningTokens = usage.reasoningTokens ?? providerMetadata?.openai?.reasoningTokens ?? 0;
