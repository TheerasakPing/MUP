...
(0, bun_test_1.describe)("parseMuxDeepLink", () => {
  (0, bun_test_1.test)("parses mux://chat/new", () => {
    const payload = (0, deepLink_1.parseMuxDeepLink)(
  ...
  (0, bun_test_1.test)("returns null for invalid scheme", () => {
    (0, bun_test_1.expect)(
      (0, deepLink_1.parseMuxDeepLink)("http://chat/new?prompt=hi")
    ).toBeNull();
  });
  ...
  (0, bun_test_1.test)("resolves deep-link project query by final path segment", () => {
    const resolved = (0, deepLink_1.resolveProjectPathFromProjectQuery)(
  ...
  (0, bun_test_1.test)("returns null when no project matches", () => {
    (0, bun_test_1.expect)(
      (0, deepLink_1.resolveProjectPathFromProjectQuery)(["/Users/mike/repos/coder"], "mux")
    ).toBeNull();
  });
});
