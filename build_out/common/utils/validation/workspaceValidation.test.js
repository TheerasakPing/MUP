...
describe("validateWorkspaceName", () => {
  describe("valid names", () => {
    ...
    test("accepts combinations", () => {
      expect((0, workspaceValidation_1.validateWorkspaceName)("feature-branch_123").valid).toBe(
        true
      );
  ...
  describe("invalid names", () => {
    ...
    test("rejects names with slashes", () => {
      ...
      expect((0, workspaceValidation_1.validateWorkspaceName)("path\\to\\branch").valid).toBe(
        false
      );
    });
  });
