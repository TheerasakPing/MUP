...
exports.getPlanModeInstruction = getPlanModeInstruction;
exports.getPlanFileHint = getPlanFileHint;
/**
 ...
 */
function getPlanModeInstruction(planFilePath, planExists) {
 ...
 */
function getPlanFileHint(planFilePath, planExists) {
