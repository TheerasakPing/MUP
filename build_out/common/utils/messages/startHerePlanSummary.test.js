...
(0, bun_test_1.describe)("isStartHerePlanSummaryMessage", () => {
  (0, bun_test_1.it)(
    "returns true for Start Here summary messages that include plan content",
    () => {
      ...
      (0, bun_test_1.expect)((0, startHerePlanSummary_1.isStartHerePlanSummaryMessage)(msg)).toBe(
        true
      );
    }
  );
  (0, bun_test_1.it)(
    "returns false for Start Here summaries that only include the placeholder",
    () => {
      const msg = createTextMessage({
        id: "start-here-123",
        role: "assistant",
...
(0, bun_test_1.describe)("hasStartHerePlanSummary", () => {
  (0, bun_test_1.it)(
    "returns true when a Start Here plan summary exists anywhere in history",
    () => {
      const messages = [
        createTextMessage({
          id: "start-here-123",
      ...
      (0, bun_test_1.expect)((0, startHerePlanSummary_1.hasStartHerePlanSummary)(messages)).toBe(
        true
      );
    }
  );
