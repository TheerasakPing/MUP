...
(0, bun_test_1.describe)("buildChatJsonlForSharing", () => {
    (0, bun_test_1.it)("strips tool output and sets state to output-redacted when includeToolOutput=false", () => {
        const messages = [
            {
                id: "assistant-1",
                role: "assistant",
        ...
        const jsonl = (0, transcriptShare_1.buildChatJsonlForSharing)(messages, { includeToolOutput: false });
    ...
    (0, bun_test_1.it)("strips nestedCalls output and sets nestedCalls state to output-redacted when includeToolOutput=false", () => {
        const messages = [
            {
                id: "assistant-1",
                role: "assistant",
    ...
    (0, bun_test_1.it)("leaves messages unchanged when includeToolOutput=true", () => {
        ...
        const jsonl = (0, transcriptShare_1.buildChatJsonlForSharing)(messages, { includeToolOutput: true });
        const parsed = JSON.parse(splitJsonlLines(jsonl)[0]);
        (0, bun_test_1.expect)(parsed).toEqual(messages[0]);
    });
    (0, bun_test_1.it)("inlines planContent into propose_plan tool output when planSnapshot matches", () => {
        const messages = [
            {
                id: "assistant-1",
                role: "assistant",
    ...
    (0, bun_test_1.it)("inlines planContent even when propose_plan planPath uses ~ but planSnapshot.path is resolved", () => {
        const messages = [
            {
                id: "assistant-1",
                role: "assistant",
    ...
    (0, bun_test_1.it)("inlines planContent even when propose_plan planPath uses Windows-style slashes", () => {
        const messages = [
            {
                id: "assistant-1",
                role: "assistant",
    ...
    (0, bun_test_1.it)("inlines planContent even when planSnapshot.path differs from propose_plan planPath", () => {
        const messages = [
            {
                id: "assistant-1",
                role: "assistant",
    ...
    (0, bun_test_1.it)("preserves propose_plan output (with planContent) while stripping other tool outputs when includeToolOutput=false", () => {
        const messages = [
            {
                id: "assistant-1",
                role: "assistant",
    ...
    (0, bun_test_1.it)("preserves task tool outputs while stripping other tool outputs when includeToolOutput=false", () => {
        const messages = [
            {
                id: "assistant-1",
                role: "assistant",
        ...
        (0, bun_test_1.expect)(taskOutput.reportMarkdown).toBe("## Report\n\nFixed the bug in foo.ts");
    ...
    (0, bun_test_1.it)("injects workspaceId into each message when provided", () => {
        ...
        const jsonl = (0, transcriptShare_1.buildChatJsonlForSharing)(messages, { workspaceId: "ws-123" });
        const parsed = JSON.parse(splitJsonlLines(jsonl)[0]);
