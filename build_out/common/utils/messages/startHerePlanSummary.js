...
exports.isStartHerePlanSummaryMessage = isStartHerePlanSummaryMessage;
exports.hasStartHerePlanSummary = hasStartHerePlanSummary;
...
function getPlanBodyText(startHereText) {
 ...
 */
function isStartHerePlanSummaryMessage(message) {
...
function hasStartHerePlanSummary(messages) {
  for (let i = messages.length - 1; i >= 0; i--) {
    if (isStartHerePlanSummaryMessage(messages[i])) return true;
  }
  return false;
}
//# sourceMappingURL=startHerePlanSummary.js.map
