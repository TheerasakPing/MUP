...
exports.sortProjectsByOrder = sortProjectsByOrder;
exports.reorderProjects = reorderProjects;
exports.normalizeOrder = normalizeOrder;
exports.equalOrders = equalOrders;
/**
 ...
 */
function reorderProjects(currentOrder, allProjects, draggedPath, targetPath) {
 ...
 * project ordering.
 */
function normalizeOrder(order, projects) {
...
//# sourceMappingURL=projectOrdering.js.map
