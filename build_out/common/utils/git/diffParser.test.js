...
(0, bun_test_1.describe)("git diff parser (real repository)", () => {
  ...
  (0, bun_test_1.beforeAll)(() => {
    ...
    (0, child_process_1.execSync)('git config user.email "test@example.com"', {
      cwd: testRepoPath,
    });
    ...
    (0, fs_2.writeFileSync)(
      (0, path_1.join)(testRepoPath, "file1.txt"),
      "Line 1\nLine 2\nLine 3\nLine 4\nLine 5\n"
    );
    (0, fs_2.writeFileSync)(
      (0, path_1.join)(testRepoPath, "file2.js"),
      'function hello() {\n  console.log("Hello");\n}\n'
    );
  ...
  (0, bun_test_1.it)("should parse new file addition", () => {
    ...
    // Add new file
    (0, fs_2.writeFileSync)(
      (0, path_1.join)(testRepoPath, "newfile.md"),
      "# New File\n\nContent here\n"
    );
  ...
  (0, bun_test_1.it)("should parse file deletion", () => {
    ...
    (0, child_process_1.execSync)("git add . && git commit -m 'Add newfile'", {
      cwd: testRepoPath,
    });
    // Delete file
  ...
  (0, bun_test_1.it)("should parse branch comparison (three-dot diff)", () => {
    ...
    (0, child_process_1.execSync)("git add . && git commit -m 'Add feature'", {
      cwd: testRepoPath,
    });
  ...
  (0, bun_test_1.it)("should generate stable hunk IDs for same content", () => {
    ...
    const diff1 = (0, child_process_1.execSync)("git diff HEAD", {
      cwd: testRepoPath,
      encoding: "utf-8",
    });
    ...
    const diff2 = (0, child_process_1.execSync)("git diff HEAD", {
      cwd: testRepoPath,
      encoding: "utf-8",
    });
  ...
  (0, bun_test_1.it)("should handle large diffs with many hunks", () => {
    ...
    (0, child_process_1.execSync)("git add . && git commit -m 'Add large file'", {
      cwd: testRepoPath,
    });
    ...
    (0, fs_2.writeFileSync)(
      (0, path_1.join)(testRepoPath, "large.txt"),
      modifiedLines.join("\n") + "\n"
    );
    const diff = (0, child_process_1.execSync)("git diff HEAD", {
      cwd: testRepoPath,
  ...
  (0, bun_test_1.it)("should handle pure file rename (no content changes)", () => {
    ...
    const diff = (0, child_process_1.execSync)("git diff --cached -M", {
      cwd: testRepoPath,
      encoding: "utf-8",
    });
    const fileDiffs = (0, diffParser_1.parseDiff)(diff);
  ...
  (0, bun_test_1.it)("should handle file rename with content changes", () => {
    ...
    (0, fs_2.writeFileSync)(
      (0, path_1.join)(testRepoPath, "large-file.js"),
      `// Header comment
function hello() {
  console.log("Hello");
}
...
`
    ...
    (0, fs_2.writeFileSync)(
      (0, path_1.join)(testRepoPath, "renamed-file.js"),
      `// Header comment
function hello() {
...
`
  ...
  (0, bun_test_1.it)("should handle renamed directory with files", () => {
    ...
    (0, fs_2.writeFileSync)(
      (0, path_1.join)(testRepoPath, "old-dir", "nested1.txt"),
      "Nested file 1\n"
    );
    (0, fs_2.writeFileSync)(
      (0, path_1.join)(testRepoPath, "old-dir", "nested2.txt"),
      "Nested file 2\n"
    );
    (0, child_process_1.execSync)("git add . && git commit -m 'Add nested files'", {
      cwd: testRepoPath,
    });
  ...
  (0, bun_test_1.it)("should show unified diff when includeUncommitted is true", () => {
    ...
    (0, fs_2.writeFileSync)(
      (0, path_1.join)(testRepoPath, "test-file.txt"),
      "Line 1\nLine 2\nLine 3\n"
    );
    (0, child_process_1.execSync)("git add test-file.txt && git commit -m 'Add test file'", {
      cwd: testRepoPath,
    });
    (0, fs_2.writeFileSync)(
      (0, path_1.join)(testRepoPath, "test-file.txt"),
    ...
    const diffOutput = (0, child_process_1.execSync)(gitCommand, {
      cwd: testRepoPath,
      encoding: "utf-8",
    });
    const fileDiffs = (0, diffParser_1.parseDiff)(diffOutput);
    ...
    (0, bun_test_1.expect)(
      allContent.includes("Line 3 modified") || allContent.includes("Line 4")
    ).toBe(true);
  ...
  (0, bun_test_1.it)("should exclude uncommitted changes when includeUncommitted is false", () => {
    ...
    // Commit a change
    (0, fs_2.writeFileSync)(
      (0, path_1.join)(testRepoPath, "committed-file.txt"),
      "Line 1\nLine 2\n"
    );
    (0, child_process_1.execSync)(
      "git add committed-file.txt && git commit -m 'Add committed file'",
      {
        cwd: testRepoPath,
      }
    );
    ...
    (0, bun_test_1.expect)(allContent.includes("Line 1") || allContent.includes("Line 2")).toBe(
      true
    );
    (0, child_process_1.execSync)("git reset --hard HEAD && git checkout -", { cwd: testRepoPath });
  });
  (0, bun_test_1.it)("should handle staged + uncommitted when diffBase is --staged", () => {
    ...
    (0, child_process_1.execSync)("git reset --hard HEAD", { cwd: testRepoPath });
    (0, fs_2.writeFileSync)(
      (0, path_1.join)(testRepoPath, "staged-test.txt"),
      "Line 1\nLine 2\nLine 3\n"
    );
  ...
  (0, bun_test_1.it)("should not show inverse deltas when branch is behind base ref", () => {
    ...
    (0, child_process_1.execSync)("git add main-file.txt && git commit -m 'Initial on main'", {
      cwd: testRepoPath,
    });
    ...
    (0, fs_2.writeFileSync)(
      (0, path_1.join)(testRepoPath, "feature-file.txt"),
      "Feature content\n"
    );
    ...
    (0, fs_2.writeFileSync)(
      (0, path_1.join)(testRepoPath, "main-file.txt"),
      "Initial content\nCommit Y\n"
    );
    ...
    const gitCommandCommittedOnly = (0, diffParser_1.buildGitDiffCommand)(
      "test-main",
      false,
      "",
      "diff"
