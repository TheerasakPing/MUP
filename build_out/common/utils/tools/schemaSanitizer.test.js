...
const schemaSanitizer_1 = require("./schemaSanitizer");
// Test helper to access tool parameters
// eslint-disable-next-line @typescript-eslint/no-explicit-any
function getParams(tool) {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
...
describe("schemaSanitizer", () => {
  describe("sanitizeToolSchemaForOpenAI", () => {
    it("should strip minLength from string properties", () => {
      ...
      const sanitized = (0, schemaSanitizer_1.sanitizeToolSchemaForOpenAI)(tool);
    ...
    it("should not mutate the original tool", () => {
      ...
      (0, schemaSanitizer_1.sanitizeToolSchemaForOpenAI)(tool);
    ...
    it("should sanitize MCP tools with inputSchema", () => {
      ...
      const sanitized = (0, schemaSanitizer_1.sanitizeToolSchemaForOpenAI)(mcpTool);
    ...
    it("should not mutate the original MCP tool inputSchema", () => {
      ...
      (0, schemaSanitizer_1.sanitizeToolSchemaForOpenAI)(mcpTool);
      // Original should still have minLength
  ...
  describe("sanitizeMCPToolsForOpenAI", () => {
    it("should sanitize all tools in a record", () => {
      ...
      const sanitized = (0, schemaSanitizer_1.sanitizeMCPToolsForOpenAI)(tools);
...
//# sourceMappingURL=schemaSanitizer.test.js.map
