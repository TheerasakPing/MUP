...
exports.RESULT_SCHEMAS =
  exports.WebFetchToolResultSchema =
  exports.FileEditReplaceStringToolResultSchema =
  exports.FileEditInsertToolResultSchema =
  exports.AgentSkillReadFileToolResultSchema =
  exports.AgentSkillReadToolResultSchema =
  exports.FileReadToolResultSchema =
  exports.MuxGlobalAgentsWriteToolResultSchema =
  exports.MuxGlobalAgentsReadToolResultSchema =
  exports.BashBackgroundTerminateResultSchema =
  exports.BashBackgroundListResultSchema =
  exports.BashOutputToolResultSchema =
  exports.BashToolResultSchema =
  exports.TOOL_DEFINITIONS =
  exports.System1KeepRangeSchema =
  exports.AgentReportToolResultSchema =
  exports.AgentReportToolArgsSchema =
  exports.TaskListToolResultSchema =
  exports.TaskListToolTaskSchema =
  exports.TaskListToolArgsSchema =
  exports.TaskTerminateToolResultSchema =
  ...
  exports.TaskTerminateToolArgsSchema =
  exports.TaskApplyGitPatchToolResultSchema =
  exports.TaskApplyGitPatchToolArgsSchema =
  exports.TaskAwaitToolResultSchema =
  ...
  exports.SubagentGitPatchArtifactSchema =
  exports.SubagentGitPatchArtifactStatusSchema =
  exports.TaskAwaitToolArgsSchema =
  exports.TaskToolResultSchema =
  exports.TaskToolCompletedResultSchema =
  exports.TaskToolQueuedResultSchema =
  exports.TaskToolArgsSchema =
  exports.AskUserQuestionToolResultSchema =
  exports.AskUserQuestionToolArgsSchema =
  exports.AskUserQuestionQuestionSchema =
  exports.AskUserQuestionOptionSchema =
    void 0;
...
exports.AskUserQuestionQuestionSchema = zod_1.z
  .object({
    ...
    header: zod_1.z
      ...
      .min(1)
      .max(32)
      .describe("Short label shown in the UI (keep it concise)"),
...
// -----------------------------------------------------------------------------
const SubagentTypeSchema = zod_1.z.preprocess(
  (value) => (typeof value === "string" ? value.trim().toLowerCase() : value),
  schemas_1.AgentIdSchema
);
const TaskAgentIdSchema = zod_1.z.preprocess(
  (value) => (typeof value === "string" ? value.trim().toLowerCase() : value),
  schemas_1.AgentIdSchema
);
...
exports.TaskAwaitToolResultSchema = zod_1.z
  .object({
    results: zod_1.z.array(
      zod_1.z.discriminatedUnion("status", [
        exports.TaskAwaitToolCompletedResultSchema,
        exports.TaskAwaitToolActiveResultSchema,
        exports.TaskAwaitToolNotFoundResultSchema,
        exports.TaskAwaitToolInvalidScopeResultSchema,
...
exports.TaskApplyGitPatchToolArgsSchema = zod_1.z
  .object({
    task_id: zod_1.z
      .string()
      .min(1)
      .describe("Child task ID whose patch artifact should be applied"),
    dry_run: zod_1.z
      .boolean()
      .nullish()
      .describe(
    ...
    three_way: zod_1.z
      ...
      .nullish()
      .default(true)
      .describe("When true, run git am with --3way"),
    force: zod_1.z
      .boolean()
      .nullish()
      .describe(
...
exports.TOOL_DEFINITIONS = {
  ...
  agent_skill_read: {
    ...
    schema: zod_1.z
      .object({
        name: schemas_1.SkillNameSchema.describe(
          "Skill name (directory name under the skills root)"
        ),
      })
      .strict(),
  },
    ...
    schema: zod_1.z
      .object({
        ...
        message: zod_1.z
          .string()
          .describe(
            `A brief description of the current activity (auto-truncated to ${toolLimits_1.STATUS_MESSAGE_MAX_LENGTH} chars with ellipsis if needed)`
          ),
        url: zod_1.z
          .string()
          .url()
...
function getToolSchemas() {
  return Object.fromEntries(
    Object.entries(exports.TOOL_DEFINITIONS).map(([name, def]) => [
      name,
      {
        name,
