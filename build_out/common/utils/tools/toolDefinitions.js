...
exports.RESULT_SCHEMAS = exports.WebFetchToolResultSchema = exports.FileEditReplaceStringToolResultSchema = exports.FileEditInsertToolResultSchema = exports.AgentSkillReadFileToolResultSchema = exports.AgentSkillReadToolResultSchema = exports.FileReadToolResultSchema = exports.MuxGlobalAgentsWriteToolResultSchema = exports.MuxGlobalAgentsReadToolResultSchema = exports.BashBackgroundTerminateResultSchema = exports.BashBackgroundListResultSchema = exports.BashOutputToolResultSchema = exports.BashToolResultSchema = exports.TOOL_DEFINITIONS = exports.System1KeepRangeSchema = exports.AgentReportToolResultSchema = exports.AgentReportToolArgsSchema = exports.TaskListToolResultSchema = exports.TaskListToolTaskSchema = exports.TaskListToolArgsSchema = exports.TaskTerminateToolResultSchema = exports.TaskTerminateToolErrorResultSchema = exports.TaskTerminateToolInvalidScopeResultSchema = exports.TaskTerminateToolNotFoundResultSchema = exports.TaskTerminateToolTerminatedResultSchema = exports.TaskTerminateToolArgsSchema = exports.TaskApplyGitPatchToolResultSchema = exports.TaskApplyGitPatchToolArgsSchema = exports.TaskAwaitToolResultSchema = exports.TaskAwaitToolErrorResultSchema = exports.TaskAwaitToolInvalidScopeResultSchema = exports.TaskAwaitToolNotFoundResultSchema = exports.TaskAwaitToolActiveResultSchema = exports.TaskAwaitToolCompletedResultSchema = exports.SubagentGitPatchArtifactSchema = exports.SubagentGitPatchArtifactStatusSchema = exports.TaskAwaitToolArgsSchema = exports.TaskToolResultSchema = exports.TaskToolCompletedResultSchema = exports.TaskToolQueuedResultSchema = exports.TaskToolArgsSchema = exports.AskUserQuestionToolResultSchema = exports.AskUserQuestionToolArgsSchema = exports.AskUserQuestionQuestionSchema = exports.AskUserQuestionOptionSchema = void 0;
...
exports.AskUserQuestionToolArgsSchema = zod_1.z
    ...
    answers: zod_1.z.record(zod_1.z.string(), zod_1.z.string()).nullish(),
})
    .strict()
...
exports.SubagentGitPatchArtifactStatusSchema = zod_1.z.enum([
    "pending",
    "ready",
    "failed",
    "skipped",
]);
exports.SubagentGitPatchArtifactSchema = zod_1.z
    .object({
    childTaskId: zod_1.z.string(),
    parentWorkspaceId: zod_1.z.string(),
    createdAtMs: zod_1.z.number().int().nonnegative(),
    updatedAtMs: zod_1.z.number().int().nonnegative().optional(),
    status: exports.SubagentGitPatchArtifactStatusSchema,
    baseCommitSha: zod_1.z.string().optional(),
    headCommitSha: zod_1.z.string().optional(),
    commitCount: zod_1.z.number().int().nonnegative().optional(),
    mboxPath: zod_1.z.string().optional(),
    error: zod_1.z.string().optional(),
    appliedAtMs: zod_1.z.number().int().nonnegative().optional(),
})
    .strict();
const TaskAwaitToolArtifactsSchema = zod_1.z
    .object({
    gitFormatPatch: exports.SubagentGitPatchArtifactSchema.optional(),
})
    .strict();
...
// -----------------------------------------------------------------------------
exports.TaskApplyGitPatchToolArgsSchema = zod_1.z
    .object({
    task_id: zod_1.z.string().min(1).describe("Child task ID whose patch artifact should be applied"),
    dry_run: zod_1.z
        .boolean()
        .nullish()
        .describe("When true, attempt to apply the patch in a temporary git worktree and then discard it (does not modify the current workspace)."),
    three_way: zod_1.z.boolean().nullish().default(true).describe("When true, run git am with --3way"),
    force: zod_1.z
        .boolean()
        .nullish()
        .describe("When true, allow apply even if the patch was previously applied (and skip clean-tree checks)."),
})
    .strict();
const TaskApplyGitPatchAppliedCommitSchema = zod_1.z
    .object({
    ...
    sha: zod_1.z.string().min(1).optional(),
})
    .strict();
exports.TaskApplyGitPatchToolResultSchema = zod_1.z.union([
    zod_1.z
        .object({
        success: zod_1.z.literal(true),
        taskId: zod_1.z.string(),
        appliedCommits: zod_1.z.array(TaskApplyGitPatchAppliedCommitSchema),
        headCommitSha: zod_1.z.string().optional(),
    ...
    zod_1.z
        ...
        error: zod_1.z.string(),
        dryRun: zod_1.z.boolean().optional(),
        conflictPaths: zod_1.z.array(zod_1.z.string()).optional(),
        failedPatchSubject: zod_1.z.string().optional(),
        note: zod_1.z.string().optional(),
    })
        .strict(),
]);
...
const TaskListThinkingLevelSchema = zod_1.z.enum(["off", "low", "medium", "high", "xhigh", "max"]);
 ...
 */
exports.System1KeepRangeSchema = zod_1.z.object({
    ...
    reason: zod_1.z.string().nullish().describe("Optional short reason for keeping this range"),
});
/**
...
exports.TOOL_DEFINITIONS = {
    ...
    mux_global_agents_read: {
        description: "Read the global AGENTS.md file (mux-wide agent instructions) from the mux home directory.",
        schema: zod_1.z.object({}).strict(),
    },
    mux_global_agents_write: {
        description: "Write the global AGENTS.md file (mux-wide agent instructions) in the mux home directory. " +
    ...
    file_edit_insert: {
        ...
        schema: zod_1.z
            .object({
            file_path: FILE_EDIT_FILE_PATH,
            insert_before: zod_1.z
                .string()
                .min(1)
                .nullish()
                .describe("Anchor text to insert before. Content will be placed immediately before this substring."),
            insert_after: zod_1.z
                .string()
                .min(1)
                .nullish()
                .describe("Anchor text to insert after. Content will be placed immediately after this substring."),
    ...
    task_apply_git_patch: {
        description: "Apply a completed sub-agent task's git-format-patch artifact to the current workspace using `git am`. " +
            "This is an explicit integration step: mux will not auto-apply patches.",
        schema: exports.TaskApplyGitPatchToolArgsSchema,
    },
    task_await: {
    ...
    system1_keep_ranges: {
        description: "Internal tool used by mux to record which line ranges to keep when filtering large bash output.",
        schema: zod_1.z
            .object({
            keep_ranges: zod_1.z
                .array(exports.System1KeepRangeSchema
 ...
 */
exports.MuxGlobalAgentsReadToolResultSchema = zod_1.z.union([
    zod_1.z.object({
        success: zod_1.z.literal(true),
 ...
 */
exports.MuxGlobalAgentsWriteToolResultSchema = zod_1.z.union([
    zod_1.z
        .object({
        success: zod_1.z.literal(true),
        diff: zod_1.z.string(),
...
exports.RESULT_SCHEMAS = {
    ...
    task_apply_git_patch: exports.TaskApplyGitPatchToolResultSchema,
