...
(0, bun_test_1.describe)("bashDisplayName", () => {
  (0, bun_test_1.test)("getDefaultBashDisplayName derives from first non-empty line", () => {
    (0, bun_test_1.expect)(
      (0, bashDisplayName_1.getDefaultBashDisplayName)("\n\n  echo   hi\n")
    ).toBe("echo hi");
  });
  (0, bun_test_1.test)(
    "getDefaultBashDisplayName falls back to 'bash' when script is empty",
    () => {
  ...
  (0, bun_test_1.test)("resolveBashDisplayName strips trailing dots/spaces", () => {
    (0, bun_test_1.expect)((0, bashDisplayName_1.resolveBashDisplayName)("echo hi", "name. ")).toBe(
      "name"
    );
  });
  (0, bun_test_1.test)(
    "resolveBashDisplayName falls back to script-derived name when display_name is empty",
    () => {
      (0, bun_test_1.expect)((0, bashDisplayName_1.resolveBashDisplayName)("echo hi", "   ")).toBe(
        "echo hi"
      );
    }
  );
