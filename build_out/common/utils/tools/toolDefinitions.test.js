...
describe("TOOL_DEFINITIONS", () => {
  ...
  it("asks for clarification via ask_user_question (instead of emitting open questions)", () => {
    expect(toolDefinitions_1.TOOL_DEFINITIONS.ask_user_question.description).toContain(
  ...
  it("discourages repeating plan contents or plan file location after propose_plan", () => {
    expect(toolDefinitions_1.TOOL_DEFINITIONS.propose_plan.description).toContain(
      "do not paste the plan contents"
    );
