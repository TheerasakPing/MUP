...
(0, bun_test_1.describe)("mcpToolName", () => {
  (0, bun_test_1.describe)("normalizeMcpToolNamePart", () => {
    (0, bun_test_1.test)("lowercases and replaces spaces with underscores", () => {
      (0, bun_test_1.expect)((0, mcpToolName_1.normalizeMcpToolNamePart)("Chrome DevTools")).toBe(
        "chrome_devtools"
      );
    });
    (0, bun_test_1.test)("treats non-alphanumeric characters as separators", () => {
      (0, bun_test_1.expect)(
        (0, mcpToolName_1.normalizeMcpToolNamePart)("chrome-devtools/mcp")
      ).toBe("chrome_devtools_mcp");
    });
  ...
  (0, bun_test_1.describe)("buildMcpToolName", () => {
    ...
    (0, bun_test_1.test)("adds a stable suffix on collision", () => {
      const usedNames = new Set();
      const first = (0, mcpToolName_1.buildMcpToolName)({
        serverName: "foo bar",
        toolName: "baz",
        usedNames,
      });
      ...
      const second = (0, mcpToolName_1.buildMcpToolName)({
        serverName: "foo_bar",
        toolName: "baz",
        usedNames,
      });
