...
(0, bun_test_1.describe)("getModelCapabilities", () => {
  ...
  (0, bun_test_1.it)(
    "merges models.json + modelsExtra so overrides don't wipe capabilities",
    () => {
  ...
  (0, bun_test_1.it)("returns null for unknown models", () => {
    (0, bun_test_1.expect)(
      (0, modelCapabilities_1.getModelCapabilities)("anthropic:this-model-does-not-exist")
    ).toBeNull();
  });
});
(0, bun_test_1.describe)("getSupportedInputMediaTypes", () => {
  (0, bun_test_1.it)("includes pdf when model supports_pdf_input is true", () => {
    const supported = (0, modelCapabilities_1.getSupportedInputMediaTypes)(
