...
(0, bun_test_1.describe)("normalizeGatewayModel", () => {
    (0, bun_test_1.it)("should convert mux-gateway:provider/model to provider:model", () => {
        (0, bun_test_1.expect)((0, models_1.normalizeGatewayModel)("mux-gateway:anthropic/claude-opus-4-5")).toBe("anthropic:claude-opus-4-5");
        (0, bun_test_1.expect)((0, models_1.normalizeGatewayModel)("mux-gateway:openai/gpt-4o")).toBe("openai:gpt-4o");
        (0, bun_test_1.expect)((0, models_1.normalizeGatewayModel)("mux-gateway:google/gemini-2.5-pro")).toBe("google:gemini-2.5-pro");
    });
    ...
    (0, bun_test_1.it)("should return malformed gateway strings unchanged", () => {
        ...
        (0, bun_test_1.expect)((0, models_1.normalizeGatewayModel)("mux-gateway:no-slash-here")).toBe("mux-gateway:no-slash-here");
    });
});
(0, bun_test_1.describe)("getModelName", () => {
    ...
    (0, bun_test_1.it)("should handle mux-gateway format", () => {
        (0, bun_test_1.expect)((0, models_1.getModelName)("mux-gateway:anthropic/claude-opus-4-5")).toBe("claude-opus-4-5");
...
(0, bun_test_1.describe)("supports1MContext", () => {
    ...
    (0, bun_test_1.it)("should return true for mux-gateway Sonnet 4 models", () => {
        (0, bun_test_1.expect)((0, models_1.supports1MContext)("mux-gateway:anthropic/claude-sonnet-4-5")).toBe(true);
        (0, bun_test_1.expect)((0, models_1.supports1MContext)("mux-gateway:anthropic/claude-sonnet-4-5-20250514")).toBe(true);
    });
    (0, bun_test_1.it)("should return false for non-Anthropic models", () => {
        ...
        (0, bun_test_1.expect)((0, models_1.supports1MContext)("mux-gateway:openai/gpt-4o")).toBe(false);
    });
    (0, bun_test_1.it)("should return true for Opus 4.6 models", () => {
        ...
        (0, bun_test_1.expect)((0, models_1.supports1MContext)("mux-gateway:anthropic/claude-opus-4-6")).toBe(true);
    });
    (0, bun_test_1.it)("should return false for Anthropic non-Sonnet-4 / non-Opus-4.6 models", () => {
        ...
        (0, bun_test_1.expect)((0, models_1.supports1MContext)("mux-gateway:anthropic/claude-opus-4-5")).toBe(false);
    });
    (0, bun_test_1.it)("should return true for Opus 4.6 models", () => {
        (0, bun_test_1.expect)((0, models_1.supports1MContext)("anthropic:claude-opus-4-6")).toBe(true);
        (0, bun_test_1.expect)((0, models_1.supports1MContext)("anthropic:claude-opus-4-6-20260201")).toBe(true);
        (0, bun_test_1.expect)((0, models_1.supports1MContext)("mux-gateway:anthropic/claude-opus-4-6")).toBe(true);
    });
});
(0, bun_test_1.describe)("isValidModelFormat", () => {
    (0, bun_test_1.it)("returns true for valid model formats", () => {
        ...
        (0, bun_test_1.expect)((0, models_1.isValidModelFormat)("mux-gateway:anthropic/claude-opus-4-5")).toBe(true);
...
(0, bun_test_1.describe)("resolveModelAlias", () => {
    (0, bun_test_1.it)("resolves known aliases to full model strings", () => {
        ...
        (0, bun_test_1.expect)((0, models_1.resolveModelAlias)("opus")).toBe("anthropic:claude-opus-4-6");
