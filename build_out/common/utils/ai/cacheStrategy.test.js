...
(0, bun_test_1.describe)("cacheStrategy", () => {
  (0, bun_test_1.describe)("supportsAnthropicCache", () => {
    (0, bun_test_1.it)("should return true for direct Anthropic models", () => {
      (0, bun_test_1.expect)(
        (0, cacheStrategy_1.supportsAnthropicCache)("anthropic:claude-3-5-sonnet-20241022")
      ).toBe(true);
      (0, bun_test_1.expect)(
        (0, cacheStrategy_1.supportsAnthropicCache)("anthropic:claude-3-5-haiku-20241022")
      ).toBe(true);
    });
    (0, bun_test_1.it)("should return true for gateway providers routing to Anthropic", () => {
      (0, bun_test_1.expect)(
        (0, cacheStrategy_1.supportsAnthropicCache)("mux-gateway:anthropic/claude-opus-4-5")
      ).toBe(true);
      (0, bun_test_1.expect)(
        (0, cacheStrategy_1.supportsAnthropicCache)(
          "mux-gateway:anthropic/claude-sonnet-4-5-20250514"
        )
      ).toBe(true);
      (0, bun_test_1.expect)(
        (0, cacheStrategy_1.supportsAnthropicCache)("openrouter:anthropic/claude-3.5-sonnet")
      ).toBe(true);
    });
    (0, bun_test_1.it)("should return false for non-Anthropic models", () => {
      (0, bun_test_1.expect)((0, cacheStrategy_1.supportsAnthropicCache)("openai:gpt-4")).toBe(
        false
      );
      (0, bun_test_1.expect)((0, cacheStrategy_1.supportsAnthropicCache)("google:gemini-2.0")).toBe(
        false
      );
      (0, bun_test_1.expect)(
        (0, cacheStrategy_1.supportsAnthropicCache)("openrouter:meta-llama/llama-3.1")
      ).toBe(false);
      (0, bun_test_1.expect)(
        (0, cacheStrategy_1.supportsAnthropicCache)("mux-gateway:openai/gpt-5.2")
      ).toBe(false);
    });
  });
  (0, bun_test_1.describe)("applyCacheControl", () => {
    ...
    (0, bun_test_1.it)("should add cache control to single message for Anthropic models", () => {
      ...
      const result = (0, cacheStrategy_1.applyCacheControl)(
        messages,
  ...
  (0, bun_test_1.describe)("createCachedSystemMessage", () => {
    (0, bun_test_1.describe)("integration with streamText parameters", () => {
      (0, bun_test_1.it)("should handle empty system message correctly", () => {
        ...
        const cachedMessage = (0, cacheStrategy_1.createCachedSystemMessage)(
          systemContent,
          "anthropic:claude-3-5-sonnet"
        );
    ...
    (0, bun_test_1.it)("should return null for non-Anthropic models", () => {
      const result = (0, cacheStrategy_1.createCachedSystemMessage)(
  ...
  (0, bun_test_1.describe)("applyCacheControlToTools", () => {
    ...
    (0, bun_test_1.it)("should return empty object for empty tools", () => {
      const result = (0, cacheStrategy_1.applyCacheControlToTools)(
        {},
        "anthropic:claude-3-5-sonnet"
      );
      (0, bun_test_1.expect)(result).toEqual({});
    ...
    (0, bun_test_1.it)(
      "should add cache control only to the last tool for Anthropic models",
      () => {
        const result = (0, cacheStrategy_1.applyCacheControlToTools)(
          mockTools,
          "anthropic:claude-3-5-sonnet"
