...
(0, bun_test_1.describe)("muxMd", () => {
  (0, bun_test_1.describe)("getMuxMdBaseUrl", () => {
    ...
    (0, bun_test_1.it)("should normalize and accept a MUX_MD_URL_OVERRIDE host", () => {
      ...
      try {
        ...
        (0, bun_test_1.expect)(
          (0, muxMd_1.isMuxMdUrl)("https://mux-md-staging.test/abc123#key456")
        ).toBe(true);
        ...
        (0, bun_test_1.expect)(
          (0, muxMd_1.isMuxMdUrl)("https://not-mux-md.test/abc123#key456")
        ).toBe(false);
      } finally {
        if (originalOverride === undefined) {
          delete process.env.MUX_MD_URL_OVERRIDE;
    ...
    (0, bun_test_1.it)(
      "should use globalThis.__MUX_MD_URL_OVERRIDE__ in browser mode without preload",
      () => {
        const originalOverride = process.env.MUX_MD_URL_OVERRIDE;
        ...
        globalWithWindow.window = {};
        try {
          (0, bun_test_1.expect)((0, muxMd_1.getMuxMdBaseUrl)()).toBe(
            "https://mux-md-staging.test"
          );
        } finally {
          if (originalOverride === undefined) {
            delete process.env.MUX_MD_URL_OVERRIDE;
  ...
  (0, bun_test_1.describe)("isMuxMdUrl", () => {
    (0, bun_test_1.it)("should detect valid mux.md URLs", () => {
      (0, bun_test_1.expect)((0, muxMd_1.isMuxMdUrl)("https://mux.md/abc123#key456")).toBe(true);
      (0, bun_test_1.expect)((0, muxMd_1.isMuxMdUrl)("https://mux.md/RQJe3#Fbbhosspt9q9Ig")).toBe(
        true
      );
    });
  ...
  itIntegration("should upload and download content correctly", async () => {
    ...
    try {
      ...
      const downloadResult = await (0, muxMd_1.downloadFromMuxMd)(
        uploadResult.id,
        uploadResult.key
      );
