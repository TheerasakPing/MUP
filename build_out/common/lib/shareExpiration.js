...
exports.EXPIRATION_OPTIONS = void 0;
exports.expirationToMs = expirationToMs;
exports.timestampToExpiration = timestampToExpiration;
exports.formatExpiration = formatExpiration;
/** Expiration options with human-readable labels */
exports.EXPIRATION_OPTIONS = [
...
function expirationToMs(value) {
    const opt = exports.EXPIRATION_OPTIONS.find((o) => o.value === value);
    return opt?.ms ?? null;
}
/** Convert timestamp to expiration value (best fit) */
function timestampToExpiration(expiresAt) {
    if (!expiresAt)
        return "never";
    ...
    for (const opt of exports.EXPIRATION_OPTIONS) {
