...
exports.OPENROUTER_REASONING_EFFORT = exports.GEMINI_THINKING_BUDGETS = exports.OPENAI_REASONING_EFFORT = exports.DEFAULT_THINKING_LEVEL = exports.THINKING_LEVEL_OFF = exports.ANTHROPIC_THINKING_BUDGETS = exports.THINKING_LEVEL_SYNONYMS = exports.MAX_THINKING_INDEX = exports.THINKING_DISPLAY_LABELS = exports.THINKING_LEVELS = void 0;
...
function parseThinkingInput(value) {
    ...
    if (!Number.isNaN(num) && String(num) === normalized && num >= 0 && num <= exports.MAX_THINKING_INDEX) {
        return num;
    }
    return undefined;
}
