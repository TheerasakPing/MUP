...
(0, bun_test_1.describe)("buildContinueMessage", () => {
    ...
    (0, bun_test_1.test)("preserves muxMetadata when provided", () => {
        const muxMetadata = {
            type: "agent-skill",
        ...
        (0, bun_test_1.expect)(result?.muxMetadata).toEqual(muxMetadata);
    });
...
(0, bun_test_1.describe)("rebuildContinueMessage", () => {
    ...
    (0, bun_test_1.test)("preserves muxMetadata from persisted data", () => {
        const muxMetadata = {
            type: "agent-skill",
            rawCommand: "/test-skill hello",
            skillName: "test-skill",
        ...
        const result = (0, message_1.rebuildContinueMessage)({ text: "continue", muxMetadata }, { model: "m", agentId: "exec" });
        (0, bun_test_1.expect)(result?.muxMetadata).toEqual(muxMetadata);
    });
