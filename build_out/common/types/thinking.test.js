...
(0, bun_test_1.describe)("getThinkingDisplayLabel", () => {
    (0, bun_test_1.test)("returns MAX for xhigh/max on Anthropic models", () => {
        (0, bun_test_1.expect)((0, thinking_1.getThinkingDisplayLabel)("xhigh", "anthropic:claude-opus-4-6")).toBe("MAX");
        (0, bun_test_1.expect)((0, thinking_1.getThinkingDisplayLabel)("max", "anthropic:claude-opus-4-6")).toBe("MAX");
        (0, bun_test_1.expect)((0, thinking_1.getThinkingDisplayLabel)("xhigh", "mux-gateway:anthropic/claude-opus-4-6")).toBe("MAX");
        (0, bun_test_1.expect)((0, thinking_1.getThinkingDisplayLabel)("xhigh", "anthropic:claude-opus-4-5")).toBe("MAX");
    });
    (0, bun_test_1.test)("returns XHIGH for xhigh/max on OpenAI models", () => {
        (0, bun_test_1.expect)((0, thinking_1.getThinkingDisplayLabel)("xhigh", "openai:gpt-5.2")).toBe("XHIGH");
        (0, bun_test_1.expect)((0, thinking_1.getThinkingDisplayLabel)("max", "openai:gpt-5.2")).toBe("XHIGH");
        (0, bun_test_1.expect)((0, thinking_1.getThinkingDisplayLabel)("xhigh", "mux-gateway:openai/gpt-5.2")).toBe("XHIGH");
        (0, bun_test_1.expect)((0, thinking_1.getThinkingDisplayLabel)("max", "mux-gateway:openai/gpt-5.2")).toBe("XHIGH");
    });
    ...
    (0, bun_test_1.test)("returns standard labels for non-xhigh levels regardless of model", () => {
        (0, bun_test_1.expect)((0, thinking_1.getThinkingDisplayLabel)("off", "anthropic:claude-opus-4-6")).toBe("OFF");
        (0, bun_test_1.expect)((0, thinking_1.getThinkingDisplayLabel)("low", "anthropic:claude-opus-4-6")).toBe("LOW");
        (0, bun_test_1.expect)((0, thinking_1.getThinkingDisplayLabel)("medium", "anthropic:claude-opus-4-6")).toBe("MED");
        (0, bun_test_1.expect)((0, thinking_1.getThinkingDisplayLabel)("high", "anthropic:claude-opus-4-6")).toBe("HIGH");
    });
});
(0, bun_test_1.describe)("getThinkingOptionLabel", () => {
    (0, bun_test_1.test)("renders max for xhigh on Anthropic models", () => {
        (0, bun_test_1.expect)((0, thinking_1.getThinkingOptionLabel)("xhigh", "anthropic:claude-opus-4-6")).toBe("max");
    });
    (0, bun_test_1.test)("renders xhigh for xhigh/max on OpenAI models", () => {
        (0, bun_test_1.expect)((0, thinking_1.getThinkingOptionLabel)("xhigh", "openai:gpt-5.2")).toBe("xhigh");
        (0, bun_test_1.expect)((0, thinking_1.getThinkingOptionLabel)("max", "openai:gpt-5.2")).toBe("xhigh");
    });
    (0, bun_test_1.test)("preserves non-xhigh labels", () => {
        (0, bun_test_1.expect)((0, thinking_1.getThinkingOptionLabel)("medium", "anthropic:claude-opus-4-6")).toBe("medium");
    });
});
...
(0, bun_test_1.describe)("parseThinkingInput", () => {
    ...
    bun_test_1.test.each(["-1", "10", "99", "foo", "mediun", "1.5", "", "  "])("returns undefined for invalid input %j", (input) => {
