...
exports.roundToBase2 = roundToBase2;
exports.getFrontendPlatformInfo = getFrontendPlatformInfo;
exports.getRuntimeTypeForTelemetry = getRuntimeTypeForTelemetry;
/**
 ...
 */
function getFrontendPlatformInfo() {
 ...
 */
function getRuntimeTypeForTelemetry(runtimeConfig) {
  if (!runtimeConfig) {
