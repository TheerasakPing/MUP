import { _ as V, l as $, e as lt } from "./mermaid-LQXJBOYN-DZHv-CM8.js";
import { c as tt } from "./cytoscape.esm-BnkdMOzK.js";
import { g as gt } from "./TerminalRouterContext-CeKE7fio.js";
          ...
          return (function (N) {
            ...
            function (N, I, L) {
              ...
              ((n.prototype.getEdges = function () {
                ...
                (n.prototype.transform = function (r) {
                  ...
                  h > i.WORLD_BOUNDARY
                    ? (h = i.WORLD_BOUNDARY)
                    : h < -i.WORLD_BOUNDARY && (h = -i.WORLD_BOUNDARY);
                  var a = this.rect.y;
                  a > i.WORLD_BOUNDARY
                    ? (a = i.WORLD_BOUNDARY)
                    : a < -i.WORLD_BOUNDARY && (a = -i.WORLD_BOUNDARY);
                  var p = new g(h, a),
              ...
              ((h.prototype.getNodes = function () {
                ...
                (h.prototype.remove = function (p) {
                  ...
                  if (p instanceof l) {
                    ...
                    for (var D = v.edges.slice(), u, T = D.length, y = 0; y < T; y++)
                      ((u = D[y]),
                        u.isInterGraph ? this.graphManager.remove(u) : u.source.owner.remove(u));
                    ...
                    (u.source.edges.splice(s, 1),
                      u.target != u.source && u.target.edges.splice(f, 1));
                ...
                (h.prototype.updateBounds = function (p) {
                  ...
                  (v == e.MAX_VALUE &&
                    ...
                    E[0].getParent().paddingLeft != null
              ...
              ((t.prototype.addRoot = function () {
                ...
                (t.prototype.remove = function (i) {
                  if (i instanceof o) {
                    ...
                    if (
                      !(l == this.rootGraph || (l.parent != null && l.parent.graphManager == this))
                    )
                ...
                (t.prototype.setRootGraph = function (i) {
                  ...
                  ((this.rootGraph = i),
                    i.parent == null && (i.parent = this.layout.newNode("Root node")));
                }),
                ...
                (t.prototype.calcLowestCommonAncestors = function () {
                  for (var i, l, g, n, d, r = this.getAllEdges(), h = r.length, a = 0; a < h; a++) {
                    ...
                    for (n = l.getOwner(); i.lca == null; ) {
                      ...
                      i.lca == null &&
                        ((i.sourceInLca = n.getParent()), (n = i.sourceInLca.getOwner()));
                    }
                    if (i.lca == null) throw "assert failed";
                  }
                }),
            ...
            function (N, I, L) {
              ...
              ((e.calcSeparationAmount = function (t, i, l, g) {
                ...
                var d = Math.abs(
                  (i.getCenterY() - t.getCenterY()) / (i.getCenterX() - t.getCenterX())
                );
                ...
                (e.getIntersection2 = function (t, i, l) {
                  ...
                  var h = t.getX(),
                    ...
                    M = !1;
                  if (g === d) {
                    if (n > r) return ((l[0] = g), (l[1] = a), (l[2] = d), (l[3] = E), !1);
                ...
                (e.getIntersection = function (t, i, l, g) {
                  ...
                  return (
                    ...
                    A === 0
                      ? null
                      : ((u = (s * E - f * c) / A), (T = (O * c - y * E) / A), new o(u, T))
                  );
                }),
              ...
              ((e.lastID = 0),
                (e.createID = function (t) {
                  return e.isPrimitive(t)
                    ? t
                    : (t.uniqueID != null || ((t.uniqueID = e.getString()), e.lastID++),
                      t.uniqueID);
                }),
            ...
            function (N, I, L) {
              ...
              ((h.RANDOM_SEED = 1),
                ...
                (h.prototype.getFlatForest = function () {
                  for (
                    var a = [], p = !0, v = this.graphManager.getRoot().getNodes(), D = !0, u = 0;
                    u < v.length;
                    u++
                  )
                ...
                (h.prototype.createDummyNodesForBendpoints = function (a) {
                  for (
                    var p = [],
                      v = a.source,
                      D = this.graphManager.calcLowestCommonAncestor(a.source, a.target),
                      u = 0;
                  ...
                  for (var p = 0; p < a.length; p++) {
                    ...
                    if (v.bendpoints.length > 0) {
                      for (var D = this.edgeToDummyNodes.get(v), u = 0; u < D.length; u++) {
                        var T = D[u],
                          y = new n(T.getCenterX(), T.getCenterY()),
            ...
            function (N, I, L) {
              ...
              function n() {
                (e.call(this),
                  (this.useSmartIdealEdgeLengthCalculation =
                    t.DEFAULT_USE_SMART_IDEAL_EDGE_LENGTH_CALCULATION),
              ...
              ((n.prototype.initParameters = function () {
                ...
                (n.prototype.calcIdealEdgeLengths = function () {
                  for (
                    var r, h, a, p, v, D, u = this.getGraphManager().getAllEdges(), T = 0;
                    T < u.length;
                    T++
                  )
                    ((r = u[T]),
                      ...
                      r.isInterGraph &&
                        ...
                        this.useSmartIdealEdgeLengthCalculation &&
                          (r.idealLength += v + D - 2 * i.SIMPLE_NODE_SIZE),
                ...
                (n.prototype.calcRepulsionForces = function () {
                  ...
                  if (this.useFRGridVariant)
                    for (
                      this.totalIterations % t.GRID_CALCULATION_CHECK_PERIOD == 1 &&
                        r &&
                        this.updateGrid(),
                        T = new Set(),
                        a = 0;
                ...
                (n.prototype.calcRepulsionForce = function (r, h) {
                  ...
                  if (a.intersects(p)) {
                    ...
                    (this.uniformLeafNodeSizes && r.getChild() == null && h.getChild() == null
                      ...
                      : (l.getIntersection(a, p, D), (u = D[2] - D[0]), (T = D[3] - D[1])),
                      Math.abs(u) < t.MIN_REPULSION_DIST && (u = g.sign(u) * t.MIN_REPULSION_DIST),
                      Math.abs(T) < t.MIN_REPULSION_DIST && (T = g.sign(T) * t.MIN_REPULSION_DIST),
                      (y = u * u + T * T),
                      (O = Math.sqrt(y)),
                  ...
                  ((h = r.getOwner()),
                    ...
                    r.getOwner() == this.graphManager.getRoot()
                      ...
                      : ((y = h.getEstimatedSize() * this.compoundGravityRangeFactor),
                        (u > y || T > y) &&
                          ((r.gravitationForceX =
                            -this.gravityConstant * v * this.compoundGravityConstant),
                          (r.gravitationForceY =
                            -this.gravityConstant * D * this.compoundGravityConstant))));
                }),
                ...
                (n.prototype.addNodeToGrid = function (r, h, a) {
                  ...
                  ((p = parseInt(Math.floor((r.getRect().x - h) / this.repulsionRange))),
                    (v = parseInt(
                      Math.floor((r.getRect().width + r.getRect().x - h) / this.repulsionRange)
                    )),
                    (D = parseInt(Math.floor((r.getRect().y - a) / this.repulsionRange))),
                    (u = parseInt(
                      Math.floor((r.getRect().height + r.getRect().y - a) / this.repulsionRange)
                    )));
                  for (var T = p; T <= v; T++)
                    for (var y = D; y <= u; y++)
                ...
                (n.prototype.updateGrid = function () {
                  var r,
                    ...
                    a = this.getAllNodes();
                  for (
                    this.grid = this.calcGrid(this.graphManager.getRoot()), r = 0;
                    r < a.length;
                    r++
                  )
                    ((h = a[r]),
                      ...
                      for (var y = r.startY - 1; y < r.finishY + 2; y++)
                        if (!(T < 0 || y < 0 || T >= u.length || y >= u[0].length)) {
                          for (var O = 0; O < u[T][y].length; O++)
                            if (
                              ((D = u[T][y][O]),
                              !(r.getOwner() != D.getOwner() || r == D) && !h.has(D) && !v.has(D))
                            ) {
                              var s =
                                  Math.abs(r.getCenterX() - D.getCenterX()) -
                                  (r.getWidth() / 2 + D.getWidth() / 2),
                                f =
                                  Math.abs(r.getCenterY() - D.getCenterY()) -
                                  (r.getHeight() / 2 + D.getHeight() / 2);
              ...
              var t = L(11),
                i = (function () {
                  function l(g, n) {
                    ...
                    var d = void 0;
                    (g instanceof t ? (d = g.size()) : (d = g.length),
              ...
              ((i.prototype.move = function () {
                ...
                ((this.displacementX =
                  ...
                  Math.abs(this.displacementX) > g.coolingFactor * g.maxNodeDisplacement &&
                    (this.displacementX =
                      g.coolingFactor * g.maxNodeDisplacement * t.sign(this.displacementX)),
                  Math.abs(this.displacementY) > g.coolingFactor * g.maxNodeDisplacement &&
                    (this.displacementY =
                      g.coolingFactor * g.maxNodeDisplacement * t.sign(this.displacementY)),
                  this.child == null
              ...
              ((y.prototype.newGraphManager = function () {
                ...
                (y.prototype.classicLayout = function () {
                  if (
                    ...
                    if (s.length > 0) this.positionNodesRadially(s);
                      ...
                      (this.reduceTrees(), this.graphManager.resetAllNodesToApplyGravitation());
                      var f = new Set(this.getAllNodes()),
                        c = this.nodesWithGravity.filter(function (E) {
                          return f.has(E);
                        });
                      (this.graphManager.setAllNodesToApplyGravitation(c),
                ...
                (y.prototype.calculateNodesToApplyGravitationTo = function () {
                  ...
                  for (A = 0; A < E; A++)
                    ((f = c[A]),
                      f.updateConnected(),
                      f.isConnected || (s = s.concat(f.getNodes())));
                  return s;
                }),
                ...
                (y.prototype.positionNodesRadially = function (s) {
                  for (
                    ...
                    R % c == 0 &&
                      ((m = 0), (A = E), R != 0 && (A += n.DEFAULT_COMPONENT_SEPERATION), (E = 0));
                    var M = s[R],
                      S = p.findCenterOfTree(M);
                    ((f.x = m),
                      (f.y = A),
                      (C = y.radialLayout(M, S, f)),
                      C.y > E && (E = Math.floor(C.y)),
                ...
                (y.prototype.groupZeroDegreeMembers = function () {
                  ...
                  for (var c = [], E = this.graphManager.getAllNodes(), A = 0; A < E.length; A++) {
                    var m = E[A],
                      C = m.getParent();
                    this.getNodeDegreeWithChildren(m) === 0 &&
                      (C.id == null || !this.getToBeTiled(C)) &&
                      c.push(m);
                  }
                ...
                (y.prototype.clearCompounds = function () {
                  ...
                  for (var c = 0; c < this.compoundOrder.length; c++)
                    ((f[this.compoundOrder[c].id] = this.compoundOrder[c]),
                      (s[this.compoundOrder[c].id] = [].concat(
                        this.compoundOrder[c].getChild().getNodes()
                      )),
                ...
                (y.prototype.insertNodeToRow = function (s, f, c, E) {
                  ...
                  var M = 0;
                  (R > s.rowHeight[c] &&
                    ((M = s.rowHeight[c]), (s.rowHeight[c] = R), (M = s.rowHeight[c] - M)),
                    (s.height += M),
                    s.rows[c].push(f));
                }),
                  ...
                  for (var s = [], f = !0, c; f; ) {
                    ...
                    if (f == !0) {
                      for (var C = [], R = 0; R < A.length; R++)
                        A[R][0].getEdges().length == 1 &&
                          (C.push(A[R]), A[R][0].getOwner().remove(A[R][0]));
                      (s.push(C),
              ...
              var p = function (u) {
                (u.nodeRepulsion != null &&
                  ...
                  u.nestingFactor != null &&
                    (i.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR = t.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR =
                      u.nestingFactor),
                  u.gravity != null &&
                  ...
                  u.gravityRange != null &&
                    (i.DEFAULT_GRAVITY_RANGE_FACTOR = t.DEFAULT_GRAVITY_RANGE_FACTOR =
                      u.gravityRange),
                  u.gravityCompound != null &&
                    (i.DEFAULT_COMPOUND_GRAVITY_STRENGTH = t.DEFAULT_COMPOUND_GRAVITY_STRENGTH =
                      u.gravityCompound),
                  u.gravityRangeCompound != null &&
                    (i.DEFAULT_COMPOUND_GRAVITY_RANGE_FACTOR =
                      t.DEFAULT_COMPOUND_GRAVITY_RANGE_FACTOR =
              ...
              ((a.prototype.run = function () {
                ...
                var M = function (w, x) {
                  ...
                  S = function Y() {
                    for (
                      var w = function () {
                          (T.fit && T.cy.fit(T.eles, T.padding),
                            D ||
                              ((D = !0),
                ...
                (a.prototype.getTopMostNodes = function (D) {
                  for (var u = {}, T = 0; T < D.length; T++) u[D[T].id()] = !0;
                    ...
                    if (
                      (s.outerWidth() != null && s.outerHeight() != null
                        ? (c = D.add(
                            new g(
                              T.graphManager,
                              new n(s.position("x") - E.w / 2, s.position("y") - E.h / 2),
                              new d(parseFloat(E.w), parseFloat(E.h))
                            )
                          ))
...
function it(G) {
  return new Promise((b) => {
    ...
    const L = { name: "cose-bilkent", quality: "proof", styleEnabled: !1, animate: !1 };
    (I.layout(L).run(),
      I.ready((o) => {
...
async function st(G, b) {
  ...
  try {
    ...
    const N = await it(G),
      ...
      L = ot(N);
    return (
      $.debug(`Layout completed: ${I.length} nodes, ${L.length} edges`),
      { nodes: I, edges: L }
    );
  } catch (N) {
...
var Lt = V(
    async (
      ...
      const v = {
          ...
          nodes: G.nodes.map((u) => {
            const T = g[u.id];
            return { ...u, width: T.width, height: T.height };
          }),
        },
      ...
      (t.debug("Positioning nodes based on layout results"),
        D.nodes.forEach((u) => {
          ...
          T?.domId &&
            ...
            (T.x = u.x),
            (T.y = u.y),
            t.debug(`Positioned node ${T.id} at center (${u.x}, ${u.y})`));
        }),
        D.edges.forEach((u) => {
          ...
          G.edges.map(async (u) => {
            ...
            if (T && y) {
              ...
              if (O) {
                ...
                const s = { ...u },
                  f = I(h, s, n, G.type, T, y, G.diagramId);
                i(s, f);
              } else {
                const s = {
                    ...u,
