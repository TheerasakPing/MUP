import {
  ...
  bx as Nr,
  by as Rr,
} from "./mermaid-LQXJBOYN-DVCVGgd1.js";
...
function Et(t) {
  return Array.isArray(t) ? Lr(t) : t instanceof RegExp ? t : typeof t == "object" ? Pr(t) : t;
}
function Lr(t) {
  let e = [];
  for (let n = 0, r = t.length; n < r; n++) e[n] = Et(t[n]);
  return e;
}
function Pr(t) {
  let e = {};
  for (let n in t) e[n] = Et(t[n]);
  return e;
}
function An(t, ...e) {
  return (
...
function En(t) {
  ...
  return e === 0 ? t : ~e === t.length - 1 ? En(t.substring(0, t.length - 1)) : t.substr(~e + 1);
}
var Ze = /\$(\d+)|\${(\d+):\/(downcase|upcase)}/g,
  ke = class {
    static hasCaptures(t) {
      return t === null ? !1 : ((Ze.lastIndex = 0), Ze.test(t));
    }
    static replaceCaptures(t, e, n) {
      return t.replace(Ze, (r, s, o, i) => {
        let a = n[parseInt(s || o, 10)];
        if (a) {
          let c = e.substring(a.start, a.end);
...
var Rn = class {
  ...
  Le = class {
    ...
    static createFromRawTheme(t, e) {
      return this.createFromParsedTheme(Mr(t), e);
    }
    static createFromParsedTheme(t, e) {
      return Br(t, e);
    }
    _cachedMatchRoot = new Rn((t) => this._root.match(t));
    getColorMap() {
    ...
    match(t) {
      ...
      const e = t.scopeName,
        r = this._cachedMatchRoot.get(e).find((s) => Tr(t.parent, s.parentScopes));
      return r ? new $n(r.fontStyle, r.foreground, r.background) : null;
    }
  },
  Je = class Ne {
    constructor(e, n) {
    ...
    static push(e, n) {
      for (const r of n) e = new Ne(e, r);
      return e;
    }
    static from(...e) {
      let n = null;
      for (let r = 0; r < e.length; r++) n = new Ne(n, e[r]);
      return n;
    }
    push(e) {
...
function Br(t, e) {
  t.sort((c, l) => {
    let u = vn(c.scope, l.scope);
    return u !== 0 || ((u = In(c.parentScopes, l.parentScopes)), u !== 0) ? u : c.index - l.index;
  });
  let n = 0,
    r = "#000000",
    s = "#ffffff";
  for (; t.length >= 1 && t[0].scope === ""; ) {
    let c = t.shift();
    (c.fontStyle !== -1 && (n = c.fontStyle),
      c.foreground !== null && (r = c.foreground),
      c.background !== null && (s = c.background));
  }
  let o = new Fr(e),
    i = new $n(n, o.getId(r), o.getId(s)),
    a = new jr(new ut(0, null, -1, 0, 0), []);
...
var Fr = class {
  ...
  jr = class ht {
    ...
    match(e) {
      ...
      return (n.sort(ht._cmpBySpecificity), n);
    }
    insert(e, n, r, s, o, i) {
      if (n === "") {
      ...
      let a = n.indexOf("."),
        c,
        l;
      a === -1 ? ((c = n), (l = "")) : ((c = n.substring(0, a)), (l = n.substring(a + 1)));
      let u;
      (this._children.hasOwnProperty(c)
        ? (u = this._children[c])
        : ((u = new ht(this._mainRule.clone(), ut.cloneArr(this._rulesWithParentScopes))),
          (this._children[c] = u)),
        u.insert(e + 1, l, r, s, o, i));
    }
    _doInsertHere(e, n, r, s, o) {
      ...
      for (let i = 0, a = this._rulesWithParentScopes.length; i < a; i++) {
        let c = this._rulesWithParentScopes[i];
        if (In(c.parentScopes, n) === 0) {
          c.acceptOverwrite(e, r, s, o);
          return;
        }
      }
      (r === -1 && (r = this._mainRule.fontStyle),
        ...
        this._rulesWithParentScopes.push(new ut(e, n, r, s, o)));
    }
  },
  ie = class L {
    ...
    static set(e, n, r, s, o, i, a) {
      let c = L.getLanguageId(e),
        l = L.getTokenType(e),
        u = L.containsBalancedBrackets(e) ? 1 : 0,
        h = L.getFontStyle(e),
        f = L.getForeground(e),
        p = L.getBackground(e);
      return (
...
function Pe(t, e) {
  ...
  for (; s !== null; ) {
    ...
    let l = i();
    if ((n.push({ matcher: l, priority: c }), s !== ",")) break;
    s = r.next();
  }
  return n;
  function o() {
...
var ge = class {
  ...
  qr = class {
    ...
    processQueue() {
      ...
      this.Q = [];
      const e = new zr();
      for (const n of t) Hr(n, this.initialScopeName, this.repo, e);
...
function Hr(t, e, n, r) {
  ...
  const o = n.lookup(e);
  t instanceof ge
    ? Re({ baseGrammar: o, selfGrammar: s }, r)
    : ft(t.ruleName, { baseGrammar: o, selfGrammar: s, repository: s.repository }, r);
  const i = n.injections(t.scopeName);
  if (i) for (const a of i) r.add(new ge(a));
}
function ft(t, e, n) {
...
function Re(t, e) {
  (t.selfGrammar.patterns &&
    ...
    Te(t.selfGrammar.patterns, { ...t, repository: t.selfGrammar.repository }, e),
...
function Te(t, e, n) {
  for (const r of t) {
    ...
    n.visitedRule.add(r);
    const s = r.repository ? An({}, e.repository, r.repository) : e.repository;
    Array.isArray(r.patterns) && Te(r.patterns, { ...e, repository: s }, n);
    const o = r.include;
    if (!o) continue;
    const i = Tn(o);
    switch (i.kind) {
      case 0:
        Re({ ...e, selfGrammar: e.baseGrammar }, n);
        break;
      case 1:
        Re(e, n);
        break;
      case 2:
        ft(i.ruleName, { ...e, repository: s }, n);
        break;
      case 3:
      case 4:
        const a =
          i.scopeName === e.selfGrammar.scopeName
            ...
            : i.scopeName === e.baseGrammar.scopeName
              ...
              : void 0;
        if (a) {
          const c = { baseGrammar: e.baseGrammar, selfGrammar: a, repository: s };
          i.kind === 4 ? ft(i.ruleName, c, n) : Re(c, n);
        } else i.kind === 4 ? n.add(new Wr(i.scopeName, i.ruleName)) : n.add(new ge(i.scopeName));
        break;
    }
  }
}
...
function Tn(t) {
  if (t === "$base") return new Vr();
  if (t === "$self") return new Xr();
  const e = t.indexOf("#");
  if (e === -1) return new Kr(t);
  if (e === 0) return new Qr(t.substring(1));
  {
...
var _e = class {
    ...
    constructor(t, e, n, r) {
      ((this.$location = t),
        (this.id = e),
        (this._name = n || null),
        (this._nameIsCapturing = ke.hasCaptures(this._name)),
        (this._contentName = r || null),
        (this._contentNameIsCapturing = ke.hasCaptures(this._contentName)));
    }
    get debugName() {
      const t = this.$location
        ? `${En(this.$location.filename)}:${this.$location.line}`
        : "unknown";
    ...
    getName(t, e) {
      return !this._nameIsCapturing || this._name === null || t === null || e === null
        ? this._name
        : ke.replaceCaptures(this._name, t, e);
    }
    getContentName(t, e) {
      return !this._contentNameIsCapturing || this._contentName === null
        ? this._contentName
        : ke.replaceCaptures(this._contentName, t, e);
    }
  },
  es = class extends _e {
  ...
  ts = class extends _e {
    ...
    _getCachedCompiledPatterns(t) {
      return (
        this._cachedCompiledPatterns ||
          ((this._cachedCompiledPatterns = new ye()),
  ...
  dt = class extends _e {
    ...
    patterns;
    _cachedCompiledPatterns;
    constructor(t, e, n, r, s, o, i, a, c, l) {
      (super(t, e, n, r),
        (this._begin = new me(s, this.id)),
        (this.beginCaptures = o),
        (this._end = new me(i || "￿", -1)),
  ...
  Ge = class extends _e {
    ...
    constructor(t, e, n, r, s, o, i, a, c) {
      (super(t, e, n, r),
        (this._begin = new me(s, this.id)),
        (this.beginCaptures = o),
        (this.whileCaptures = a),
        (this._while = new me(i, Gn)),
    ...
    _getCachedCompiledWhilePatterns(t, e) {
      return (
        this._cachedCompiledWhilePatterns ||
          ((this._cachedCompiledWhilePatterns = new ye()),
  ...
  Mn = class I {
    static createCaptureRule(e, n, r, s, o) {
      return e.registerRule((i) => new es(n, i, r, s, o));
    }
      ...
      return (
        e.id ||
          n.registerRule((s) => {
            ...
            if (typeof e.begin > "u") {
              e.repository && (r = An({}, r, e.repository));
              let o = e.patterns;
              return (
            ...
            return e.while
              ? new Ge(
                  ...
                  e.contentName,
                  e.begin,
                  I._compileCaptures(e.beginCaptures || e.captures, n, r),
                  e.while,
              ...
              : new dt(
                  ...
                  I._compileCaptures(e.beginCaptures || e.captures, n, r),
                  e.end,
                  I._compileCaptures(e.endCaptures || e.captures, n, r),
    ...
    static _compileCaptures(e, n, r) {
      ...
      if (e) {
        ...
        for (const i in e) {
          ...
          const a = parseInt(i, 10);
          let c = 0;
          (e[i].patterns && (c = I.getCompiledRuleId(e[i], n, r)),
            (s[a] = I.createCaptureRule(
              n,
    ...
    static _compilePatterns(e, n, r) {
      ...
      if (e)
        for (let o = 0, i = e.length; o < i; o++) {
          ...
          let c = -1;
          if (a.include) {
            const l = Tn(a.include);
            switch (l.kind) {
              case 0:
              case 1:
                c = I.getCompiledRuleId(r[a.include], n, r);
                break;
              case 2:
                let u = r[l.ruleName];
                u && (c = I.getCompiledRuleId(u, n, r));
                break;
              case 3:
              case 4:
                const h = l.scopeName,
                  f = l.kind === 4 ? l.ruleName : null,
                  p = n.getExternalGrammar(h, r);
                if (p)
                  if (f) {
                    let d = p.repository[f];
                    d && (c = I.getCompiledRuleId(d, n, p.repository));
                  } else c = I.getCompiledRuleId(p.repository.$self, n, p.repository);
                break;
            }
          } else c = I.getCompiledRuleId(a, n, r);
          if (c !== -1) {
            const l = n.getRule(c);
            let u = !1;
            if (
              ((l instanceof Wt || l instanceof dt || l instanceof Ge) &&
                l.hasMissingPatterns &&
                l.patterns.length === 0 &&
                (u = !0),
              u)
            )
  ...
  me = class On {
    ...
    constructor(e, n) {
      ...
      (this.hasAnchor ? (this._anchorCache = this._buildAnchorCache()) : (this._anchorCache = null),
        ...
        typeof this.source == "string"
          ? (this.hasBackReferences = Jr.test(this.source))
          : (this.hasBackReferences = !1));
    }
    clone() {
      return new On(this.source, this.ruleId);
    }
    setSource(e) {
      this.source !== e &&
    ...
    resolveBackReferences(e, n) {
      ...
      return ((Ut.lastIndex = 0), this.source.replace(Ut, (s, o) => Nn(r[parseInt(o, 10)] || "")));
    }
    _buildAnchorCache() {
      if (typeof this.source != "string")
        throw new Error("This method should only be called if the source is a string");
      ...
      for (o = 0, i = this.source.length; o < i; o++)
        ((a = this.source.charAt(o)),
          ...
          a === "\\" &&
            o + 1 < i &&
            ((c = this.source.charAt(o + 1)),
            c === "A"
              ? ((e[o + 1] = "￿"), (n[o + 1] = "￿"), (r[o + 1] = "A"), (s[o + 1] = "A"))
              : c === "G"
                ? ((e[o + 1] = "￿"), (n[o + 1] = "G"), (r[o + 1] = "￿"), (s[o + 1] = "G"))
                : ((e[o + 1] = c), (n[o + 1] = c), (r[o + 1] = c), (s[o + 1] = c)),
            o++));
...
`);
  ...
  ns = class pt {
    ...
    constructor(e, n) {
      ((this._defaultAttributes = new Ye(e, 8)),
        (this._embeddedLanguagesMatcher = new rs(Object.entries(n || {}))));
    }
    getDefaultAttributes() {
      return this._defaultAttributes;
    }
    getBasicScopeAttributes(e) {
      return e === null ? pt._NULL_SCOPE_METADATA : this._getBasicScopeAttributes.get(e);
    }
    static _NULL_SCOPE_METADATA = new Ye(0, 0);
    _getBasicScopeAttributes = new Rn((e) => {
    ...
    _toStandardTokenType(e) {
      const n = e.match(pt.STANDARD_TOKEN_TYPE_REGEXP);
      if (!n) return 8;
      switch (n[1]) {
        case "comment":
          return 1;
...
function Bn(t, e, n, r, s, o, i, a) {
  const c = e.content.length;
  let l = !1,
    u = -1;
  if (i) {
    const p = ss(t, e, n, r, s, o);
    ((s = p.stack), (r = p.linePos), (n = p.isFirstLine), (u = p.anchorPosition));
  }
  const h = Date.now();
  for (; !l; ) {
    if (a !== 0 && Date.now() - h > a) return new qt(s, !0);
    f();
  }
  return new qt(s, !1);
  function f() {
    const p = os(t, e, n, r, s, u);
    if (!p) {
      (o.produce(s, c), (l = !0));
      return;
    }
    ...
    if (y === Yr) {
      const g = s.getRule(t);
      (o.produce(s, d[0].start),
        (s = s.withContentNameScopesList(s.nameScopesList)),
        fe(t, e, n, s, o, g.endCaptures, d),
        o.produce(s, d[0].end));
      const w = s;
      if (((s = s.parent), (u = w.getAnchorPos()), !b && w.getEnterPos() === r)) {
        ((s = w), o.produce(s, c), (l = !0));
        return;
      }
    } else {
      const g = t.getRule(y);
      o.produce(s, d[0].start);
      const w = s,
        m = g.getName(e.content, d),
        _ = s.contentNameScopesList.pushAttributed(m, t);
      if (((s = s.push(y, r, u, d[0].end === c, null, _, _)), g instanceof dt)) {
        const S = g;
        (fe(t, e, n, s, o, S.beginCaptures, d), o.produce(s, d[0].end), (u = d[0].end));
        const R = S.getContentName(e.content, d),
          $ = _.pushAttributed(R, t);
        if (
          ((s = s.withContentNameScopesList($)),
          S.endHasBackReferences &&
            (s = s.withEndRule(S.getEndWithResolvedBackReferences(e.content, d))),
          !b && w.hasSameRuleAs(s))
        ) {
          ((s = s.pop()), o.produce(s, c), (l = !0));
          return;
        }
        ...
        if (
          ((s = s.withContentNameScopesList($)),
          S.whileHasBackReferences &&
            (s = s.withEndRule(S.getWhileWithResolvedBackReferences(e.content, d))),
          !b && w.hasSameRuleAs(s))
        ) {
          ((s = s.pop()), o.produce(s, c), (l = !0));
          return;
        }
      } else if ((fe(t, e, n, s, o, g.captures, d), o.produce(s, d[0].end), (s = s.pop()), !b)) {
        ((s = s.safePop()), o.produce(s, c), (l = !0));
        return;
      }
    }
...
function ss(t, e, n, r, s, o) {
  ...
  const a = [];
  for (let c = s; c; c = c.pop()) {
    const l = c.getRule(t);
    l instanceof Ge && a.push({ rule: l, stack: c });
  }
  for (let c = a.pop(); c; c = a.pop()) {
    const { ruleScanner: l, findOptions: u } = cs(c.rule, t, c.stack.endRule, n, r === i),
      h = l.findNextMatchSync(e, r, u);
    if (h) {
      if (h.ruleId !== Gn) {
        s = c.stack.pop();
        break;
      ...
      h.captureIndices &&
        ...
        (o.produce(c.stack, h.captureIndices[0].start),
        fe(t, e, n, c.stack, o, c.rule.whileCaptures, h.captureIndices),
        o.produce(c.stack, h.captureIndices[0].end),
...
function os(t, e, n, r, s, o) {
  const i = is(t, e, n, r, s, o),
    a = t.getInjections();
  if (a.length === 0) return i;
  const c = as(a, t, e, n, r, s, o);
  if (!c) return i;
  if (!i) return c;
  const l = i.captureIndices[0].start,
    u = c.captureIndices[0].start;
  return u < l || (c.priorityMatch && u === l) ? c : i;
}
function is(t, e, n, r, s, o) {
  const i = s.getRule(t),
    { ruleScanner: a, findOptions: c } = Fn(i, t, s.endRule, n, r === o),
    l = a.findNextMatchSync(e, r, c);
  return l ? { captureIndices: l.captureIndices, matchedRuleId: l.ruleId } : null;
}
function as(t, e, n, r, s, o, i) {
  ...
  for (let f = 0, p = t.length; f < p; f++) {
    ...
    const y = e.getRule(d.ruleId),
      { ruleScanner: b, findOptions: g } = Fn(y, e, null, r, s === i),
      w = b.findNextMatchSync(n, s, g);
    if (!w) continue;
    const m = w.captureIndices[0].start;
    if (!(m >= a) && ((a = m), (c = w.captureIndices), (l = w.ruleId), (u = d.priority), a === s))
      break;
  }
  return c ? { priorityMatch: u === -1, captureIndices: c, matchedRuleId: l } : null;
}
...
function fe(t, e, n, r, s, o, i) {
  ...
  for (let h = 0; h < c; h++) {
    ...
    if (
      (l.length > 0 ? s.produceFromScopes(l[l.length - 1].scopes, p.start) : s.produce(r, p.start),
      f.retokenizeCapturedWithRuleId)
    ) {
      const y = f.getName(a, i),
        b = r.contentNameScopesList.pushAttributed(y, t),
        g = f.getContentName(a, i),
        w = b.pushAttributed(g, t),
        m = r.push(f.retokenizeCapturedWithRuleId, p.start, -1, !1, null, b, w),
        _ = t.createOnigString(a.substring(0, p.end));
      (Bn(t, _, n && p.start === 0, p.start, m, s, !1, 0), Pn(_));
      continue;
    }
    const d = f.getName(a, i);
    if (d !== null) {
      const b = (l.length > 0 ? l[l.length - 1].scopes : r.contentNameScopesList).pushAttributed(
        d,
        t
      );
      l.push(new ls(b, p.end));
    }
  }
  for (; l.length > 0; )
    (s.produceFromScopes(l[l.length - 1].scopes, l[l.length - 1].endPos), l.pop());
...
function us(t, e, n, r, s, o, i, a) {
  return new fs(t, e, n, r, s, o, i, a);
}
function Ht(t, e, n, r, s) {
  const o = Pe(e, Me),
    i = Mn.getCompiledRuleId(n, r, s.repository);
  for (const a of o)
    t.push({ debugSelector: e, matcher: a.matcher, ruleId: i, grammar: s, priority: a.priority });
}
function Me(t, e) {
  if (e.length < t.length) return !1;
  let n = 0;
  return t.every((r) => {
    for (let s = n; s < e.length; s++) if (hs(e[s], r)) return ((n = s + 1), !0);
    return !1;
  });
}
function hs(t, e) {
...
var fs = class {
  constructor(t, e, n, r, s, o, i, a) {
    if (
      ...
      (this._onigLib = a),
      (this._basicScopeAttributesProvider = new ns(n, r)),
      (this._rootId = -1),
      (this._lastRuleId = 0),
      (this._ruleId2desc = [null]),
      (this._includedGrammars = {}),
      (this._grammarRepository = i),
      (this._grammar = Vt(e, null)),
      ...
      for (const c of Object.keys(s)) {
        const l = Pe(c, Me);
        for (const u of l) this._tokenTypeMatchers.push({ matcher: u.matcher, type: s[c] });
      }
  }
  _rootId;
  _lastRuleId;
  ...
  _collectInjections() {
    ...
    if (r) {
      ...
      if (s) for (let i in s) Ht(e, i, s[i], this, r);
  ...
  getExternalGrammar(t, e) {
    ...
    if (this._grammarRepository) {
      ...
      if (n) return ((this._includedGrammars[t] = Vt(n, e && e.$base)), this._includedGrammars[t]);
    }
  }
  ...
  _tokenize(t, e, n, r) {
    this._rootId === -1 &&
      ((this._rootId = Mn.getCompiledRuleId(
    ...
    if (!e || e === gt.NULL) {
      s = !0;
      const l = this._basicScopeAttributesProvider.getDefaultAttributes(),
        u = this.themeProvider.getDefaults(),
        h = ie.set(0, l.languageId, l.tokenType, null, u.fontStyle, u.foregroundId, u.backgroundId),
        f = this.getRule(this._rootId).getName(null, null);
      let p;
      (f ? (p = de.createRootAndLookUpScopeName(f, h, this)) : (p = de.createRoot("unknown", h)),
        (e = new gt(null, this._rootId, -1, -1, !1, null, p, p)));
    } else ((s = !1), e.reset());
    t =
      t +
      `
`;
    const o = this.createOnigString(t),
      i = o.content.length,
      a = new ps(n, t, this._tokenTypeMatchers, this.balancedBracketSelectors),
      c = Bn(this, o, s, 0, e, a, !0, r);
    return (
      Pn(o),
      { lineLength: i, lineTokens: a, ruleStack: c.stack, stoppedEarly: c.stoppedEarly }
    );
  }
};
function Vt(t, e) {
...
var de = class M {
    ...
    static fromExtension(e, n) {
      let r = e,
        s = e?.scopePath ?? null;
      for (const o of n)
        ((s = Je.push(s, o.scopeNames)), (r = new M(r, s, o.encodedTokenAttributes)));
      return r;
    }
    static createRoot(e, n) {
      return new M(null, new Je(null, e), n);
    }
    static createRootAndLookUpScopeName(e, n, r) {
      const s = r.getMetadataForScope(e),
        o = new Je(null, e),
        i = r.themeProvider.themeMatch(o),
        a = M.mergeAttributes(n, s, i);
      return new M(null, o, a);
    }
    get scopeName() {
    ...
    static mergeAttributes(e, n, r) {
      let s = -1,
        ...
        i = 0;
      return (
        r !== null && ((s = r.fontStyle), (o = r.foregroundId), (i = r.backgroundId)),
        ie.set(e, n.languageId, n.tokenType, null, s, o, i)
      );
    }
    pushAttributed(e, n) {
      if (e === null) return this;
      if (e.indexOf(" ") === -1) return M._pushAttributed(this, e, n);
      const r = e.split(/ /g);
      let s = this;
      for (const o of r) s = M._pushAttributed(s, o, n);
      return s;
    }
    static _pushAttributed(e, n, r) {
      const s = r.getMetadataForScope(n),
        ...
        i = r.themeProvider.themeMatch(o),
        a = M.mergeAttributes(e.tokenAttributes, s, i);
      return new M(e, o, a);
    }
    getScopeNames() {
  ...
  gt = class X {
    constructor(e, n, r, s, o, i, a, c) {
      ((this.parent = e),
        (this.ruleId = n),
        (this.beginRuleCapturedEOL = o),
        (this.endRule = i),
        (this.nameScopesList = a),
        (this.contentNameScopesList = c),
    ...
    static _equals(e, n) {
      return e === n
        ...
        : this._structuralEquals(e, n)
          ? de.equals(e.contentNameScopesList, n.contentNameScopesList)
          : !1;
    }
    ...
    push(e, n, r, s, o, i, a) {
      return new X(this, e, n, r, s, o, i, a);
    }
    getEnterPos() {
  ...
  ds = class {
    ...
    constructor(t, e) {
      ((this.balancedBracketScopes = t.flatMap((n) =>
        n === "*" ? ((this.allowAny = !0), []) : Pe(n, Me).map((r) => r.matcher)
      )),
        (this.unbalancedBracketScopes = e.flatMap((n) => Pe(n, Me).map((r) => r.matcher))));
    }
    get matchesAlways() {
  ...
  gs = class {
    ...
    grammarForScopeName(t, e, n, r, s) {
      if (!this._grammars.has(t)) {
        ...
        if (!o) return null;
        this._grammars.set(t, us(t, o, e, n, r, s, this, this._onigLib));
      }
  ...
  ms = class {
    ...
    constructor(e) {
      ((this._options = e),
        (this._syncRegistry = new gs(Le.createFromRawTheme(e.theme, e.colorMap), e.onigLib)),
    ...
    loadGrammarWithConfiguration(e, n, r) {
      return this._loadGrammar(
        ...
        r.embeddedLanguages,
        r.tokenTypes,
        new ds(r.balancedBracketSelectors || [], r.unbalancedBracketSelectors || [])
      );
    }
    loadGrammar(e) {
    ...
    _loadGrammar(e, n, r, s, o) {
      const i = new qr(this._syncRegistry, e);
      for (; i.Q.length > 0; )
...
const ys = /["&'<>`]/g,
  bs = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g,
  ws = /[\x01-\t\v\f\x0E-\x1F\x7F\x81\x8D\x8F\x90\x9D\xA0-\uFFFF]/g,
  _s = /[|\\{}()[\]^$+*?.]/g,
  Xt = new WeakMap();
function Cs(t, e) {
  if (((t = t.replace(e.subset ? Ss(e.subset) : ys, r)), e.subset || e.escapeOnly)) return t;
  return t.replace(bs, n).replace(ws, r);
  function n(s, o, i) {
    return e.format(
...
function Ss(t) {
  let e = Xt.get(t);
  return (e || ((e = ks(t)), Xt.set(t, e)), e);
}
function ks(t) {
  const e = [];
  let n = -1;
  for (; ++n < t.length; ) e.push(t[n].replace(_s, "\\$&"));
...
function vs(t, e, n) {
  const r = "&#" + String(t);
  return n && e && !Es.test(String.fromCharCode(e)) ? r : r + ";";
}
const Is = [
    "AElig",
    "AMP",
  ...
  Ns = ["cent", "copy", "divide", "gt", "lt", "not", "para", "times"],
  Dn = {}.hasOwnProperty,
  yt = {};
let xe;
for (xe in et) Dn.call(et, xe) && (yt[et[xe]] = xe);
const Rs = /[^\dA-Za-z]/;
function $s(t, e, n, r) {
  ...
  if (Dn.call(yt, s)) {
    ...
    return n &&
      Is.includes(o) &&
      !Ns.includes(o) &&
      (!r || (e && e !== 61 && Rs.test(String.fromCharCode(e))))
      ? i
      : i + ";";
  }
  return "";
...
function Ms(t, e, n, r) {
  return r.settings.bogusComments
    ? "<?" + oe(t.value, Object.assign({}, r.settings.characterReferences, { subset: Ts })) + ">"
    : "<!--" + t.value.replace(Ps, s) + "-->";
  function s(o) {
    return oe(o, Object.assign({}, r.settings.characterReferences, { subset: Gs }));
  }
}
function Os(t, e, n, r) {
  return (
...
function Un(t) {
  return e;
  function e(n, r, s) {
    const o = n ? n.children : Bs;
    let i = (r || 0) + t,
      a = o[i];
    if (!s) for (; a && At(a); ) ((i += t), (a = o[i]));
    return a;
  }
}
...
function Wn(t) {
  return e;
  function e(n, r, s) {
    return Fs.call(t, n.tagName) && t[n.tagName](n, r, s);
  }
}
const vt = Wn({
  body: js,
...
function tt(t, e, n) {
  const r = E(n, e, !0);
  return !r || (r.type !== "comment" && !(r.type === "text" && At(r.value.charAt(0))));
}
function Ds(t, e, n) {
  const r = E(n, e);
...
const Js = Wn({ body: to, colgroup: no, head: eo, html: Ys, tbody: ro });
function Ys(t) {
  const e = E(t, -1);
...
function to(t) {
  ...
  return (
    !e ||
    (e.type !== "comment" &&
      !(e.type === "text" && At(e.value.charAt(0))) &&
      !(
        e.type === "element" &&
        (e.tagName === "meta" ||
          e.tagName === "link" ||
...
function so(t, e, n, r) {
  ...
  const a = [];
  let c;
  s.space === "html" && t.tagName === "svg" && (r.schema = xn);
  const l = oo(r, t.properties),
    u = r.all(s.space === "html" && t.tagName === "template" ? t.content : t);
  return (
    (r.schema = s),
    u && (i = !1),
    (l || !o || !Js(t, e, n)) &&
      (a.push("<", t.tagName, l ? " " + l : ""),
      i &&
        (s.space === "svg" || r.settings.closeSelfClosing) &&
        ((c = l.charAt(l.length - 1)),
        (!r.settings.tightSelfClosing || c === "/" || (c && c !== '"' && c !== "'")) && a.push(" "),
        a.push("/")),
      a.push(">")),
    a.push(u),
    !i && (!o || !vt(t, e, n)) && a.push("</" + t.tagName + ">"),
    a.join("")
  );
}
function oo(t, e) {
...
function io(t, e, n) {
  ...
  const c = oe(
    r.attribute,
    Object.assign({}, t.settings.characterReferences, { subset: Ae.name[s][o] })
  );
  return n === !0 ||
    ((n = Array.isArray(n)
      ? (r.commaSeparated ? Er : vr)(n, { padLeft: !t.settings.tightCommaSeparatedLists })
      : String(n)),
    ...
    : (t.settings.preferUnquoted &&
      ...
      a !== n &&
        (t.settings.quoteSmart && Ft(n, i) > Ft(n, t.alternative) && (i = t.alternative),
        (a =
          i +
          oe(
            n,
...
function zn(t, e, n, r) {
  return n && n.type === "element" && (n.tagName === "script" || n.tagName === "style")
    ? t.value
    : oe(t.value, Object.assign({}, r.settings.characterReferences, { subset: ao }));
}
function co(t, e, n, r) {
  return r.settings.allowDangerousHtml ? t.value : zn(t, e, n, r);
}
function lo(t, e, n, r) {
  return r.all(t);
}
const uo = Ir("type", {
  invalid: ho,
  unknown: fo,
  handlers: { comment: Ms, doctype: Os, element: so, raw: co, root: lo, text: zn },
});
function ho(t) {
...
function yo(t, e) {
  ...
  return {
    ...
    settings: {
      ...
      voids: n.voids || Rr,
      characterReferences: n.characterReferences || go,
      closeSelfClosing: n.closeSelfClosing || !1,
      closeEmptyElements: n.closeEmptyElements || !1,
    },
    schema: n.space === "svg" ? xn : Nr,
    quote: r,
    alternative: s,
  }.one(Array.isArray(t) ? { type: "root", children: t } : t, void 0, void 0);
}
function bo(t, e, n) {
  return uo(t, e, n, this);
}
function wo(t) {
  const e = [],
    n = (t && t.children) || mo;
    ...
    ? t.map((r) =>
        r.flatMap((s) => {
          const o = n
            ...
            .map((i) => i - s.offset)
            .sort((i, a) => i - a);
          return o.length ? ko(s, o) : s;
        })
      )
    : t;
}
function Ao(t, e, n, r, s = "css-vars") {
  const o = { content: t.content, explanation: t.explanation, offset: t.offset },
    i = e.map((u) => Be(t.variants[u])),
    a = new Set(i.flatMap((u) => Object.keys(u))),
    c = {},
    l = (u, h) => {
  ...
  return (
    i.forEach((u, h) => {
      for (const f of a) {
        const p = u[f] || "inherit";
        if (h === 0 && r && So.includes(f))
          if (r === Rt && i.length > 1) {
            const d = e.findIndex((w) => w === "light"),
              y = e.findIndex((w) => w === "dark");
            if (d === -1 || y === -1)
              throw new x(
                'When using `defaultColor: "light-dark()"`, you must provide both `light` and `dark` themes'
              );
            const b = i[d][f] || "inherit",
              g = i[y][f] || "inherit";
            ((c[f] = `light-dark(${b}, ${g})`), s === "css-vars" && (c[l(h, f)] = p));
          } else c[f] = p;
        else s === "css-vars" && (c[l(h, f)] = p);
      }
    }),
    (o.htmlStyle = c),
    o
...
function Be(t) {
  ...
  if (
    ...
    (t.fontStyle & N.Italic && (e["font-style"] = "italic"),
      t.fontStyle & N.Bold && (e["font-weight"] = "bold"));
    const n = [];
    (t.fontStyle & N.Underline && n.push("underline"),
      t.fontStyle & N.Strikethrough && n.push("line-through"),
...
class ae {
  ...
  static initial(e, n) {
    return new ae(Object.fromEntries(_o(n).map((r) => [r, mt])), e);
  }
  constructor(...e) {
    if (e.length === 2) {
      const [n, r] = e;
...
function vo(t, e) {
  if (!(t instanceof ae)) throw new x("Invalid grammar state");
      ...
      let r = function (i) {
        if (typeof i == "number") {
          if (i < 0 || i > n.source.length)
            throw new x(`Invalid decoration offset: ${i}. Code length: ${n.source.length}`);
          return { ...s.indexToPos(i), offset: i };
        } else {
          const a = s.lines[i.line];
          if (a === void 0)
            throw new x(
              `Invalid decoration position ${JSON.stringify(i)}. Lines length: ${s.lines.length}`
            );
          let c = i.character;
          if ((c < 0 && (c = a.length + c), c < 0 || c > a.length))
            throw new x(
              `Invalid decoration position ${JSON.stringify(i)}. Line ${i.line} length: ${a.length}`
            );
          return { ...i, character: c, offset: s.posToIndex(i.line, c) };
        }
      };
      const s = Co(n.source),
        o = (n.options.decorations || []).map((i) => ({ ...i, start: r(i.start), end: r(i.end) }));
      (No(o), t.set(n.meta, { decorations: o, converter: s, source: n.source }));
    }
    return t.get(n.meta);
  }
  return {
    ...
    code(n) {
      ...
      function o(u, h, f, p) {
        ...
        if (
          (h === 0 && (b = 0),
          f === 0 && (g = 0),
          f === Number.POSITIVE_INFINITY && (g = d.children.length),
          b === -1 || g === -1)
        )
          for (let m = 0; m < d.children.length; m++)
            ((y += Kn(d.children[m])),
              b === -1 && y.length === h && (b = m + 1),
              g === -1 && y.length === f && (g = m + 1));
        if (b === -1)
          throw new x(`Failed to find start index for decoration ${JSON.stringify(p.start)}`);
        if (g === -1)
          throw new x(`Failed to find end index for decoration ${JSON.stringify(p.end)}`);
        const w = d.children.slice(b, g);
        if (!p.alwaysWrap && w.length === d.children.length) a(d, p, "line");
        else if (!p.alwaysWrap && w.length === 1 && w[0].type === "element") a(w[0], p, "token");
        else {
          const m = { type: "element", tagName: "span", properties: {}, children: w };
          (a(m, p, "wrapper"), d.children.splice(b, w.length, m));
        }
      }
      function i(u, h) {
        s[u] = a(s[u], h, "line");
      ...
      function a(u, h, f) {
        ...
        return (
          ...
          (u.properties = { ...u.properties, ...p, class: u.properties.class }),
          h.properties?.class && Xn(u, h.properties.class),
          (u = d(u, f) || u),
          u
        );
      }
      const c = [],
        l = r.decorations.sort(
          (u, h) => h.start.offset - u.start.offset || u.end.offset - h.end.offset
        );
      for (const u of l) {
        ...
        if (h.line === f.line) o(h.line, h.character, f.character, u);
          ...
          for (let p = h.line + 1; p < f.line; p++) c.unshift(() => i(p, u));
  ...
  for (let e = 0; e < t.length; e++) {
    ...
    for (let r = e + 1; r < t.length; r++) {
      const s = t[r],
        ...
        i = n.start.offset < s.end.offset && s.end.offset <= n.end.offset,
        a = s.start.offset <= n.start.offset && n.start.offset < s.end.offset,
        c = s.start.offset < n.end.offset && n.end.offset <= s.end.offset;
      if (o || i || a || c) {
        if (
          (o && i) ||
          (a && c) ||
          (a && n.start.offset === n.end.offset) ||
          (i && s.start.offset === s.end.offset)
        )
          continue;
        throw new x(
...
function Kn(t) {
  return t.type === "text" ? t.value : t.type === "element" ? t.children.map(Kn).join("") : "";
}
const Ro = [Io()];
function Fe(t) {
  const e = $o(t.transformers || []);
  return [...e.pre, ...e.normal, ...e.post, ...Ro];
}
function $o(t) {
  const e = [],
    n = [],
...
function Po(t) {
  ...
  for (; t.length > 0; ) {
    ...
    if (!Number.isNaN(r))
      if (r === 0) e.push({ type: "resetAll" });
      else if (r <= 9) nt[r] && e.push({ type: "setDecoration", value: nt[r] });
      else if (r <= 29) {
        const s = nt[r - 20];
        s &&
        ...
        e.push({ type: "setForegroundColor", value: { type: "named", name: K[r - 30] } });
      else if (r === 38) {
        const s = Zt(t);
        s && e.push({ type: "setForegroundColor", value: s });
      } else if (r === 39) e.push({ type: "resetForegroundColor" });
      else if (r <= 47)
        e.push({ type: "setBackgroundColor", value: { type: "named", name: K[r - 40] } });
      else if (r === 48) {
        const s = Zt(t);
...
function To() {
  ...
  return {
    parse(r) {
      ...
      do {
        const i = Lo(r, o),
          a = i.sequence ? r.substring(o, i.startPosition) : r.substring(o);
        if (
          (a.length > 0 &&
            s.push({ value: a, foreground: t, background: e, decorations: new Set(n) }),
          i.sequence)
        ) {
          const c = Po(i.sequence);
          for (const l of c)
            l.type === "resetAll"
              ? ((t = null), (e = null), n.clear())
              : l.type === "resetForegroundColor"
                ? (t = null)
                : l.type === "resetBackgroundColor"
                  ? (e = null)
                  : l.type === "resetDecoration" && n.delete(l.value);
          for (const l of c)
            l.type === "setForegroundColor"
              ? (t = l.value)
              : l.type === "setBackgroundColor"
                ? (e = l.value)
                : l.type === "setDecoration" && n.add(l.value);
        }
        o = i.position;
      } while (o < r.length);
      return s;
...
function Mo(t = Go) {
  ...
  function s() {
    if (r) return r;
    r = [];
    for (let l = 0; l < K.length; l++) r.push(e(K[l]));
    let a = [0, 95, 135, 175, 215, 255];
    for (let l = 0; l < 6; l++)
      for (let u = 0; u < 6; u++) for (let h = 0; h < 6; h++) r.push(n([a[l], a[u], a[h]]));
    let c = 8;
    for (let l = 0; l < 24; l++, c += 10) r.push(n([c, c, c]));
    return r;
  }
  function o(a) {
    return s()[a];
...
function Bo(t, e, n) {
  const r = Oe(t, n),
    ...
    o = Object.fromEntries(
      K.map((c) => {
        const l = `terminal.ansi${c[0].toUpperCase()}${c.substring(1)}`,
          u = t.colors?.[l];
        return [c, u || Oo[c]];
      })
    ),
  ...
  return s.map((c) =>
    a.parse(c[0]).map((l) => {
      ...
      (l.decorations.has("reverse")
        ? ((u = l.background ? i.value(l.background) : t.bg),
          (h = l.foreground ? i.value(l.foreground) : t.fg))
        : ((u = l.foreground ? i.value(l.foreground) : t.fg),
          (h = l.background ? i.value(l.background) : void 0)),
        (u = H(u, r)),
        (h = H(h, r)),
        l.decorations.has("dim") && (u = Fo(u)));
      let f = N.None;
      return (
        l.decorations.has("bold") && (f |= N.Bold),
        l.decorations.has("italic") && (f |= N.Italic),
        l.decorations.has("underline") && (f |= N.Underline),
        l.decorations.has("strikethrough") && (f |= N.Strikethrough),
        { content: l.value, offset: c[1], color: u, bgColor: h, fontStyle: f }
      );
    })
  );
}
function Fo(t) {
  ...
  if (e) {
    const r = e[1];
    if (r.length === 8) {
      const s = Math.round(Number.parseInt(r.slice(6, 8), 16) / 2)
        .toString(16)
        .padStart(2, "0");
      ...
      if (r.length === 4) {
        const s = r[0],
          ...
          i = r[2],
          a = r[3],
          c = Math.round(Number.parseInt(`${a}${a}`, 16) / 2)
            .toString(16)
            .padStart(2, "0");
        return `#${s}${s}${o}${o}${i}${i}${c}`;
      } else if (r.length === 3) {
        const s = r[0],
          o = r[1],
          i = r[2];
...
function $t(t, e, n = {}) {
  const { theme: r = t.getLoadedThemes()[0] } = n,
    s = t.resolveLangAlias(n.lang || "text");
  if (It(s) || Nt(r)) return ze(e).map((c) => [{ content: c[0], offset: c[1] }]);
  const { theme: o, colorMap: i } = t.setTheme(r);
  if (s === "ansi") return Bo(o, e, n);
  const a = t.getLanguage(n.lang || "text");
  if (n.grammarState) {
...
function Do(...t) {
  ...
  if (It(s) || Nt(o)) throw new x("Plain language does not have grammar state");
  if (s === "ansi") throw new x("ANSI language does not have grammar state");
  const { theme: i, colorMap: a } = e.setTheme(o),
    c = e.getLanguage(s);
  return new ae(De(n, c, i, a, r).stateStack, c.name, i.name);
}
function jo(t, e, n, r, s) {
  const o = De(t, e, n, r, s),
    i = new ae(De(t, e, n, r, s).stateStack, e.name, n.name);
  return (qe(o.tokens, i), o.tokens);
}
function De(t, e, n, r, s) {
  const o = Oe(n, s),
    { tokenizeMaxLineLength: i = 0, tokenizeTimeLimit: a = 500 } = s,
    c = ze(t);
  let l = s.grammarState
      ? (vo(s.grammarState, n.name) ?? mt)
      : s.grammarContextCode != null
        ? De(s.grammarContextCode, e, n, r, {
            ...s,
            grammarState: void 0,
  ...
  for (let f = 0, p = c.length; f < p; f++) {
    ...
    if (i > 0 && d.length >= i) {
      ((u = []), h.push([{ content: d, offset: y, color: "", fontStyle: 0 }]));
      continue;
    }
    let b, g, w;
    s.includeExplanation && ((b = e.tokenizeLine(d, l, a)), (g = b.tokens), (w = 0));
    const m = e.tokenizeLine2(d, l, a),
      _ = m.tokens.length / 2;
    for (let S = 0; S < _; S++) {
      const R = m.tokens[2 * S],
        $ = S + 1 < _ ? m.tokens[2 * S + 2] : d.length;
      if (R === $) continue;
      const O = m.tokens[2 * S + 1],
        Se = H(r[ie.getForeground(O)], o),
        Qe = ie.getFontStyle(O),
        ue = { content: d.substring(R, $), offset: y + R, color: Se, fontStyle: Qe };
      if (s.includeExplanation) {
        const W = [];
        if (s.includeExplanation !== "scopeName")
          for (const B of n.settings) {
            let Y;
            switch (typeof B.scope) {
              case "string":
                Y = B.scope.split(/,/).map((Ke) => Ke.trim());
                break;
              case "object":
                Y = B.scope;
                break;
            ...
            W.push({ settings: B, selectors: Y.map((Ke) => Ke.split(/ /)) });
          }
        ue.explanation = [];
        let Bt = 0;
        for (; R + Bt < $; ) {
          const B = g[w],
            Y = d.substring(B.startIndex, B.endIndex);
          ((Bt += Y.length),
            ue.explanation.push({
              content: Y,
              scopes: s.includeExplanation === "scopeName" ? Uo(B.scopes) : Wo(W, B.scopes),
            }),
            (w += 1));
        }
      }
    ...
    (h.push(u), (u = []), (l = m.ruleStack));
  }
  return { tokens: h, stateStack: l };
}
function Uo(t) {
...
function Wo(t, e) {
  ...
  for (let r = 0, s = e.length; r < s; r++) {
    const o = e[r];
    n[r] = { scopeName: o, themeMatches: qo(t, o, e.slice(0, r)) };
  }
  return n;
}
function Jt(t, e) {
...
function zo(t, e, n) {
  if (!Jt(t[t.length - 1], e)) return !1;
  let r = t.length - 2,
    s = n.length - 1;
  for (; r >= 0 && s >= 0; ) (Jt(t[r], n[s]) && (r -= 1), (s -= 1));
  return r === -1;
}
function qo(t, e, n) {
  const r = [];
...
function Zn(t, e, n) {
  const r = Object.entries(n.themes)
      .filter((c) => c[1])
      .map((c) => ({ color: c[0], theme: c[1] })),
    s = r.map((c) => {
      const l = $t(t, e, { ...n, theme: c.theme }),
        u = be(l),
        h = typeof c.theme == "string" ? c.theme : c.theme.name;
      return { tokens: l, state: u, theme: h };
    }),
    o = Ho(...s.map((c) => c.tokens)),
    i = o[0].map((c, l) =>
      c.map((u, h) => {
        ...
        return (
          ...
          o.forEach((p, d) => {
            const { content: y, explanation: b, offset: g, ...w } = p[l][h];
    ...
    a = s[0].state
      ? new ae(
          Object.fromEntries(s.map((c) => [c.theme, c.state?.getInternalStack(c.theme)])),
          s[0].state.lang
        )
      : void 0;
  return (a && qe(i, a), i);
...
function Ho(...t) {
  ...
  for (let r = 0; r < t[0].length; r++) {
    const s = t.map((c) => c[r]),
      o = e.map(() => []);
    e.forEach((c, l) => c.push(o[l]));
    const i = s.map(() => 0),
      a = s.map((c) => c[0]);
    for (; a.every((c) => c); ) {
      const c = Math.min(...a.map((l) => l.content.length));
      for (let l = 0; l < n; l++) {
        const u = a[l];
        u.content.length === c
          ? (o[l].push(u), (i[l] += 1), (a[l] = s[l][i[l]]))
          : (o[l].push({ ...u, content: u.content.slice(0, c) }),
            (a[l] = { ...u, content: u.content.slice(c), offset: u.offset + c }));
      }
    }
  }
  return e;
  ...
  if ("themes" in n) {
    const {
      ...
      f = Object.entries(n.themes)
        .filter((g) => g[1])
        .map((g) => ({ color: g[0], theme: g[1] }))
        .sort((g, w) => (g.color === l ? -1 : w.color === l ? 1 : 0));
    if (f.length === 0) throw new x("`themes` option must not be empty");
    const p = Zn(t, e, n);
    if (((c = be(p)), l && Rt !== l && !f.find((g) => g.color === l)))
      throw new x(`\`themes\` option must contain the defaultColor key \`${l}\``);
    const d = f.map((g) => t.getTheme(g.theme)),
      y = f.map((g) => g.color);
    ((o = p.map((g) => g.map((w) => Ao(w, y, u, l, h)))), c && qe(o, c));
    const b = f.map((g) => Oe(g.theme, n));
    ((s = Yt(f, d, b, u, l, "fg", h)),
      (r = Yt(f, d, b, u, l, "bg", h)),
      (i = `shiki-themes ${d.map((g) => g.name).join(" ")}`),
      (a = l ? void 0 : [s, r].join(";")));
  } else if ("theme" in n) {
    const l = Oe(n.theme, n);
    o = $t(t, e, n);
    const u = t.getTheme(n.theme);
    ((r = H(u.bg, l)), (s = H(u.fg, l)), (i = u.name), (c = be(o)));
  } else throw new x("Invalid options, either `theme` or `themes` must be provided");
  return { tokens: o, fg: s, bg: r, themeName: i, rootStyle: a, grammarState: c };
}
function Yt(t, e, n, r, s, o, i) {
  return t
    .map((a, c) => {
      const l = H(e[c][o], n[c]) || "inherit",
        u = `${r + a.color}${o === "bg" ? "-bg" : ""}:${l}`;
      if (c === 0 && s) {
        if (s === Rt && t.length > 1) {
          const h = t.findIndex((y) => y.color === "light"),
            f = t.findIndex((y) => y.color === "dark");
          if (h === -1 || f === -1)
            throw new x(
              'When using `defaultColor: "light-dark()"`, you must provide both `light` and `dark` themes'
            );
          const p = H(e[h][o], n[h]) || "inherit",
            d = H(e[f][o], n[f]) || "inherit";
          return `light-dark(${p}, ${d});${u}`;
        }
        return l;
      }
...
function Ue(
  ...
  r = {
    meta: {},
    options: n,
    codeToHast: (s, o) => Ue(t, s, o),
    codeToTokens: (s, o) => je(t, s, o),
  }
) {
  let s = e;
  for (const d of Fe(n)) s = d.preprocess?.call(r, s, n) || s;
  let { tokens: o, fg: i, bg: a, themeName: c, rootStyle: l, grammarState: u } = je(t, s, n);
  const { mergeWhitespaces: h = !0, mergeSameStyleTokens: f = !1 } = n;
  (h === !0 ? (o = Xo(o)) : h === "never" && (o = Qo(o)), f && (o = Ko(o)));
  const p = {
    ...r,
    get source() {
      return s;
  ...
  for (const d of Fe(n)) o = d.tokens?.call(p, o) || o;
  return Vo(
    o,
    { ...n, fg: i, bg: a, themeName: c, rootStyle: n.rootStyle === !1 ? !1 : (n.rootStyle ?? l) },
    p,
    u
  );
}
function Vo(t, e, n, r = be(t)) {
  const s = Fe(e),
    o = [],
    i = { type: "root", children: [] },
    { structure: a = "classic", tabindex: c = "0" } = e,
    l = { class: `shiki ${e.themeName || ""}` };
  (e.rootStyle !== !1 &&
    (e.rootStyle != null
      ? (l.style = e.rootStyle)
      : (l.style = `background-color:${e.bg};color:${e.fg}`)),
    c !== !1 && c != null && (l.tabindex = c.toString()));
  for (const [y, b] of Object.entries(e.meta || {})) y.startsWith("_") || (l[y] = b);
  let u = { type: "element", tagName: "pre", properties: l, children: [] },
    h = { type: "element", tagName: "code", properties: {}, children: o };
  const f = [],
    p = {
      ...n,
      structure: a,
...
`,
      ...
      for (const m of y) {
        ...
        const S = bt(m.htmlStyle || Be(m));
        S && (_.properties.style = S);
        for (const R of s) _ = R?.span?.call(p, _, b + 1, w, g, m) || _;
        (a === "inline" ? i.children.push(_) : a === "classic" && g.children.push(_),
          (w += m.content.length));
      }
      if (a === "classic") {
        for (const m of s) g = m?.line?.call(p, g, b + 1) || g;
        (f.push(g), o.push(g));
      } else a === "inline" && f.push(g);
    }),
    a === "classic")
  ) {
    for (const y of s) h = y?.code?.call(p, h) || h;
    u.children.push(h);
    for (const y of s) u = y?.pre?.call(p, u) || u;
    i.children.push(u);
  } else if (a === "inline") {
    const y = [];
    let b = { type: "element", tagName: "span", properties: { class: "line" }, children: [] };
    for (const m of i.children)
      m.type === "element" && m.tagName === "br"
        ? (y.push(b),
          (b = { type: "element", tagName: "span", properties: { class: "line" }, children: [] }))
        : (m.type === "element" || m.type === "text") && b.children.push(m);
    y.push(b);
    let w = { type: "element", tagName: "code", properties: {}, children: y };
    for (const m of s) w = m?.code?.call(p, w) || w;
    i.children = [];
    for (let m = 0; m < w.children.length; m++) {
      m > 0 && i.children.push({ type: "element", tagName: "br", properties: {}, children: [] });
      const _ = w.children[m];
      _.type === "element" && i.children.push(..._.children);
    }
  }
  let d = i;
  for (const y of s) d = y?.root?.call(p, d) || d;
  return (r && qe(d, r), d);
}
function Xo(t) {
  return t.map((e) => {
    ...
    return (
      e.forEach((o, i) => {
        const c = !(o.fontStyle && (o.fontStyle & N.Underline || o.fontStyle & N.Strikethrough));
        c && o.content.match(/^\s+$/) && e[i + 1]
          ? (s === void 0 && (s = o.offset), (r += o.content))
          : r
            ? (c
...
function Qo(t) {
  return t.map((e) =>
    e.flatMap((n) => {
      ...
      const [, s, o, i] = r;
      if (!s && !i) return n;
      const a = [{ ...n, offset: n.offset + s.length, content: o }];
      return (
        s && a.unshift({ content: s, offset: n.offset }),
        i && a.push({ content: i, offset: n.offset + s.length + o.length }),
        a
      );
    })
  );
  ...
  return t.map((e) => {
    ...
    for (const r of e) {
      ...
      const s = n[n.length - 1],
        o = bt(s.htmlStyle || Be(s)),
        i = bt(r.htmlStyle || Be(r)),
        a = s.fontStyle && (s.fontStyle & N.Underline || s.fontStyle & N.Strikethrough),
        c = r.fontStyle && (r.fontStyle & N.Underline || r.fontStyle & N.Strikethrough);
      !a && !c && o === i ? (s.content += r.content) : n.push({ ...r });
    }
    return n;
  });
}
...
function Jo(t, e, n) {
  const r = {
    ...
    codeToTokens: (o, i) => je(t, o, i),
  };
  let s = Zo(Ue(t, e, n, r));
  for (const o of Fe(n)) s = o.postprocess?.call(r, s, n) || s;
  return s;
}
const en = { light: "#333333", dark: "#bbbbbb" },
  tn = { light: "#fffffe", dark: "#1e1e1e" },
  nn = "__shiki_resolved";
function Lt(t) {
  if (t?.[nn]) return t;
  const e = { ...t };
  ...
  let { bg: n, fg: r } = e;
  if (!n || !r) {
    const a = e.settings ? e.settings.find((c) => !c.name && !c.scope) : void 0;
    (a?.settings?.foreground && (r = a.settings.foreground),
      ...
      r || (r = e.type === "light" ? en.light : en.dark),
      n || (n = e.type === "light" ? tn.light : tn.dark),
      (e.fg = r),
      (e.bg = n));
  }
  ...
  function i(a) {
    ...
    s += 1;
    const c = `#${s.toString(16).padStart(8, "0").toLowerCase()}`;
    return e.colorReplacements?.[`#${c}`] ? i(a) : (o.set(a, c), c);
  }
  e.settings = e.settings.map((a) => {
    const c = a.settings?.foreground && !a.settings.foreground.startsWith("#"),
      l = a.settings?.background && !a.settings.background.startsWith("#");
    if (!c && !l) return a;
    const u = { ...a, settings: { ...a.settings } };
    if (c) {
  ...
  for (const a of Object.keys(e.colors || {}))
    if (
      (a === "editor.foreground" || a === "editor.background" || a.startsWith("terminal.ansi")) &&
      !e.colors[a]?.startsWith("#")
    ) {
      const c = i(e.colors[a]);
      ((e.colorReplacements[c] = e.colors[a]), (e.colors[a] = c));
    }
  return (Object.defineProperty(e, nn, { enumerable: !1, writable: !1, value: !0 }), e);
}
async function Jn(t) {
  return Array.from(
    new Set(
      (
        await Promise.all(
          t
            .filter((e) => !Hn(e))
            .map(async (e) => await qn(e).then((n) => (Array.isArray(n) ? n : [n])))
        )
      ).flat()
    )
  );
...
async function Yn(t) {
  return (await Promise.all(t.map(async (n) => (Vn(n) ? null : Lt(await qn(n)))))).filter(
    (n) => !!n
  );
}
let Yo = 3;
function ei(t, e = 3) {
  e > Yo || console.trace(`[SHIKI DEPRECATE]: ${t}`);
}
...
function er(t, e) {
  ...
  if (e[t]) {
    ...
    for (; e[t]; ) {
      if (((t = e[t]), n.has(t)))
        throw new se(`Circular alias \`${Array.from(n).join(" -> ")} -> ${t}\``);
      n.add(t);
    }
  }
  return t;
...
class ti extends ms {
  ...
  setTheme(e) {
    ...
    (n || ((n = Le.createFromRawTheme(e)), this._textmateThemeCache.set(e, n)),
      this._syncRegistry.setTheme(n));
  }
  getGrammar(e) {
    return ((e = er(e, this._alias)), this._resolvedGrammars.get(e));
  }
  loadLanguage(e) {
  ...
  loadLanguages(e) {
    ...
    if (r.length) {
      const s = n
        .filter(([o, i]) =>
          i
            ? (i.embeddedLanguages || i.embeddedLangs)?.some((c) => r.map(([l]) => l).includes(c))
            : !1
        )
...
function ri(t) {
  ((he += 1),
    t.warnings !== !1 &&
      ...
      he % 10 === 0 &&
      console.warn(
        `[Shiki] ${he} instances have been created. Shiki is supposed to be used as a singleton, consider refactoring your code to cache your highlighter instance; Or call \`highlighter.dispose()\` to release unused instances.`
      ));
  let e = !1;
  if (!t.engine) throw new se("`engine` option is required for synchronous mode");
  const n = (t.langs || []).flat(1),
    r = (t.themes || []).flat(1).map(Lt),
    s = new ni(t.engine, n),
    o = new ti(s, r, n, t.langAlias);
  let i;
  function a(m) {
    return er(m, t.langAlias);
  }
  function c(m) {
    g();
    const _ = o.getGrammar(typeof m == "string" ? m : m.name);
    if (!_) throw new se(`Language \`${m}\` not found, you may need to load it first`);
    return _;
  }
  function l(m) {
    if (m === "none") return { bg: "", fg: "", name: "none", settings: [], type: "dark" };
    g();
    const _ = o.getTheme(m);
    if (!_) throw new se(`Theme \`${m}\` not found, you may need to load it first`);
    return _;
  }
  function u(m) {
    g();
    const _ = l(m);
    i !== m && (o.setTheme(_), (i = m));
    const S = o.getColorMap();
    return { theme: _, colorMap: S };
  }
  function h() {
  ...
  function y(...m) {
    g();
    for (const _ of m.flat(1)) o.loadTheme(_);
  }
  async function b(...m) {
    return (g(), y(await Yn(m)));
  }
  function g() {
    if (e) throw new se("Shiki instance has been disposed");
  }
  function w() {
    e || ((e = !0), o.dispose(), (he -= 1));
  }
  return {
    setTheme: u,
    getTheme: l,
...
async function si(t) {
  ...
  const [e, n, r] = await Promise.all([Yn(t.themes || []), Jn(t.langs || []), t.engine]);
  return ri({ ...t, themes: e, langs: n, engine: r });
}
async function oi(t) {
  const e = await si(t);
  return {
    getLastGrammarState: (...n) => Do(e, ...n),
    codeToTokensBase: (n, r) => $t(e, n, r),
    codeToTokensWithThemes: (n, r) => Zn(e, n, r),
    codeToTokens: (n, r) => je(e, n, r),
    codeToHast: (n, r) => Ue(e, n, r),
    codeToHtml: (n, r) => Jo(e, n, r),
    getBundledLanguages: () => ({}),
    getBundledThemes: () => ({}),
    ...e,
...
function Xa(t) {
  ...
  async function s(o) {
    function i(h) {
      if (typeof h == "string") {
        if (((h = o.langAlias?.[h] || h), Hn(h))) return [];
        const f = e[h];
        if (!f)
          throw new x(
            `Language \`${h}\` is not included in this bundle. You may want to load it from external source.`
          );
        return f;
      }
      return h;
    ...
    function a(h) {
      ...
      if (typeof h == "string") {
        ...
        if (!f)
          throw new x(
            `Theme \`${h}\` is not included in this bundle. You may want to load it from external source.`
          );
        return f;
      }
      return h;
    }
    const c = (o.themes ?? []).map((h) => a(h)),
      l = (o.langs ?? []).map((h) => i(h)),
      u = await oi({ engine: o.engine ?? r(), ...o, themes: c, langs: l });
    return {
      ...u,
      loadLanguage(...h) {
...
const tr = v`\[\^?`,
  nr = `c.? | C(?:-.?)?|${v`[pP]\{(?:\^?[-\x20_]*[A-Za-z][-\x20\w]*\})?`}|${v`x[89A-Fa-f]\p{AHex}(?:\\x[89A-Fa-f]\p{AHex})*`}|${v`u(?:\p{AHex}{4})? | x\{[^\}]*\}? | x\p{AHex}{0,2}`}|${v`o\{[^\}]*\}?`}|${v`\d{1,3}`}`,
  Tt = /[?*+][?+]?|\{(?:\d+(?:,\d*)?|,\d+)\}\??/,
  Ee = new RegExp(
    v`
  \\ (?:
...
function ai(t, e = {}) {
  ...
  let i = [],
    a;
  for (Ee.lastIndex = 0; (a = Ee.exec(t)); ) {
    const h = ci(o, t, a[0], Ee.lastIndex);
    (h.tokens ? i.push(...h.tokens) : h.token && i.push(h.token),
      h.lastIndex !== void 0 && (Ee.lastIndex = h.lastIndex));
  }
  const c = [];
  let l = 0;
  (i
    .filter((h) => h.type === "GroupOpen")
    .forEach((h) => {
      h.kind === "capturing" ? (h.number = ++l) : h.raw === "(" && c.push(h);
    }),
    l ||
      c.forEach((h, f) => {
  ...
  const u = l || c.length;
  return { tokens: i.map((h) => (h.type === "EscapedNumber" ? Ii(h, u) : h)).flat(), flags: r };
}
function ci(t, e, n, r) {
  const [s, o] = n;
  if (n === "[" || n === "[^") {
  ...
  if (s === "\\") {
    if ("AbBGyYzZ".includes(o)) return { token: rn(n, n) };
    if (/^\\g[<']/.test(n)) {
    ...
    if (o === "K") return { token: or("keep", n) };
    if (o === "N" || o === "R") return { token: Z("newline", n, { negate: o === "N" }) };
    if (o === "O") return { token: Z("any", n) };
    if (o === "X") return { token: Z("text_segment", n) };
    const i = rr(n, { inCharClass: !1 });
    return Array.isArray(i) ? { tokens: i } : { token: i };
  }
  if (s === "(") {
    if (o === "*") return { token: ki(n) };
    if (n === "(?{") throw new Error(`Unsupported callout "${n}"`);
    if (n.startsWith("(?#")) {
      if (e[r] !== ")") throw new Error('Unclosed comment group "(?#"');
      return { lastIndex: r + 1 };
    }
    if (/^\(\?[-imx]+[:)]$/.test(n)) return { token: Si(n, t) };
    if (
      (t.pushModX(t.getCurrentModX()),
      t.numOpenGroups++,
      (n === "(" && !t.captureGroup) || n === "(?:")
    )
      return { token: ne("group", n) };
    if (n === "(?>") return { token: ne("atomic", n) };
    if (n === "(?=" || n === "(?!" || n === "(?<=" || n === "(?<!")
      return {
        token: ne(n[2] === "<" ? "lookbehind" : "lookahead", n, { negate: n.endsWith("!") }),
      };
    if (
      (n === "(" && t.captureGroup) ||
      ...
      return { token: ne("capturing", n, { ...(n !== "(" && { name: n.slice(3, -1) }) }) };
    if (n.startsWith("(?~")) {
      if (n === "(?~|") throw new Error(`Unsupported absence function kind "${n}"`);
      return { token: ne("absence_repeater", n) };
    }
    throw n === "(?("
...
`,
  ...
  if (n === ".") return { token: Z("dot", n) };
  if (n === "^" || n === "$") {
    const i = t.singleline ? { "^": v`\A`, $: v`\Z` }[n] : n;
    return { token: rn(i, n) };
  }
  return n === "|" ? { token: hi(n) } : Tt.test(n) ? { tokens: Ni(n) } : { token: j(ce(n), n) };
}
function li(t, e, n) {
  const r = [sn(e[1] === "^", e)];
  let s = 1,
    o;
  for (rt.lastIndex = n; (o = rt.exec(t)); ) {
    const i = o[0];
    if (i[0] === "[" && i[1] !== ":") (s++, r.push(sn(i[1] === "^", i)));
    else if (i === "]") {
      if (r.at(-1).type === "CharacterClassOpen") r.push(j(93, i));
      else if ((s--, r.push(fi(i)), !s)) break;
    } else {
      const a = ui(i);
      Array.isArray(a) ? r.push(...a) : r.push(a);
    }
  }
  return { tokens: r, lastIndex: rt.lastIndex || t.length };
}
function ui(t) {
  if (t[0] === "\\") return rr(t, { inCharClass: !0 });
  if (t[0] === "[") {
    const e = /\[:(?<negate>\^?)(?<name>[a-z]+):\]/.exec(t);
    if (!e || !Pt.has(e.groups.name)) throw new Error(`Invalid POSIX class "${t}"`);
    return Z("posix", t, { value: e.groups.name, negate: !!e.groups.negate });
  }
  return t === "-" ? di(t) : t === "&&" ? pi(t) : j(ce(t), t);
}
function rr(t, { inCharClass: e }) {
  const n = t[1];
  if (n === "c" || n === "C") return Ci(t);
  if ("dDhHsSwW".includes(n)) return xi(t);
  if (t.startsWith(v`\o{`))
  ...
  if (/^\\x[89A-Fa-f]\p{AHex}/u.test(t))
    try {
      const r = t
        ...
        o = new TextEncoder();
      return [...s].map((i) => {
        const a = [...o.encode(i)].map((c) => `\\x${c.toString(16)}`).join("");
        return j(ce(i), a);
      });
    } catch {
      throw new Error(`Multibyte code "${t}" incomplete or invalid in Oniguruma`);
    }
  if (n === "u" || n === "x") return j(vi(t), t);
  if (on.has(n)) return j(on.get(n), t);
  if (/\d/.test(n)) return gi(e, t);
  if (t === "\\") throw new Error(v`Incomplete escape "\"`);
  if (n === "M") throw new Error(`Unsupported meta "${t}"`);
  if ([...t].length === 2) return j(t.codePointAt(1), t);
...
function or(t, e, n = {}) {
  return t === "keep"
    ...
    : { type: "Directive", kind: t, flags: le(n.flags), raw: e };
}
function gi(t, e) {
...
const _i = new Set(["COUNT", "CMP", "ERROR", "FAIL", "MAX", "MISMATCH", "SKIP", "TOTAL_COUNT"]),
  on = new Map([
    ["a", 7],
    ["b", 8],
    ["e", 27],
...
function Ci(t) {
  ...
  return j(ce(e.toUpperCase()) - 64, t);
}
function Si(t, e) {
  ...
  const s = (e.getCurrentModX() || n.includes("x")) && !r.includes("x"),
    ...
    i = cn(r),
    a = {};
  if ((o && (a.enable = o), i && (a.disable = i), t.endsWith(")")))
    return (e.replaceCurrentModX(s), or("flags", t, { flags: a }));
  if (t.endsWith(":"))
    return (e.pushModX(s), e.numOpenGroups++, ne("group", t, { ...((o || i) && { flags: a }) }));
...
function ki(t) {
  ...
  const o = s
      ...
      : [],
    [i, a, c] = o,
    l = _i.has(n) ? n.toLowerCase() : "custom";
  switch (l) {
    case "fail":
    case "mismatch":
    case "skip":
    ...
    case "max":
      ...
      if (o.length === 2 && (typeof a == "number" || !/^[<>X]$/.test(a)))
        throw new Error(`Named callout optional argument two must be '<', '>', or 'X' "${a}"`);
      break;
    case "count":
    case "total_count":
      if (o.length > 1) throw new Error(`Named callout allows only one argument "${o}"`);
    ...
    case "cmp":
      ...
      if (typeof i == "string" && !/^[A-Za-z_]\w*$/.test(i))
        throw new Error(`Named callout argument one must be a tag or number "${i}"`);
      if (typeof a == "number" || !/^(?:[<>!=]=|[<>])$/.test(a))
        throw new Error(
          `Named callout argument two must be '==', '!=', '>', '<', '>=', or '<=' "${a}"`
        );
      if (typeof c == "string" && !/^[A-Za-z_]\w*$/.test(c))
        throw new Error(`Named callout argument three must be a tag or number "${c}"`);
      break;
    case "custom":
  ...
  return yi(l, r ?? null, s?.split(",") ?? null, t);
}
function an(t) {
  let e = null,
    n,
  ...
  if (t[0] === "{") {
    const { minStr: s, maxStr: o } = /^\{(?<minStr>\d*)(?:,(?<maxStr>\d*))?/.exec(t).groups,
      i = 1e5;
    if (+s > i || (o && +o > i)) throw new Error("Quantifier value unsupported in Oniguruma");
    if (
      ((n = +s),
...
function xi(t) {
  ...
  return Z({ d: "digit", h: "hex", s: "space", w: "word" }[e], t, { negate: t[1] !== e });
}
function Ai(t) {
  const { p: e, neg: n, value: r } = /^\\(?<p>[pP])\{(?<neg>\^?)(?<value>[^}]+)/.exec(t).groups;
  return Z("property", t, { value: r, negate: (e === "P" && !n) || (e === "p" && !!n) });
}
function cn(t) {
  const e = {};
  return (
...
function vi(t) {
  if (/^(?:\\u(?!\p{AHex}{4})|\\x(?!\p{AHex}{1,2}|\{\p{AHex}{1,8}\}))/u.test(t))
...
function Ii(t, e) {
  const { raw: n, inCharClass: r } = t,
    s = n.slice(1);
  if (!r && ((s !== "0" && s.length === 1) || (s[0] !== "0" && +s <= e))) return [sr(n)];
  const o = [],
    i = s.match(/^[0-7]+|\d/g);
  for (let a = 0; a < i.length; a++) {
    ...
    let l;
    if (a === 0 && c !== "8" && c !== "9") {
      if (((l = parseInt(c, 8)), l > 127))
        throw new Error(v`Octal encoded byte above 177 unsupported "${n}"`);
    } else l = ce(c);
    o.push(j(l, (a === 0 ? "\\" : "") + c));
  }
  return o;
  ...
  for (; (r = n.exec(t)); ) {
    ...
    if (s[0] === "{") {
      ...
      if (o) {
        ...
        if (+i > +a && s.endsWith("?")) {
          (n.lastIndex--, e.push(an(s.slice(0, -1))));
          continue;
        }
      }
    }
...
function ar(t, e = {}) {
    ...
    s = (f, p) => {
      ...
      switch (((o.parent = f), o.nextIndex++, d.type)) {
        ...
        case "Backreference":
          return Pi(d, o);
        case "Character":
          return He(d.value, { useLastValid: !!p.isCheckingRangeEnd });
        ...
        case "CharacterSet":
          return Mi(d, o);
        case "Directive":
          return Ui(d.kind, { flags: d.flags });
        case "GroupOpen":
          return Oi(d, o, p);
        case "NamedCallout":
          return zi(d.kind, d.tag, d.arguments);
        case "Quantifier":
          return Bi(d, o);
        case "Subroutine":
          return Fi(d, o);
  ...
  for (; o.nextIndex < r.tokens.length; ) {
    const f = s(a, {});
    f.type === "Alternative" ? (i.body.push(f), (a = f)) : a.body.push(f);
  }
  const { capturingGroups: c, hasNumberedRef: l, namedGroupsByName: u, subroutines: h } = o;
  if (l && u.size && !n.rules.captureGroup)
    throw new Error("Numbered backref/subroutine not allowed when using named capture");
  for (const { ref: f } of h)
    if (typeof f == "number") {
      if (f > c.length) throw new Error("Subroutine uses a group number that's not defined");
      f && (c[f - 1].isSubroutined = !0);
    } else if (u.has(f)) {
      if (u.get(f).length > 1)
        throw new Error(v`Subroutine uses a duplicate group name "\g<${f}>"`);
      u.get(f)[0].isSubroutined = !0;
    } else throw new Error(v`Subroutine uses a group name that's not defined "\g<${f}>"`);
  return i;
}
function Li({ kind: t }) {
  return wt(
...
function Pi({ raw: t }, e) {
  const n = /^\\k[<']/.test(t),
    ...
    s = (o, i = !1) => {
      ...
      let c = !1;
      if (o > a)
        if (e.skipBackrefValidation) c = !0;
        else throw new Error(`Not enough capturing groups defined to the left "${t}"`);
      return ((e.hasNumberedRef = !0), _t(i ? a + 1 - o : o, { orphan: c }));
    };
  if (n) {
...
function Ti(t, e, n) {
  ...
  if (
    ...
    a &&
    a.type !== "CharacterClassOpen" &&
    a.type !== "CharacterClassClose" &&
    a.type !== "CharacterClassIntersector"
  ) {
    const c = s(o, { ...n, isCheckingRangeEnd: !0 });
    if (i.type === "Character" && c.type === "Character") return (o.body.pop(), ji(i, c));
    throw new Error("Invalid character class range");
  }
  return He(ce("-"));
}
function Gi({ negate: t }, e, n) {
  const { tokens: r, walk: s } = e,
    o = r[e.nextIndex],
    i = [$e()];
  let a = hn(o);
  for (; a.type !== "CharacterClassClose"; ) {
    if (a.type === "CharacterClassIntersector") (i.push($e()), e.nextIndex++);
    else {
      const l = i.at(-1);
      l.body.push(s(l, n));
    }
    a = hn(r[e.nextIndex], o);
  }
  const c = $e({ negate: t });
  return (
    i.length === 1
      ? (c.body = i[0].body)
      : ((c.kind = "intersection"), (c.body = i.map((l) => (l.body.length === 1 ? l.body[0] : l)))),
    e.nextIndex++,
    c
  );
}
function Mi({ kind: t, negate: e, value: n }, r) {
  const {
  ...
  if (t === "property") {
    const a = Ve(n);
    if (Pt.has(a) && !i?.has(a)) ((t = "posix"), (n = a));
    else
      return re(n, {
        negate: e,
        normalizeUnknownPropertyNames: s,
  ...
  return t === "posix" ? qi(n, { negate: e }) : Ct(t, { negate: e });
}
function Oi(t, e, n) {
  const {
      tokens: r,
    ...
    h = u && c.negate;
  if (
    (c.type === "CapturingGroup" && (s.push(c), c.name && ii(o, c.name, []).push(c)),
    l && n.isInAbsenceFunction)
  )
    throw new Error("Nested absence function not supported by Oniguruma");
  let f = fn(r[e.nextIndex]);
  for (; f.type !== "GroupClose"; ) {
    if (f.type === "Alternator") (c.body.push(J()), e.nextIndex++);
    else {
      const p = c.body.at(-1),
        d = a(p, {
          ...n,
          ...
          isInNegLookbehind: n.isInNegLookbehind || h,
        });
      if ((p.body.push(d), (u || n.isInLookbehind) && !i)) {
        const y = "Lookbehind includes a pattern not allowed by Oniguruma";
        if (h || n.isInNegLookbehind) {
          if (ln(d) || d.type === "CapturingGroup") throw new Error(y);
        } else if (ln(d) || (un(d) && d.negate)) throw new Error(y);
      }
    }
    f = fn(r[e.nextIndex]);
  }
  return (e.nextIndex++, c);
}
function Bi({ kind: t, min: e, max: n }, r) {
  const s = r.parent,
    o = s.body.at(-1);
  if (!o || !Ri(o)) throw new Error("Quantifier requires a repeatable token");
  const i = lr(t, e, n, o);
  return (s.body.pop(), i);
}
function Fi({ raw: t }, e) {
  ...
  if (o) {
    const a = +o.groups.num,
      c = n.length;
    if (
      ((e.hasNumberedRef = !0), (s = { "": a, "+": c + a, "-": c + 1 - a }[o.groups.sign]), s < 1)
    )
...
function Di(t, e) {
  return { type: "AbsenceFunction", kind: t, body: Ce(e?.body) };
}
function J(t) {
  return { type: "Alternative", body: hr(t?.body) };
}
function wt(t, e) {
...
function $e(t) {
  ...
  return { type: "CharacterClass", kind: e.kind, negate: e.negate, body: hr(t?.body) };
}
function ji(t, e) {
...
function Ui(t, e = {}) {
  ...
  if (t === "flags") return { type: "Directive", kind: t, flags: le(e.flags) };
...
function G(t) {
  ...
  return { type: "Group", ...(e && { atomic: e }), ...(n && { flags: n }), body: Ce(t?.body) };
}
function Q(t) {
...
function qi(t, e) {
  const n = !!e?.negate;
  if (!Pt.has(t)) throw new Error(`Invalid POSIX class "${t}"`);
...
function Hi(t, e) {
  return { type: "Regex", body: Ce(e?.body), flags: t };
}
function ur(t) {
...
function re(t, e) {
  ...
  let r = n.unicodePropertyMap?.get(Ve(t));
  if (!r) {
    if (n.normalizeUnknownPropertyNames) r = Qi(t);
    else if (n.unicodePropertyMap && !n.skipPropertyNameValidation)
      throw new Error(v`Invalid Unicode property "\p{${t}}"`);
  }
  return { type: "CharacterSet", kind: "property", value: r ?? t, negate: n.negate };
}
function Vi({ flags: t, kind: e, name: n, negate: r, number: s }) {
  switch (e) {
    ...
    case "lookahead":
    case "lookbehind":
      return Q({ behind: e === "lookbehind", negate: r });
    default:
...
function fn(t) {
  return le(t, "Unclosed group");
}
function pe(t, e, n = null) {
  function r(o, i) {
  ...
  function s(o, i = null, a = null, c = null) {
    let l = 0,
      u = !1;
    const h = {
        node: o,
        ...
        root: t,
        remove() {
          (ve(c).splice(Math.max(0, ee(a) + l), 1), l--, (u = !0));
        },
        removeAllNextSiblings() {
          return ve(c).splice(ee(a) + 1);
        },
        removeAllPrevSiblings() {
          const g = ee(a) + l;
          return ((l -= g), ve(c).splice(0, Math.max(0, g)));
        },
        replaceWith(g, w = {}) {
          const m = !!w.traverse;
          (c ? (c[Math.max(0, ee(a) + l)] = g) : (le(i, "Can't replace root node")[a] = g),
            m && s(g, i, a, c),
            (u = !0));
        },
        replaceWithMultiple(g, w = {}) {
          const m = !!w.traverse;
          if ((ve(c).splice(Math.max(0, ee(a) + l), 1, ...g), (l += g.length - 1), m)) {
            let _ = 0;
            for (let S = 0; S < g.length; S++) _ += s(g[S], i, ee(a) + S + _, c);
          }
          u = !0;
        },
        skip() {
    ...
    return (d?.exit?.(h, n), p?.exit?.(h, n), l);
  }
  return (s(t), t);
}
function ve(t) {
...
const Ki = String.raw`\(\?(?:[:=!>A-Za-z\-]|<[=!]|\(DEFINE\))`;
function Zi(t, e) {
...
const T = Object.freeze({ DEFAULT: "DEFAULT", CHAR_CLASS: "CHAR_CLASS" });
function Gt(t, e, n, r) {
  const s = new RegExp(String.raw`${e}|(?<$skip>\[\^?|\\?.)`, "gsu"),
    o = [!1];
  let i = 0,
    a = "";
  for (const c of t.matchAll(s)) {
    const {
      0: l,
      groups: { $skip: u },
    } = c;
    if (!u && (!r || (r === T.DEFAULT) == !i)) {
      n instanceof Function
        ? (a += n(c, { context: i ? T.CHAR_CLASS : T.DEFAULT, negated: o[o.length - 1] }))
        : (a += n);
      continue;
    }
    (l[0] === "[" ? (i++, o.push(l[1] === "^")) : l === "]" && i && (i--, o.pop()), (a += l));
  }
  return a;
}
function fr(t, e, n, r) {
...
function Yi(t, e, n = 0, r) {
  ...
  for (; (i = s.exec(t)); ) {
    ...
    if (!c && (!r || (r === T.DEFAULT) == !o)) return i;
    (a === "[" ? o++ : a === "]" && o && o--, s.lastIndex == i.index && s.lastIndex++);
  }
  return null;
}
function Ie(t, e, n) {
...
const dn = new RegExp(
  String.raw`(?<noncapturingStart>${Ki})|(?<capturingStart>\((?:\?<[^>]+>)?)|\\?.`,
  "gsu"
);
function ta(t, e) {
  ...
  do {
    ...
    let f = 0,
      ...
      d = !1,
      y;
    for (dn.lastIndex = Number.isNaN(u) ? 0 : u + o.length; (y = dn.exec(t)); ) {
      const {
        0: b,
        index: g,
        groups: { capturingStart: w, noncapturingStart: m },
      } = y;
      if (b === "[") f++;
      else if (f) b === "]" && f--;
      else if (b === s && !d) ((u = g), (d = !0));
      else if (d && m) p++;
      else if (w) d ? p++ : (c++, i.push(c + l));
      else if (b === ")" && d) {
        if (!p) {
          l++;
          const _ = c + l;
          if (
            ((t = `${t.slice(0, u)}${o}${t.slice(u + s.length, g)}))<$$${_}>)${t.slice(g + 1)}`),
            (h = !0),
            a.push(_),
            Zi(n, _),
            r.size)
  ...
  return (
    ...
    (t = Gt(
      ...
      ({ 0: f, groups: { backrefNum: p, wrappedBackrefNum: d } }) => {
        if (p) {
          const y = +p;
          if (y > i.length - 1) throw new Error(`Backref "${f}" greater than number of captures`);
          return `\\${i[y]}`;
        }
        return `\\${d}`;
      },
...
| (?<qBase>${dr})(?<qMod>[?+]?)(?<invalidQ>[?*+\{]?)
| \\?.
`.replace(/\s+/g, ""),
    "gsu"
  );
function na(t) {
  if (!new RegExp(`${dr}\\+`).test(t)) return { pattern: t };
  const e = [];
  let n = null,
    r = null,
    s = "",
    o = 0,
    i;
  for (st.lastIndex = 0; (i = st.exec(t)); ) {
    const {
      0: a,
      index: c,
      groups: { qBase: l, qMod: u, invalidQ: h },
    } = i;
    if (a === "[") (o || (r = c), o++);
    else if (a === "]") o ? o-- : (r = null);
    else if (!o)
      if (u === "+" && s && !s.startsWith("(")) {
        if (h) throw new Error(`Invalid quantifier "${a}"`);
        let f = -1;
        if (/^\{\d+\}$/.test(l)) t = Ji(t, c + l.length, u, "");
        else {
          if (s === ")" || s === "]") {
            const p = s === ")" ? n : r;
            if (p === null) throw new Error(`Invalid unmatched "${s}"`);
            t = `${t.slice(0, p)}(?>${t.slice(p, c)}${l})${t.slice(c + a.length)}`;
          } else t = `${t.slice(0, c - s.length)}(?>${s}${l})${t.slice(c + a.length)}`;
          f += 4;
        }
        st.lastIndex += f;
      } else a[0] === "(" ? e.push(c) : a === ")" && (n = e.length ? e.pop() : null);
    s = a;
  }
  return { pattern: t };
}
const P = String.raw,
  ra = P`\\g<(?<gRNameOrNum>[^>&]+)&R=(?<gRDepth>[^>]+)>`,
  St = P`\(\?R=(?<rDepth>[^\)]+)\)|${ra}`,
  Xe = P`\(\?<(?![=!])(?<captureName>[^>]+)>`,
  pr = P`${Xe}|(?<unnamed>\()(?!\?)`,
  V = new RegExp(P`${Xe}|${St}|\(\?|\\?.`, "gsu"),
  ot = "Cannot use multiple overlapping recursions";
function sa(t, e) {
  const { hiddenCaptures: n, mode: r } = { hiddenCaptures: [], mode: "plugin", ...e };
  let s = e?.captureTransfers ?? new Map();
  if (!new RegExp(St, "su").test(t)) return { pattern: t, captureTransfers: s, hiddenCaptures: n };
  if (r === "plugin" && Ie(t, P`\(\?\(DEFINE\)`, T.DEFAULT))
    throw new Error("DEFINE groups cannot be used with recursion");
  const o = [],
    i = Ie(t, P`\\[1-9]`, T.DEFAULT),
    a = new Map(),
    c = [];
  let l = !1,
    u = 0,
    h = 0,
    f;
  for (V.lastIndex = 0; (f = V.exec(t)); ) {
    const {
      0: p,
      groups: { captureName: d, rDepth: y, gRNameOrNum: b, gRDepth: g },
    } = f;
    if (p === "[") u++;
    else if (u) p === "]" && u--;
    else if (y) {
      if ((pn(y), l)) throw new Error(ot);
      if (i)
        throw new Error(
          `${r === "external" ? "Backrefs" : "Numbered backrefs"} cannot be used with global recursion`
        );
      const w = t.slice(0, f.index),
        m = t.slice(V.lastIndex);
      if (Ie(m, St, T.DEFAULT)) throw new Error(ot);
      const _ = +y - 1;
      ((t = gn(w, m, _, !1, n, o, h)), (s = yn(s, w, _, o.length, 0, h)));
      break;
    } else if (b) {
      pn(g);
      let w = !1;
      for (const W of c)
        if (W.name === b || W.num === +b) {
          if (((w = !0), W.hasRecursedWithin)) throw new Error(ot);
          break;
        }
      if (!w)
        throw new Error(
          P`Recursive \g cannot be used outside the referenced group "${r === "external" ? b : P`\g<${b}&R=${g}>`}"`
        );
      const m = a.get(b),
        _ = ea(t, m);
      if (i && Ie(_, P`${Xe}|\((?!\?)`, T.DEFAULT))
        throw new Error(
          `${r === "external" ? "Backrefs" : "Numbered backrefs"} cannot be used with recursion of capturing groups`
        );
      const S = t.slice(m, f.index),
        R = _.slice(S.length + p.length),
        $ = o.length,
        O = +g - 1,
        Se = gn(S, R, O, !0, n, o, h);
      s = yn(s, S, O, o.length - $, $, h);
      const Qe = t.slice(0, m),
        ue = t.slice(m + _.length);
      ((t = `${Qe}${Se}${ue}`),
        (V.lastIndex += Se.length - p.length - S.length - R.length),
        c.forEach((W) => (W.hasRecursedWithin = !0)),
        (l = !0));
    } else if (d)
      (h++, a.set(String(h), V.lastIndex), a.set(d, V.lastIndex), c.push({ num: h, name: d }));
    else if (p[0] === "(") {
      const w = p === "(";
      (w && (h++, a.set(String(h), V.lastIndex)), c.push(w ? { num: h } : {}));
    } else p === ")" && c.pop();
  }
...
function gn(t, e, n, r, s, o, i) {
  const a = new Set();
  r &&
    fr(
      t + e,
      Xe,
      ({ groups: { captureName: l } }) => {
        a.add(l);
      },
      T.DEFAULT
    );
  const c = [n, r ? a : null, s, o, i];
  return `${t}${mn(`(?:${t}`, "forward", ...c)}(?:)${mn(`${e})`, "backward", ...c)}${e}`;
}
function mn(t, e, n, r, s, o, i) {
  const c = (u) => (e === "forward" ? u + 2 : n - u + 2 - 1);
  let l = "";
  for (let u = 0; u < n; u++) {
    const h = c(u);
    l += Gt(
      t,
      P`${pr}|\\k<(?<backref>[^>]+)>`,
      ({ 0: f, groups: { captureName: p, unnamed: d, backref: y } }) => {
        if (y && r && !r.has(y)) return f;
        const b = `_$${h}`;
        if (d || p) {
          const g = i + o.length + 1;
          return (o.push(g), oa(s, g), d ? f : `(?<${p}${b}>`);
        }
        return P`\k<${y}${b}>`;
      },
      T.DEFAULT
  ...
  if (t.size && r) {
    ...
    return (
      t.forEach((l, u) => {
        ...
        for (const y of l)
          if (y <= a) d.push(y);
          else if (y > a + i + h) d.push(y + r);
          else if (y <= a + i) for (let b = 0; b <= n; b++) d.push(y + i * b);
          else for (let b = 0; b <= n; b++) d.push(y + f + h * b);
        c.set(p, d);
      }),
      c
    );
...
function We(t, { enable: e, disable: n }) {
  return {
...
var bn = { ES2025: 2025, ES2024: 2024, ES2018: 2018 },
  aa = { auto: "auto", ES2025: "ES2025", ES2024: "ES2024", ES2018: "ES2018" };
function gr(t = {}) {
  if ({}.toString.call(t) !== "[object Object]") throw new Error("Unexpected options");
  if (t.target !== void 0 && !aa[t.target]) throw new Error(`Unexpected target "${t.target}"`);
  const e = {
    accuracy: "default",
    avoidSubclass: !1,
    flags: "",
  ...
  return (
    e.target === "auto" &&
      (e.target = U.flagGroups ? "ES2025" : U.unicodeSets ? "ES2024" : "ES2018"),
    e
  );
}
var ca = "[	-\r ]",
  la = new Set([A(304), A(305)]),
  F = C`[\p{L}\p{M}\p{N}\p{Pc}]`;
function mr(t) {
  if (la.has(t)) return [t];
  const e = new Set(),
    n = t.toLowerCase(),
    r = n.toUpperCase(),
    s = fa.get(n),
...
function ga(t, e) {
  ...
  const r = {
    ...
    minTargetEs2024: kt(n.bestEffortTarget, "ES2024"),
    passedLookbehind: !1,
    strategy: null,
  ...
  return (pe(t, ba, i), (t._originMap = o.groupOriginByCopy), (t._strategy = r.strategy), t);
}
var ma = {
    AbsenceFunction({ node: t, parent: e, replaceWith: n }) {
      ...
      if (s === "repeater") {
        const o = G();
        o.body[0].body.push(Q({ negate: !0, body: r }), re("Any"));
        const i = G();
        (i.body[0].body.push(lr("greedy", 0, 1 / 0, o)), n(k(i, e), { traverse: !0 }));
    ...
    Alternative: {
      ...
      exit({ node: t }, { flagDirectivesByAlt: e }) {
        if (e.get(t)?.length) {
          ...
          if (n) {
            const r = G({ flags: n });
            ((r.body[0].body = t.body), (t.body = [k(r, t)]));
          }
        }
      },
    },
    Assertion({ node: t, parent: e, key: n, container: r, root: s, remove: o, replaceWith: i }, a) {
      const { kind: c, negate: l } = t,
        { asciiWordBoundaries: u, avoidSubclass: h, supportedGNodes: f, wordIsAscii: p } = a;
      if (c === "text_segment_boundary")
        throw new Error(`Unsupported text segment boundary "\\${l ? "Y" : "y"}"`);
      if (c === "line_end")
        i(k(Q({ body: [J({ body: [wt("string_end")] }), J({ body: [He(10)] })] }), e));
        ...
        if (f.has(t)) ((s.flags.sticky = !0), o());
          ...
          const d = r[n - 1];
          if (d && xa(d)) i(k(Q({ negate: !0 }), e));
          else {
            if (h) throw new Error(C`Uses "\G" in a way that requires a subclass`);
            (i(q(wt("string_start"), e)), (a.strategy = "clip_search"));
          }
        }
      else if (!(c === "string_end" || c === "string_start"))
        if (c === "string_end_newline") i(k(D(C`(?=\n?\z)`), e));
        ...
        } else throw new Error(`Unexpected assertion kind "${c}"`);
    },
    Backreference({ node: t }, { jsGroupNameMap: e }) {
      let { ref: n } = t;
      typeof n == "string" && !ct(n) && ((n = at(n, e)), (t.ref = n));
    },
    CapturingGroup({ node: t }, { jsGroupNameMap: e, subroutineRefMap: n }) {
      let { name: r } = t;
      (r && !ct(r) && ((r = at(r, e)), (t.name = r)), n.set(t.number, t), r && n.set(r, t));
    },
    ...
    CharacterSet(
      ...
      { accuracy: r, minTargetEs2024: s, digitIsAscii: o, spaceIsAscii: i, wordIsAscii: a }
    ) {
      const { kind: c, negate: l, value: u } = t;
      if (o && (c === "digit" || u === "digit")) {
        n(q(Ct("digit", { negate: l }), e));
        return;
      }
      if (i && (c === "space" || u === "space")) {
        n(k(lt(D(ca), l), e));
        return;
      }
      if (a && (c === "word" || u === "word")) {
        n(q(Ct("word", { negate: l }), e));
        return;
      }
      if (c === "any") n(q(re("Any"), e));
      else if (c === "digit") n(q(re("Nd", { negate: l }), e));
      else if (c !== "dot")
        if (c === "text_segment") {
          if (r === "strict") throw new Error(C`Use of "\X" requires non-strict accuracy`);
          const h = "\\p{Emoji}(?:\\p{EMod}|\\uFE0F\\u20E3?|[\\x{E0020}-\\x{E007E}]+\\x{E007F})?",
            f = C`\p{RI}{2}|${h}(?:\u200D${h})*`;
          n(
            k(
              D(C`(?>\r\n|${s ? C`\p{RGI_Emoji}` : f}|\P{M}\p{M}*)`, {
                skipPropertyNameValidation: !0,
              }),
              e
            )
          );
        } else if (c === "hex") n(q(re("AHex", { negate: l }), e));
        else if (c === "newline")
          n(
            k(
              D(
...
\v\f\u2028\u2029])`
          ...
          if (!s && (u === "graph" || u === "print")) {
            ...
            let h = { graph: "!-~", print: " -~" }[u];
            (l && (h = `\0-${A(h.codePointAt(0) - 1)}${A(h.codePointAt(2) + 1)}-􏿿`),
              n(k(D(`[${h}]`), e)));
          } else n(k(lt(D(da.get(u)), l), e));
        else if (c === "property") Mt.has(Ve(u)) || (t.key = "sc");
        else if (c === "space") n(q(re("space", { negate: l }), e));
        else if (c === "word") n(k(lt(D(F), l), e));
        else throw new Error(`Unexpected character set kind "${c}"`);
    },
    Directive({
      node: t,
      parent: e,
      ...
      const { kind: a, flags: c } = t;
      if (a === "flags")
        if (!c.enable && !c.disable) r();
        else {
          const l = G({ flags: c });
          ((l.body[0].body = i()), s(k(l, e), { traverse: !0 }));
        }
      else if (a === "keep") {
        const l = n.body[0],
          h =
            n.body.length === 1 && ir(l, { type: "Group" }) && l.body[0].body.length === 1
              ? l.body[0]
              : n;
        if (e.parent !== h || h.body.length > 1)
          throw new Error(C`Uses "\K" in a way that's unsupported`);
        const f = Q({ behind: !0 });
        ((f.body[0].body = o()), s(k(f, e)));
      } else throw new Error(`Unexpected directive kind "${a}"`);
    },
  ...
  ya = {
    ...
    CapturingGroup: {
      enter(
        ...
        const l = s.get(t);
        if (l && a.has(t.number)) {
          const h = q(wn(t.number), e);
          (c.set(h, a.get(t.number)), n(h));
          return;
        }
        (a.set(t.number, t), i.set(t.number, []), t.name && we(i, t.name, []));
        const u = i.get(t.name ?? t.number);
        for (let h = 0; h < u.length; h++) {
          const f = u[h];
          if (l === f.node || (l && l === f.origin) || t === f.origin) {
            u.splice(h, 1);
            break;
          }
        }
        if (
          (i.get(t.number).push({ node: t, origin: l }),
          t.name && i.get(t.name).push({ node: t, origin: l }),
          t.name)
        ) {
          const h = we(o, t.name, new Map());
          let f = !1;
          if (l) f = !0;
          else
            for (const p of h.values())
              if (!p.hasDuplicateNameToRemove) {
                f = !0;
                break;
              }
    ...
    Group: {
      enter({ node: t }, e) {
        ((e.prevFlags = e.currentFlags), t.flags && (e.currentFlags = We(e.currentFlags, t.flags)));
      },
      exit(t, e) {
    ...
    Subroutine({ node: t, parent: e, replaceWith: n }, r) {
      ...
      const i = r.subroutineRefMap.get(o),
        a = o === 0,
        c = a ? wn(0) : wr(i, r.groupOriginByCopy, null);
      let l = c;
      if (!a) {
        const u = _r(Ca(i, (f) => f.type === "Group" && !!f.flags)),
          h = u ? We(r.globalFlags, u) : r.globalFlags;
        wa(h, r.currentFlags) || ((l = G({ flags: Sa(h) })), l.body[0].body.push(c));
      }
      n(k(l, e), { traverse: !a });
    },
  },
  ba = {
    Backreference({ node: t, parent: e, replaceWith: n }, r) {
      ...
      const o = r.reffedNodesByReferencer.get(t).filter((i) => _a(i, t));
      if (!o.length) n(k(Q({ negate: !0 }), e));
      else if (o.length > 1) {
        const i = G({ atomic: !0, body: o.reverse().map((a) => J({ body: [_t(a.number)] })) });
        n(k(i, e));
...
function wr(t, e, n, r) {
  ...
  for (const [o, i] of Object.entries(t))
    o === "parent"
      ...
      : i && typeof i == "object"
        ? (s[o] = wr(i, e, s, n))
        : (o === "type" && i === "CapturingGroup" && e.set(s, e.get(t) ?? t), (s[o] = i));
  return s;
}
function wn(t) {
  const e = ur(t);
...
function Sa({ dotAll: t, ignoreCase: e }) {
  const n = {};
  return (
...
function Sr(t) {
  const e = t.find((n) => n.kind === "search_start" || Aa(n, { negate: !1 }) || !ka(n));
  if (!e) return null;
...
function kr(t, e) {
  const n = Cr(t) ?? [];
  for (const r of n) if (r === e || kr(r, e)) return !0;
  return !1;
}
function ka({ type: t }) {
...
function Aa(t, e) {
  ...
  return (
    ...
    t.body.length === 1 &&
    ir(t.body[0], { type: "Assertion", kind: "search_start" })
  );
}
function ct(t) {
...
function D(t, e) {
  const r = ar(t, { ...e, unicodePropertyMap: Mt }).body;
  return r.length > 1 || r[0].body.length > 1 ? G({ body: r }) : r[0].body[0];
}
function lt(t, e) {
  return ((t.negate = e), t);
}
...
function k(t, e) {
  return (br(t), (t.parent = e), t);
}
function Ea(t, e) {
  const n = gr(e),
    r = kt(n.target, "ES2024"),
    s = kt(n.target, "ES2025"),
  ...
  const c = { dotAll: t.flags.dotAll, ignoreCase: !!((t.flags.ignoreCase || i) && !a) };
  let l = t;
  const u = {
    accuracy: n.accuracy,
    ...
    recursionLimit: o,
    useAppliedIgnoreCase: !!(!s && i && a),
    useFlagMods: s,
    useFlagV: r,
    verbose: n.verbose,
  };
  function h(p) {
    return ((u.lastNode = l), (l = p), ia(Ia[p.type], `Unexpected node type "${p.type}"`)(p, u, h));
  }
  const f = { pattern: t.body.map(h).join("|"), flags: h(t.flags), options: { ...t.options } };
  return (
    r ||
    ...
    u.captureMap.forEach((p, d) => {
      (p.hidden && f._hiddenCaptures.push(d),
        p.transferTo && we(f._captureTransfers, p.transferTo, []).push(d));
    }),
    f
  );
}
var va = {
    "*": {
      enter({ node: t }, e) {
        if (Cn(t)) {
          ...
          e.pushModI(t.flags ? We({ ignoreCase: n }, t.flags).ignoreCase : n);
        }
      },
      exit({ node: t }, e) {
        Cn(t) && e.popModI();
  ...
  Ia = {
    ...
    Assertion({ kind: t, negate: e }) {
      ...
      if (t === "word_boundary") return e ? C`\B` : C`\b`;
    ...
    CapturingGroup(t, e, n) {
      const { body: r, name: s, number: o } = t,
        ...
        a = e.originMap.get(t);
      return (
        a && ((i.hidden = !0), o > a.number && (i.transferTo = a.number)),
        e.captureMap.set(o, i),
        `(${s ? `?<${s}>` : ""}${r.map(n).join("|")})`
      );
    },
    Character({ value: t }, e) {
      ...
      if (r !== n) return r;
      if (e.useAppliedIgnoreCase && e.currentFlags.ignoreCase && Ot(n)) {
        const s = mr(n);
    ...
    CharacterClass(t, e, n) {
      ...
      U.bugFlagVLiteralHyphenIsRange &&
        e.useFlagV &&
        i.some(Sn) &&
        (i = [He(45), ...i.filter((l) => !Sn(l))]);
      const a = () => `[${s ? "^" : ""}${i.map(n).join(r === "intersection" ? "&&" : "")}]`;
      if (!e.inCharClass) {
        if ((!e.useFlagV || U.bugNestedClassIgnoresNegation) && !s) {
          const u = i.filter((h) => h.type === "CharacterClass" && h.kind === "union" && h.negate);
          if (u.length) {
            const h = G(),
              f = h.body[0];
            return (
              (h.parent = o),
              (f.parent = h),
              (i = i.filter((p) => !u.includes(p))),
              (t.body = i),
              i.length ? ((t.parent = f), f.body.push(t)) : h.body.pop(),
              u.forEach((p) => {
                const d = J({ body: [p] });
                ((p.parent = d), (d.parent = h), h.body.push(d));
              }),
              n(h)
            );
          }
      ...
      if (
        ...
        (((!e.useFlagV || !e.verbose) &&
          o.kind === "union" &&
          !(U.bugFlagVLiteralHyphenIsRange && e.useFlagV)) ||
          (!e.verbose &&
            o.kind === "intersection" &&
            i.length === 1 &&
    ...
    CharacterClassRange(t, e) {
      ...
      if (e.useAppliedIgnoreCase && e.currentFlags.ignoreCase) {
        const c = xr(t);
        Pa(c).forEach((u) => {
          a.add(Array.isArray(u) ? `${te(u[0], s)}-${te(u[1], s)}` : te(u, s));
        });
      }
      return `${o}-${i}${[...a].join("")}`;
    },
      ...
      if (t === "dot")
        return s.currentFlags.dotAll
          ? s.appliedGlobalFlags.dotAll || s.useFlagMods
            ...
            : "[^]"
          : C`[^\n]`;
      if (t === "digit") return e ? C`\D` : C`\d`;
      if (t === "property") {
        if (s.useAppliedIgnoreCase && s.currentFlags.ignoreCase && yr.has(n))
          throw new Error(
            `Unicode property "${n}" can't be case-insensitive when other chars have specific case`
          );
        return `${e ? C`\P` : C`\p`}{${r ? `${r}=` : ""}${n}}`;
      }
      if (t === "word") return e ? C`\W` : C`\w`;
...
function xr(t, e) {
  ...
  for (let i = r; i <= s; i++) {
    const a = A(i);
    if (!Ot(a)) continue;
    const c = mr(a).filter((l) => {
      const u = l.codePointAt(0);
      return u < r || u > s;
    });
    if (c.length && (o.push(...c), n)) break;
  }
  return o;
}
function te(t, { escDigit: e, inCharClass: n, useFlagV: r }) {
  if (_n.has(t)) return _n.get(t);
  if (t < 32 || (t > 126 && t < 160) || t > 262143 || (e && Ma(t)))
    return t > 255
...
function Ga({ kind: t, max: e, min: n }) {
  let r;
  return (
    !n && e === 1
      ? (r = "?")
...
function Sn({ type: t, value: e }) {
  return t === "Character" && e === 45;
}
var Oa = class xt extends RegExp {
  #t = new Map();
  #e = null;
  #r;
  #n = null;
  ...
  constructor(e, n, r) {
    ...
    if (e instanceof RegExp) {
      ...
      (super(o, n),
        (this.#r = o.source),
        o instanceof xt &&
          ((this.#t = o.#t), (this.#n = o.#n), (this.#s = o.#s), (this.rawOptions = o.rawOptions)));
    } else {
      const o = { hiddenCaptures: [], strategy: null, transfers: [], ...r };
      (super(s ? "" : e, n),
        (this.#r = e),
        (this.#t = Fa(o.hiddenCaptures, o.transfers)),
        (this.#s = o.strategy),
        (this.rawOptions = r ?? {}));
    }
    s || (this.#e = this);
  ...
  exec(e) {
    if (!this.#e) {
      ...
      this.#e = new xt(this.#r, this.flags, o);
    }
    ...
    if (this.#s === "clip_search" && n && r) {
      ...
      return (s && (Ba(s, r, e, this.hasIndices), (this.lastIndex += r)), s);
    }
    return this.#o(e);
  }
  #o(e) {
    ...
    if (((this.lastIndex = this.#e.lastIndex), !n || !this.#t.size)) return n;
    const r = [...n];
    n.length = 1;
    let s;
    ...
    for (let i = 1; i < r.length; i++) {
      const { hidden: a, transferTo: c } = this.#t.get(i) ?? {};
      if (
        (a
          ? o.push(null)
          : (o.push(n.length), n.push(r[i]), this.hasIndices && n.indices.push(s[i])),
        c && r[i] !== void 0)
      ) {
        const l = o[c];
        if (!l) throw new Error(`Invalid capture transfer to "${l}"`);
        if (((n[l] = r[i]), this.hasIndices && (n.indices[l] = s[i]), n.groups)) {
          this.#n || (this.#n = Da(this.source));
          const u = this.#n.get(c);
          u && ((n.groups[u] = r[i]), this.hasIndices && (n.indices.groups[u] = s[i]));
        }
      }
    }
    return n;
...
function Fa(t, e) {
  ...
  for (const [r, s] of e) for (const o of s) we(n, o, {}).transferTo = r;
  return n;
}
function Da(t) {
  ...
  for (; (o = e.exec(t)); ) {
    const {
      0: i,
      groups: { capture: a, name: c },
    } = o;
    i === "[" ? r++ : r ? i === "]" && r-- : a && (s++, c && n.set(s, c));
  }
  return n;
}
function ja(t, e) {
  const n = Ua(t, e);
  return n.options ? new Oa(n.pattern, n.flags, n.options) : new RegExp(n.pattern, n.flags);
}
function Ua(t, e) {
  const n = gr(e),
    r = ar(t, {
    ...
    a = na(i.pattern),
    c = ta(a.pattern, { captureTransfers: i.captureTransfers, hiddenCaptures: i.hiddenCaptures }),
    l = {
      pattern: c.pattern,
  ...
  if (n.avoidSubclass) {
    ...
    const u = c.hiddenCaptures.sort((d, y) => d - y),
      h = Array.from(c.captureTransfers),
      f = s._strategy,
      p = l.pattern.length >= n.lazyCompileLength;
    (u.length || h.length || f || p) &&
      (l.options = {
...
class Wa {
  ...
  findNextMatchSync(e, n, r) {
    ...
    function i(a, c, l = 0) {
      return {
        index: a,
        captureIndices: c.indices.map((u) =>
          u == null
            ? { start: kn, end: kn, length: 0 }
            : { start: u[0] + l, end: u[1] + l, length: u[1] - u[0] }
        ),
      };
    }
    for (let a = 0; a < this.regexps.length; a++) {
      const c = this.regexps[a];
      if (c)
        try {
          c.lastIndex = n;
          const l = c.exec(s);
          if (!l) continue;
          if (l.index === n) return i(a, l, 0);
          o.push([a, l, 0]);
        } catch (l) {
    ...
    if (o.length) {
      const a = Math.min(...o.map((c) => c[1].index));
      for (const [c, l, u] of o) if (l.index === a) return i(c, l, u);
    }
    return null;
  }
}
...
function Qa(t = {}) {
  ...
  return (
    (e.regexConstructor ||= (n) => za(n, { target: e.target })),
    {
      createScanner(n) {
        return new Wa(n, e);
      },
