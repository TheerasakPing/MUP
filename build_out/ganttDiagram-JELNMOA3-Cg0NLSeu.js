...
import { g as ae } from "./TerminalRouterContext-CeKE7fio.js";
import { b as Gn, t as He, c as jn, a as Qn, l as Jn } from "./linear-pEwbecgX.js";
...
import "./defaultLocale-C4B-KCzX.js";
function tr(t, e) {
  let n;
...
function ln(t, e) {
  var n = [],
    ...
    L = t === Xt || t === Te ? rr : ir;
  function _(S) {
    var B = r ?? (e.ticks ? e.ticks.apply(e, n) : e.domain()),
      ...
      g = j.selectAll(".tick").data(B, e).order(),
      y = g.exit(),
      h = g.enter().append("g").attr("class", "tick"),
      D = g.select("line"),
      w = g.select("text");
    ((p = p.merge(
      p.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "currentColor")
    )),
      (g = g.merge(h)),
      (D = D.merge(
        h
      ...
      j
        ...
        .attr("text-anchor", t === ue ? "start" : t === Zt ? "end" : "middle"),
      j.each(function () {
        this.__axis = q;
      }));
  }
...
function Fr(t) {
    ...
    return function (V) {
      ...
      if (
        ...
        ("W" in l || "U" in l) &&
          ...
          (l.m = 0),
          (l.d =
            "W" in l ? ((l.w + 6) % 7) + l.W * 7 - ((Q + 5) % 7) : l.w + l.U * 7 - ((Q + 6) % 7)));
  ...
  function y(M, H, V, l) {
    for (var J = 0, $ = H.length, Q = V.length, G, it; J < $; ) {
      ...
      if (((G = H.charCodeAt(J++)), G === 37)) {
        if (
          ((G = H.charAt(J++)), (it = j[G in Ve ? H.charAt(J++) : G]), !it || (l = it(M, V, l)) < 0)
        )
          return -1;
  ...
  function D(M, H, V) {
    ...
    return l ? ((M.w = B.get(l[0].toLowerCase())), V + l[0].length) : -1;
  }
  function w(M, H, V) {
...
function Qr(t, e) {
  return Z(1 + bt.count(kt(t), t), e, 3);
}
function wn(t, e) {
...
function ri(t, e) {
  return Z(Pt.count(kt(t) - 1, t), e, 2);
}
function Dn(t) {
  var e = t.getDay();
...
function ii(t, e) {
  return ((t = Dn(t)), Z(xt.count(kt(t), t) + (kt(t).getDay() === 4), e, 2));
}
function si(t) {
  return t.getDay();
}
function ai(t, e) {
  return Z(Ht.count(kt(t) - 1, t), e, 2);
}
function oi(t, e) {
  return Z(t.getFullYear() % 100, e, 2);
}
function ci(t, e) {
  return ((t = Dn(t)), Z(t.getFullYear() % 100, e, 2));
}
function ui(t, e) {
...
function li(t, e) {
  var n = t.getDay();
  return ((t = n >= 4 || n === 0 ? xt(t) : xt.ceil(t)), Z(t.getFullYear() % 1e4, e, 4));
}
function fi(t) {
...
function mi(t, e) {
  return Z(1 + Se.count(wt(t), t), e, 3);
}
function Mn(t, e) {
...
function Ti(t, e) {
  return Z(xn.count(wt(t) - 1, t), e, 2);
}
function Cn(t) {
  var e = t.getUTCDay();
...
function bi(t, e) {
  return ((t = Cn(t)), Z(Et.count(wt(t), t) + (wt(t).getUTCDay() === 4), e, 2));
}
function xi(t) {
  return t.getUTCDay();
}
function wi(t, e) {
  return Z(ne.count(wt(t) - 1, t), e, 2);
}
function Di(t, e) {
  return Z(t.getUTCFullYear() % 100, e, 2);
}
function Mi(t, e) {
  return ((t = Cn(t)), Z(t.getUTCFullYear() % 100, e, 2));
}
function Ci(t, e) {
...
function Sn(t, e, n, r, i, a, c, m, Y, C) {
  ...
  return (
    ...
    (k.nice = function (p) {
      var g = _();
      return (
        (!p || typeof p.range != "function") && (p = e(g[0], g[g.length - 1], p ?? 10)),
        p ? _(kr(g, p)) : k
      );
    }),
    (k.copy = function () {
                    ...
                    try {
                      ...
                      return M
                        ...
                        : o
                          ...
                          : ((Q = new Date(J, $, l, G, it, at, pt)),
                            H && (Q = X(Q).week(H).toDate()),
                            Q);
                    } catch {
                      return new Date("");
                    }
              ...
              return (
                ...
                (g.toISOString = function () {
                  ...
                  var w = W(D, "D"),
                    ...
                    u = this.$d.seconds || 0;
                  this.$d.milliseconds &&
                    ((u += this.$d.milliseconds / 1e3), (u = Math.round(1e3 * u) / 1e3));
                  var f = W(u, "S"),
                    b =
                      y.negative ||
                      h.negative ||
                ...
                (g.add = function (y, h, D) {
                  var w;
                  return (
                    (w = h ? y * _[A(h)] : S(y) ? y.$ms : B(y, this).$ms),
                    B(this.$ms + w * (D ? -1 : 1), this)
                  );
                }),
    ...
    D = {
      ...
      performAction: d(function (u, f, b, x, F, o, X) {
        ...
        switch (F) {
          ...
          case 36:
            ((this.$ = o[s - 2]),
              x.setClickEvent(o[s - 2], o[s - 1], null),
              x.setLink(o[s - 2], o[s]));
            break;
          case 37:
            ((this.$ = o[s - 3]),
              x.setClickEvent(o[s - 3], o[s - 2], o[s - 1]),
              x.setLink(o[s - 3], o[s]));
            break;
          case 38:
            ((this.$ = o[s - 2]),
              x.setClickEvent(o[s - 2], o[s], null),
              x.setLink(o[s - 2], o[s - 1]));
            break;
          case 39:
            ((this.$ = o[s - 3]),
              x.setClickEvent(o[s - 3], o[s - 1], o[s]),
              x.setLink(o[s - 3], o[s - 2]));
            break;
          case 40:
      ...
      parse: d(function (u) {
        ...
        function J() {
          ...
          return (
            (ot = x.pop() || O.lex() || P),
            typeof ot != "number" &&
              (ot instanceof Array && ((x = ot), (ot = x.pop())), (ot = f.symbols_[ot] || ot)),
            ot
          );
        }
        d(J, "lex");
...
Expecting ` +
          ...
          if (G[0] instanceof Array && G.length > 1)
            throw new Error(
              "Parse Error: multiple actions possible at state: " + Q + ", token: " + $
            );
          switch (G[0]) {
            case 1:
              (b.push($),
        ...
        unput: d(function (u) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: b
                ? (b.length === x.length ? this.yylloc.first_column : 0) +
                  x[x.length - b.length].length -
                  b[0].length
...
` +
        ...
        next: d(function () {
          ...
          for (var F = this._currentRules(), o = 0; o < F.length; o++)
            if (
              ((b = this._input.match(this.rules[F[o]])), b && (!f || b[0].length > f[0].length))
            ) {
...
var nn = { friday: 5, saturday: 6 },
  ...
  Yn = d(function (t, e, n, r) {
    ...
    let i;
    (t.startTime instanceof Date ? (i = rt(t.startTime)) : (i = rt(t.startTime, e, !0)),
      (i = i.add(1, "d")));
    let a;
  ...
  Ds = d(function (t, e) {
    ...
    switch (r.length) {
      case 1:
        ((i.id = Yt()),
          (i.startTime = { type: "prevTaskEnd", id: t }),
          (i.endTime = { data: r[0] }));
        break;
      case 2:
        ((i.id = Yt()),
  ...
  Ss = d(function (t, e) {
    let n = e;
    (_t().securityLevel !== "loose" && (n = Bn.sanitizeUrl(e)),
...
var Es = d(function () {
  ...
  Ls = d(function (t, e, n, r) {
    ...
    ((dt = C.parentElement.offsetWidth),
      dt === void 0 && (dt = 1200),
      i.useWidth !== void 0 && (dt = i.useWidth));
      ...
      B.append("g")
        ...
        .attr("class", function (s) {
          for (const [E, R] of L.entries())
            if (s.type === R) return "section section" + (E % i.numberSectionStyles);
          return "section section0";
        })
        .enter();
      const F = B.append("g").selectAll("rect").data(h).enter(),
        o = r.db.getLinks();
      if (
        (F.append("rect")
          .attr("id", function (s) {
          ...
          .attr("width", function (s) {
            return s.milestone
              ...
              : s.vert
                ? 0.08 * v
                : A(s.renderEndTime || s.endTime) - A(s.startTime);
          })
        ...
        F.append("text")
          ...
          .attr("x", function (s) {
            ...
            if (
              (s.milestone && ((E += 0.5 * (A(s.endTime) - A(s.startTime)) - 0.5 * v), (R = E + v)),
              s.vert)
            )
    ...
    function W(h, D, w, T, v, u, f, b) {
      ...
      B.append("g")
        ...
        .attr("transform-origin", function (z, P) {
          return (
            (A(z.start) + w + 0.5 * (A(z.end) - A(z.start))).toString() +
            "px " +
            (P * h + 0.5 * v).toString() +
            "px"
          );
    ...
    function j(h, D, w, T) {
      ...
      if (F !== null) {
        ...
        if (isNaN(o) || o <= 0)
          Tt.warn(`Invalid tick interval value: "${F[1]}". Skipping custom tick interval.`);
        else {
          const X = F[2],
    ...
    function p(h, D) {
      ...
      B.append("g")
        ...
        .attr("y", function (v, u) {
          if (u > 0)
            for (let f = 0; f < u; f++) return ((w += T[u - 1][1]), (v[1] * h) / 2 + w * h + D);
    ...
    function g(h, D, w, T) {
      ...
      if (v === "off") return;
      const u = B.append("g").attr("class", "today"),
        f = new Date(),
        b = u.append("line");
      (b
        .attr("x1", A(f) + h)
...
`,
  ...
  $s = Ws,
  Bs = { parser: Gi, db: Us, renderer: As, styles: $s };
export { Bs as diagram };
