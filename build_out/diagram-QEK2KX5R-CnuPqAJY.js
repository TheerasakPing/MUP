...
import { p as V } from "./chunk-4BX2VUAB-DD9VcsVt.js";
import { p as W } from "./treemap-KMMF4GRG-CUI7aynp.js";
...
var h = { showLegend: !0, ticks: 5, max: null, min: 0, graticule: "circle" },
  ...
  X = l((a) => {
    m.curves = a.map((t) => ({ name: t.name, label: t.label ?? t.name, entries: Y(t.entries) }));
  }, "setCurves"),
  Y = l((a) => {
...
var st = { draw: tt },
  ...
  $t = { parser: Q, db: $, renderer: st, styles: it };
export { $t as diagram };
