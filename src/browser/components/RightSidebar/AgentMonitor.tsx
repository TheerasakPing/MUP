  ...
  return (
    <div className="space-y-4">
          ...
          <div className="border-border-light mt-2 grid grid-cols-3 gap-2 border-t pt-2">
            <div className="text-center">
              ...
              <div className="text-foreground text-sm font-medium tabular-nums">
                {state.streamingTPS !== undefined ? state.streamingTPS.toFixed(1) : "—"}
              </div>
            </div>
            <div className="text-center">
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        />
        <MetricCard icon={Activity} label="Responses" value={sessionResponseCount.toString()} />
        <MetricCard
          icon={Zap}
          label="Output Tokens"
          ...
          subValue={
            totalReasoningTokens > 0
              ? `+${totalReasoningTokens.toLocaleString()} reasoning`
              : undefined
          }
        />
        <MetricCard
      ...
      {statsSnapshot?.active && (
        <div className="bg-panel border-border-light rounded-lg border p-3">
          ...
          <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-xs">
            ...
            <div className="text-foreground text-right tabular-nums">
              {statsSnapshot.active.liveTPS != null ? statsSnapshot.active.liveTPS.toFixed(1) : "—"}
            </div>
